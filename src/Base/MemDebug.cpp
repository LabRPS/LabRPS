 ...
 * The LabRPS memory debugging is located in the Base::MemDebug class.
 */
...
/// Here the LabRPS includes sorted by Base,App,Gui......
#include "MemDebug.h"
#include <stdexcept>
 ...
 * facility. If the define MemDebugOn in the src/RPSConfig.h is
...
#endif
   fprintf( logFile,
            "Memory Allocation Log File for LabRPS, run at %s on %s.\n",
            timeStr, dateStr );
   fputs( "-------------------------------------------------------------------\n", logFile );
