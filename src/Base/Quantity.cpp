...
/** \defgroup Units Units system
    \ingroup BASE
    \brief The quantities and units system enables LabRPS to work transparently with many different units
*/
...
Quantity Quantity::RadianPerSecond  (0.1591549      ,Unit(0, 0, -1));
...
Quantity Quantity::MetrePerSecond   (1.0e3         ,Unit(1, 0, -1));// m/s
