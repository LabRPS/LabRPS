 ...
 *
 * In LabRPS normally inheritance is a chain, it is not possible to use multiple inheritance.
 ...
 *
 * The concept of extensions allow to circumvent those problems. Extensions are LabRPS objects
 ...
 *
 * The interoperability with python is highly important, as in LabRPS all functionality should be
