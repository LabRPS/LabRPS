 ...
 *
 * Extensions are like every other LabRPS object and based on properties. All information storage
 ...
 * for c++ classes. This is like every where else in LabRPS, there is no automatic creation of python
 * API from c++ classes. Hence the extension creator must also create a custom python object of its
 * extension, which works exactly like the normal LabRPS python object workflow. There is nothing
