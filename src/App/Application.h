...
public:
    ...
    static std::string getUserPluginDir();
    static int getUserPluginSource(std::string& customPluginSourcePlath);
...
private:
    ...
    static PyObject* sGetUserPluginPath  (PyObject *self,PyObject *args);
    ...
    /// Search for the LabRPS home path based on argv[0]
    /*!
