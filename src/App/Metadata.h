...
namespace App {
    ...
    public:
        ...
        Meta::Version labrpsmin() const; //< The minimum LabRPS version.
        Meta::Version labrpsmax() const; //< The maximum LabRPS version.
        ...
        void setLabRPSMin(const Meta::Version& version);
        void setLabRPSMax(const Meta::Version& version);
        ...
        /**
         * Determine whether the current metadata specifies support for the currently-running version of LabRPS.
         * Does not interrogate content items, which must be querried individually.
         */
        bool supportsCurrentLabRPS() const;
    ...
    private:
        ...
        Meta::Version _labrpsmin;
        Meta::Version _labrpsmax;
