...
public:
    ...
    /** Update an existing feature with sName (ASCII) to this document.
    * Unicode names are set through the Label property.
     * a feature outside and add it to the document afterwards.
    * \note The passed feature must  yet be added to the document, otherwise an exception
    * is raised.
    */
    void updateObject(DocumentObject*);
