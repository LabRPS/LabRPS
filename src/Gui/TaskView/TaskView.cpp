...
#include <Gui/QSint/actionpanel/labrpsscheme.h>
    ...
    : QScrollArea(parent),ActiveDialog(nullptr),ActiveCtrl(nullptr)
{
    ...
    taskPanel->setScheme(QSint::LabRPSPanelScheme::defaultScheme());
...
void TaskView::addTaskWatcher()
{
    ...
    // https://forum.labrpsweb.org/viewtopic.php?f=8&t=39187
    //
...
{
    static_cast<QSint::LabRPSPanelScheme*>(QSint::LabRPSPanelScheme::defaultScheme())->clearActionStyle();
    taskPanel->setScheme(QSint::LabRPSPanelScheme::defaultScheme());
}

void TaskView::restoreActionStyle()
{
    static_cast<QSint::LabRPSPanelScheme*>(QSint::LabRPSPanelScheme::defaultScheme())->restoreActionStyle();
    taskPanel->setScheme(QSint::LabRPSPanelScheme::defaultScheme());
}
