 ...
 * Therefore an overview and some remarks to the LabRPS 3D viewing system.
 *
...
void View3DInventorViewer::init()
{
    ...
    // http://forum.labrpsweb.org/viewtopic.php?f=10&t=7486&start=120#p74398 and for
    // the fix and some details what happens behind the scene have a look at this
    // http://forum.labrpsweb.org/viewtopic.php?f=10&t=7486&p=74777#p74736
...
View3DInventorViewer::~View3DInventorViewer()
{
    ...
    // See https://forum.labrpsweb.org/viewtopic.php?f=3&t=39720
...
void View3DInventorViewer::setRenderCache(int mode)
{
    ...
    if (mode<0) {
        ...
        // https://forum.labrpsweb.org/viewtopic.php?f=18&t=43305&start=10#p412537
...
// so that's why it is disabled now: http://forum.labrpsweb.org/viewtopic.php?f=3&t=6037&hilit=transparency
