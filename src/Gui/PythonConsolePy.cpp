...
void PythonStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to LabRPS's Python console window");
...
void OutputStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to LabRPS's output window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
...
void PythonStdin::init_type()
{
    ...
    behaviors().doc("Redirection of stdin to LabRPS to open an input dialog");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
