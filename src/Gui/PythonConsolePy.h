...
/**
 * Python class for redirection of stdout to LabRPS's Python
...
/**
 * Python class for redirection of stderr to LabRPS's Python
 * console window. This allows to show all Python messages in
 * the same window where the commands are performed.
 * @see PythonStdout
 * @see PythonConsole
...
/**
 * Python class for redirection of stdout to LabRPS's output
...
/**
 * Python class for redirection of stderr to LabRPS's output
