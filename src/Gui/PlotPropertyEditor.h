...
#ifndef GUI_PLOTPROPERTYEDITOR_H
#define GUI_PLOTPROPERTYEDITOR_H
...
//namespace Gui {
    ...
    class GuiExport PlotPropertyEditor: public QWidget
{
        Q_OBJECT
    public:
        PlotPropertyEditor(QWidget* parent = nullptr, Gui::MainAlphaPlot* app = nullptr);
        ~PlotPropertyEditor();
        MyPlotTreeWidget* getObjectBrowser();
    ...
    private:
        Gui::MainAlphaPlot* app_;
        QSplitter* splitter_;
        QWidget* dockWidgetContents;
        QGridLayout* propEditorGridLayout;
        MyPlotTreeWidget* objectbrowser_;
...
#endif  // GUI_PLOTPROPERTYEDITOR_H
