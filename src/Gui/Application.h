...
public:
    ...
    */
    ...
    void emptyAllToBeUninstalledObjectsMap() const;
    void showPluginList();
...
public:
    ...
    /** @name python plugin handling */
    //@{
    /// Activate a named workbench
    bool initializePythonPlugin(const char* name);
    bool registerPythonPlugin(const char* name);
    bool unregisterPythonPlugin(const char* name);
    QStringList pythonPlugins() const;
    //@}
...
private:
    ...
    PyObject*             _pcPythonPluginDictionary;
    PyObject*             _pcPythonFeatureDictionary;
    PyObject*             _pcRPSPythonFeatureMaker;
};
