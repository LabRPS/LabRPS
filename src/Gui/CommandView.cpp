...
{
    sGroup        = "Standard-View";
    sMenuText     = QT_TR_NOOP("LabRPS-VR");
    sToolTipText  = QT_TR_NOOP("Extend the LabRPS 3D Window to a Oculus Rift");
    sWhatsThis    = "Std_ViewVR";
    sStatusTip    = QT_TR_NOOP("Extend the LabRPS 3D Window to a Oculus Rift");
    eType         = Alter3DView;
}
