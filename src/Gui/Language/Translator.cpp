...
/** \defgroup i18n Internationalization with LabRPS
 *  \ingroup GUI
 *
 * The internationalization of LabRPS makes heavy use of the internationalization
 * support of Qt. For more details refer to your Qt documentation.
 * 
 * \section stepbystep Step by step
 * To integrate a new language into LabRPS or one of its application modules
 ...
 * The .qm file should now be integrated into the GUI library (either of LabRPS
