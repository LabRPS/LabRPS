 ...
 * This lightweight class is the base class of all commands in LabRPS. It represents the link between the LabRPS
 ...
 * It contains also a lot of helper methods to make implementing commands for LabRPS as easy as possible.
 *
 ...
 *  This class manage all available commands in LabRPS. All
