...
PythonDebugModule::PythonDebugModule()
  : Py::ExtensionModule<PythonDebugModule>("LabRPSDbg")
{
    ...
    initialize( "The LabRPS Python debug module" );
...
void PythonDebugStdout::init_type()
{
    ...
    behaviors().doc("Redirection of stdout to LabRPS's Python debugger window");
...
void PythonDebugStderr::init_type()
{
    ...
    behaviors().doc("Redirection of stderr to LabRPS's Python debugger window");
    // you must have overwritten the virtual functions
    behaviors().supportRepr();
