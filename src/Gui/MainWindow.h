...
public:
    ...
    void clearResultLogInfo();
    void setResultLogInfo(QString info);
    MainAlphaPlot* getAlphaPlot();
...
public Q_SLOTS:
    ...
    void addSubWindow(MyWidget* view);
    void setActiveSubWindow(MyWidget* w);
    bool isActiveWindow();
    QList<QMdiSubWindow*> subWindowList();
    QMdiSubWindow* getactiveMyWidget();
