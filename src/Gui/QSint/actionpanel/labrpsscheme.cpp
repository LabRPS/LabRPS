...
const char* ActionPanelLabRPS =
    ...
    // https://github.com/LabRPS/LabRPS/issues/6102
...
const char* MinimumActionPanelLabRPS =
...
LabRPSPanelScheme::LabRPSPanelScheme() : ActionPanelScheme()
{
#if defined(Q_OS_WIN32)
    ActionPanelScheme* panelStyle = WinXPPanelScheme2::defaultScheme();

    actionStyle = QString(ActionPanelLabRPS);
    ...
    minimumStyle = QString(MinimumActionPanelLabRPS);
...
void LabRPSPanelScheme::clearActionStyle()
{
...
void LabRPSPanelScheme::restoreActionStyle()
{
