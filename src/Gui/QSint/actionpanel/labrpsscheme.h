...
#ifndef LABRPSTASKPANELSCHEME_H
#define LABRPSTASKPANELSCHEME_H
...
class QSINT_EXPORT LabRPSPanelScheme : public ActionPanelScheme
{
public:
    explicit LabRPSPanelScheme();

    static ActionPanelScheme* defaultScheme()
    {
        static LabRPSPanelScheme scheme;
        return &scheme;
    }
...
#endif // IISLABRPSTASKPANELSCHEME_H
