...
namespace Gui {
     ...
     * LabRPS distribution, or inside various installed mods. 
     */
    ...
    public:
         ...
         * a PreferencePack
         *
         * PreferencePacks can contain any parameters at all, but inside LabRPS there is no 
         ...
         * hidden from the users: LabRPS behaves as though those values exist in the config file.
         * 
         ...
         * 
         * The base LabRPS installation includes default templates in:
         ...
         * sets of core LabRPS preferences.
         */
        struct TemplateFile {
