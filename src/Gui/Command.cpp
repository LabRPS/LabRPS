...
/** \defgroup commands Command Framework
    \ingroup GUI
    \brief Structure for registering commands to the LabRPS system
 * \section Overview
 ...
 * \a Gui::CommandBase and \a Gui::Action that represent the link between Qt's QAction world and the LabRPS's command world.
 *
 ...
 * };
 * \endcode
 * An instance of \a OpenCommand must be created and added to the \ref Gui::CommandManager to make the class known to LabRPS.
...
void Command::_invoke(int id, bool disablelog)
{
    try {
        ...
        e.ReportException();
        // Pop-up a dialog for LabRPS-specific exceptions
