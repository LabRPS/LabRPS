...
class OpenSCADWorkbench(Workbench):
    ...
    def __init__(self):
        ...
        self.__class__.ToolTip = (
            ...
            "LabRPS utizes OpenSCAD's capability as a script-only based modeller that uses its own description language\n"
    ...
    def Initialize(self):
        ...
        param = LabRPS.ParamGet("User parameter:BaseApp/Preferences/Mod/OpenSCAD")
        ...
        if openscadfilename:
            ...
            LabRPS.Console.PrintWarning("OpenSCAD executable not found\n")
        ...
        if openscadfilename and transferMechanism == 0:  
            ...
            if "snap" in openscadfilename:
                LabRPS.Console.PrintMessage(
                    ...
                    + translate(
                        "OpenSCAD",
                        "If OpenSCAD execution fails to load the temporary file, use LabRPS's OpenSCAD Workbench Preferences to change the transfer mechanism.",
                    )
                    + "\n"
                )
                ...
                LabRPS.Console.PrintMessage(
                    translate(
                        "OpenSCAD",
                        "It looks like you may be using a sandboxed version of LabRPS.",
                    )
                    + " "
                    + translate(
                        "OpenSCAD",
        ...
        LabRPSGui.addIconPath(":/icons")
        LabRPSGui.addLanguagePath(":/translations")
        LabRPSGui.addPreferencePage(":/ui/openscadprefs-base.ui", "OpenSCAD")
...
LabRPS.__unit_test__ += ["TestOpenSCADGui"]
