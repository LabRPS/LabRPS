...
class TestImportCSG(unittest.TestCase):
    ...
    def setUp(self):
        self.test_dir = join(LabRPS.getHomePath(), "Mod", "OpenSCAD", "OpenSCADTest", "data")
...
""","polyhedron"
    ...
    def test_import_rotate_extrude(self):
        ...
        # Bug #4353 - https://tracker.labrpsweb.org/view.php?id=4353
...
#        LabRPS.closeDocument(doc.Name)
    ...
    def test_import_import_stl(self):
        ...
        if transfer_mechanism == 2:
            ...
            print ("If either OpenSCAD or LabRPS are installed as sandboxed packages,")
