        ...
        if type(propvalue) == list:
            ...
            if bModified:
                if propname == "ExpressionEngine":
                    ...
                    LabRPS.Console.PrintWarning("Expressions in "+parent.Name+" need to be modified, but they were not. Please do that manually.")
                    continue
...
if __name__ == '__main__':
    import LabRPS
    import LabRPSGui
    objs = [selobj.Object for selobj in LabRPSGui.Selection.getSelectionEx()]
