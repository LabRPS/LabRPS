...
#*   Acknowledgements :                                                    *
#*                                                                         *
#*     Thanks to shoogen on the LabRPS forum for programming advice       *
#*     and some code.                                                      *
#*                                                                         *
#***************************************************************************
__title__ = "LabRPS OpenSCAD Workbench - CSG exporter Version"
...
def export(exportList, filename):
    "called when LabRPS exports a file"
    ...
    csg.write("// CSG file generated from LabRPS %s\n" % \
            '.'.join(LabRPS.Version()[0:3]))
    ...
    # close file
    csg.close()
    LabRPS.Console.PrintMessage("successfully exported" + " " + filename)
