...
public:
    ...
    bool Simulate(const SeaLabAPI::SeaLabSimulationData& Data, mat &dVelocityArray);

	// The simulation function in large scale mode 
    bool SimulateInLargeScaleMode(const SeaLabAPI::SeaLabSimulationData& Data, QString &strFileName);

    bool stationaryWind(const SeaLabAPI::SeaLabSimulationData& Data, mat &dVelocityArray);
