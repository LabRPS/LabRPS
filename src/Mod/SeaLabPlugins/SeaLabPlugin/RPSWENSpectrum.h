...
#ifndef SEALAB_PLUGIN_WEN_PSD_H
#define SEALAB_PLUGIN_WEN_PSD_H
...
class CRPSWENSpectrum : public SeaLabAPI::IrpsSeLFrequencySpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLab::CRPSWENSpectrum);
public:
	CRPSWENSpectrum();
...
public:
   ...
   App::PropertyTime SignificantWavePeriod;
   App::PropertyFloat DepthParameter;
