...
#ifndef SEALAB_PLUGIN_Cos2sType_PSD_H
#define SEALAB_PLUGIN_Cos2sType_PSD_H
...
class CRPSCos2sTypeDirectionalSpreadingFunction: public SeaLabAPI::IrpsSeLDirectionalSpreadingFunction
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLab::CRPSCos2sTypeDirectionalSpreadingFunction);
public:
	CRPSCos2sTypeDirectionalSpreadingFunction();
...
#endif// SEALAB_PLUGIN_Cos2sType_PSD_H