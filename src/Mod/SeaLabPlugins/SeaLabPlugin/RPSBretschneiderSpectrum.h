...
#ifndef SEALAB_PLUGIN_Bretschneider_PSD_H
#define SEALAB_PLUGIN_Bretschneider_PSD_H
...
class CRPSBretschneiderSpectrum : public SeaLabAPI::IrpsSeLFrequencySpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLab::CRPSBretschneiderSpectrum);
public:
	CRPSBretschneiderSpectrum();
...
#endif// SEALAB_PLUGIN_Bretschneider_PSD_H