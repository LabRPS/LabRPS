...
PROPERTY_SOURCE(SeaLab::TargetCorrelation, SeaLabAPI::SeaLabFeatureTableTool)
...
bool TargetCorrelation::OnInitialSetting(const SeaLabAPI::SeaLabSimulationData& Data)
{
	return true;
}

bool TargetCorrelation::ComputeTargetCorrelation(const SeaLabAPI::SeaLabSimulationData& Data, std::vector<double>& tau, std::vector<double>& corr)
{
