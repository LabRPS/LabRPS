...
#ifndef SEALAB_PLUGIN_Scott_PSD_H
#define SEALAB_PLUGIN_Scott_PSD_H
...
class CRPSScottSpectrum : public SeaLabAPI::IrpsSeLFrequencySpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLab::CRPSScottSpectrum);
public:
	CRPSScottSpectrum();
...
#endif// SEALAB_PLUGIN_Scott_PSD_H