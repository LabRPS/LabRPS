...
class RPS_CORE_API UserDefinedPhenomenonLabFeatureDescription
{
public:
    UserDefinedPhenomenonLabFeatureDescription();
    ~UserDefinedPhenomenonLabFeatureDescription();
	...
	bool operator==(const UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureDescription& rhs) const
	{
