...
#ifndef RPSUSERDEFINEDPHENOMENONLABPLUGINAPI_H
#define RPSUSERDEFINEDPHENOMENONLABPLUGINAPI_H
...
////////////////////////////////////////////////////////////////
class RPS_CORE_API RPSUserDefinedPhenomenonLabPluginAPIInfo
{
public:

	static const char * getUserDefinedPhenomenonLabPluginAPIVersion();
};

} //namespace UserDefinedPhenomenonLabAPI

typedef UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod *(*SimulationMethodInitFunc)();
typedef void(*SimulationMethodFreeFunc)(UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod *);
