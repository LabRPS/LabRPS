...
RPS_LOG_LEVEL_INIT("SeaLabFeatureFrequencyDistribution",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureFrequencyDistribution, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureFrequencyDistribution::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureFrequencyDistribution::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureFrequencyDistribution::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureFrequencyDistribution::onChanged(const App::Property* prop)
{
