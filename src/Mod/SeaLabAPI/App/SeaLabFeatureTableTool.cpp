...
RPS_LOG_LEVEL_INIT("SeaLabFeatureTableTool",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureTableTool, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureTableTool::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureTableTool::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureTableTool::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureTableTool::onChanged(const App::Property* prop)
{
