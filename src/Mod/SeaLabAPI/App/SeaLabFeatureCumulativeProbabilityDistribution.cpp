...
RPS_LOG_LEVEL_INIT("SeaLabFeatureCumulativeProbabilityDistribution",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureCumulativeProbabilityDistribution, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureCumulativeProbabilityDistribution::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureCumulativeProbabilityDistribution::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureCumulativeProbabilityDistribution::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureCumulativeProbabilityDistribution::onChanged(const App::Property* prop)
{
