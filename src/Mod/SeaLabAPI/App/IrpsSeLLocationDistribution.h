...
class IrpsSeLLocationDistribution: public SeaLabAPI::SeaLabFeatureLocationDistribution
{

public:
    virtual ~IrpsSeLLocationDistribution() {};

    virtual bool ComputeLocationCoordinateMatrixP3(const SeaLabSimulationData& Data, mat& dLocCoord) = 0;
