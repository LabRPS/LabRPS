...
RPS_LOG_LEVEL_INIT("SeaLabFeatureKurtosis",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureKurtosis, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureKurtosis::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureKurtosis::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureKurtosis::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureKurtosis::onChanged(const App::Property* prop)
{
