...
RPS_LOG_LEVEL_INIT("SeaLabFeatureVariance",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureVariance, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureVariance::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureVariance::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureVariance::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureVariance::onChanged(const App::Property* prop)
{
