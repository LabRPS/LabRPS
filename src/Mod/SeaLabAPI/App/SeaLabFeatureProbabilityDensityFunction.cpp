...
RPS_LOG_LEVEL_INIT("SeaLabFeatureProbabilityDensityFunction",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureProbabilityDensityFunction, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureProbabilityDensityFunction::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureProbabilityDensityFunction::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureProbabilityDensityFunction::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureProbabilityDensityFunction::onChanged(const App::Property* prop)
{
