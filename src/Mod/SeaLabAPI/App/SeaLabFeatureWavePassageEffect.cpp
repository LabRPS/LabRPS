...
RPS_LOG_LEVEL_INIT("SeaLabFeatureWavePassageEffect",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureWavePassageEffect, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureWavePassageEffect::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureWavePassageEffect::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureWavePassageEffect::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureWavePassageEffect::onChanged(const App::Property* prop)
{
