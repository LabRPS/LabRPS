...
RPS_LOG_LEVEL_INIT("SeaLabFeatureRandomness",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureRandomness, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureRandomness::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureRandomness::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureRandomness::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureRandomness::onChanged(const App::Property* prop)
{
