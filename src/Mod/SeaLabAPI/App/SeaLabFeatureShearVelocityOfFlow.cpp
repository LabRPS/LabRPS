...
RPS_LOG_LEVEL_INIT("SeaLabFeatureShearVelocityOfFlow",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureShearVelocityOfFlow, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureShearVelocityOfFlow::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureShearVelocityOfFlow::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureShearVelocityOfFlow::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureShearVelocityOfFlow::onChanged(const App::Property* prop)
{
