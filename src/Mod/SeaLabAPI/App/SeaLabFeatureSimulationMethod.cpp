...
RPS_LOG_LEVEL_INIT("SeaLabFeatureSimulationMethod",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureSimulationMethod, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureSimulationMethod::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureSimulationMethod::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureSimulationMethod::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureSimulationMethod::onChanged(const App::Property* prop)
{
