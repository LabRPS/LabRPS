...
RPS_LOG_LEVEL_INIT("SeaLabFeaturePSDDecompositionMethod",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeaturePSDDecompositionMethod, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeaturePSDDecompositionMethod::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeaturePSDDecompositionMethod::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeaturePSDDecompositionMethod::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeaturePSDDecompositionMethod::onChanged(const App::Property* prop)
{
