...
RPS_LOG_LEVEL_INIT("SeaLabFeatureCoherence",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureCoherence, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureCoherence::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureCoherence::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureCoherence::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureCoherence::onChanged(const App::Property* prop)
{
