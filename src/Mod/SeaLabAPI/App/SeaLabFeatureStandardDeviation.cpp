...
RPS_LOG_LEVEL_INIT("SeaLabFeatureStandardDeviation",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureStandardDeviation, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureStandardDeviation::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureStandardDeviation::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureStandardDeviation::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureStandardDeviation::onChanged(const App::Property* prop)
{
