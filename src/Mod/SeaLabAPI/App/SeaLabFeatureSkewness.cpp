...
RPS_LOG_LEVEL_INIT("SeaLabFeatureSkewness",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeatureSkewness, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeatureSkewness::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeatureSkewness::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeatureSkewness::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeatureSkewness::onChanged(const App::Property* prop)
{
