...
RPS_LOG_LEVEL_INIT("SeaLabFeaturePeakFactor",true,true)

PROPERTY_SOURCE(SeaLabAPI::SeaLabFeaturePeakFactor, SeaLabAPI::SeaLabFeature)
...
short SeaLabFeaturePeakFactor::mustExecute(void) const
{
    return SeaLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeaLabFeaturePeakFactor::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeaLabFeaturePeakFactor::execute(void)
{
    return SeaLabFeature::execute();
}

void SeaLabFeaturePeakFactor::onChanged(const App::Property* prop)
{
