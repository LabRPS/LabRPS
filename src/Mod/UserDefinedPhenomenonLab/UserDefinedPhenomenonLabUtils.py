...
__title__ = "UserDefinedPhenomenonLab Gui Utils"
...
def showSimulationPoints():
    sim = UserDefinedPhenomenonLabGui.getActiveSimulation()
    if not sim:
...
def findAllVertexes():
    ...
    if App.GuiUp:
        import UserDefinedPhenomenonLabGui
        UserDefinedPhenomenonLabGui.UserDefinedPhenomenonLabPyTool.showArray(rows, cols, arr)
        # print(arr)
##  @}