...
import UserDefinedPhenomenonLabObjects
...
def get_information():
    return {
        ...
        "userdefinedphenomenonlabfeature": "SimulationMethod",
    }
...
from userdefinedphenomenonlabexamples.Deodatis1996_SimulationMethod import setup
setup()
...
def setup(doc=None, showGui=True, location = 1):
    ...
    from userdefinedphenomenonlabexamples.Deodatis1996_SpectrumDecomposition import setup
    doc = setup(None, False)

    # get the existing simulation
    sim = UserDefinedPhenomenonLab.getSimulation("Simulation")
    ...
    simMethod = UserDefinedPhenomenonLabObjects.makeFeature("SimulationMethod", "Simulation",  "Deodatis Simulation Method", "Simulation Method")
    ...
    randomness = UserDefinedPhenomenonLabObjects.makeFeature("RandomPhases", "Simulation",  "Uniform Random Phases", "Randomness Provider")
    ...
    CorrelationErgo = UserDefinedPhenomenonLabObjects.makeFeature("CorrelationErgo", "Simulation",  "Correlation Ergodicity Check Tool", "Table Tool")
    ...
    # create new table tool
    pdfCheck = UserDefinedPhenomenonLabObjects.makeFeature("pdfCheck", "Simulation",  "PDF Check Tool", "Table Tool")
    ...
    # create new table tool
    psdErgo = UserDefinedPhenomenonLabObjects.makeFeature("psdErgo", "Simulation", "Ergodicity Check Tool", "Table Tool")
    ...
    if LabRPS.GuiUp and showGui:
        ...
        import UserDefinedPhenomenonLabGui
        #show the mean wind speeds in Alphaplot
        UserDefinedPhenomenonLabGui.UserDefinedPhenomenonLabPyTool.showArray(sim.getSimulationData().numberOfTimeIncrements, sim.getSimulationData().numberOfSpatialPosition + 1, velocities)
