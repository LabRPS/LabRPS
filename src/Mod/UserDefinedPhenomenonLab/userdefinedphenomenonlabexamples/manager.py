...
"""
# setup all examples
from userdefinedphenomenonlabexamples.manager import *
setup_all()
...
# one special example
from userdefinedphenomenonlabexamples.manager import run_example as run
...
def run_simulation(doc, base_name, filepath=""):
    ...
    # filepath
    if filepath == "":
        filepath = join(gettmp(), "USERDEFINEDPHENOMENONLAB_examples")
...
def run_example(example, base_name=None):
    ...
    module = import_module("userdefinedphenomenonlabexamples." + example)
