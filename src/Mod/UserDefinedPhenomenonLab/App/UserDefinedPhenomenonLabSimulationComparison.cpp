...
#include <Mod/UserDefinedPhenomenonLab/App/UserDefinedPhenomenonLabSimulationComparisonPy.h>

using namespace App;
using namespace UserDefinedPhenomenonLab;

PROPERTY_SOURCE(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison, App::DocumentObject)

UserDefinedPhenomenonLabSimulationComparison::UserDefinedPhenomenonLabSimulationComparison()
{
...
void UserDefinedPhenomenonLabSimulationComparison::start()
{

}
void UserDefinedPhenomenonLabSimulationComparison::stop()
{

}

bool UserDefinedPhenomenonLabSimulationComparison::doubleClicked(void)
{
    return true;
}

void UserDefinedPhenomenonLabSimulationComparison::onChanged(const App::Property* prop)
{
...
PyObject* UserDefinedPhenomenonLabSimulationComparison::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        PythonObject = Py::Object(new UserDefinedPhenomenonLabSimulationComparisonPy(this), true);
    }
