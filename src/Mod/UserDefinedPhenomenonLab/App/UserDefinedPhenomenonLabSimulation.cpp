...
#include "UserDefinedPhenomenonlabUtils.h"
...
#include <Mod/UserDefinedPhenomenonLab/App/UserDefinedPhenomenonLabSimulationPy.h>
...
PROPERTY_SOURCE(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation, App::Simulation)

UserDefinedPhenomenonLabSimulation::UserDefinedPhenomenonLabSimulation()
{
    _simuData = new UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabSimulationData();
    ...
    static const char* featuregroup = "UserDefinedPhenomenonlab Features";
...
UserDefinedPhenomenonLabSimulation::~UserDefinedPhenomenonLabSimulation() { delete _simuData; }

void UserDefinedPhenomenonLabSimulation::handleChangedPropertyName(Base::XMLReader& reader, const char* TypeName,            const char* PropName)
{
    Base::Type type = Base::Type::fromName(TypeName);
    App::DocumentObjectGroup::handleChangedPropertyName(reader, TypeName, PropName);
}

void UserDefinedPhenomenonLabSimulation::updateSimulationData()
{
...
bool UserDefinedPhenomenonLabSimulation::run() { return false; }

bool UserDefinedPhenomenonLabSimulation::stop() { return false; }

std::string UserDefinedPhenomenonLabSimulation::getPhenomenonName() const
{
    return UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::rpsPhenomenonWindVelocity.toUtf8().constData();
}

std::string UserDefinedPhenomenonLabSimulation::workbenchName() const { return "UserDefinedPhenomenonLab"; }

void UserDefinedPhenomenonLabSimulation::setSimulationData(UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabSimulationData* simuData)
{
    _simuData = simuData;
}

UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabSimulationData* UserDefinedPhenomenonLabSimulation::getSimulationData() const { return _simuData; }

void UserDefinedPhenomenonLabSimulation::userDefinedPhenomenonFeatureInitalSetting(QString group, QString currentSelected)
{
    if (!_simuData)
        return;
    ...
    if (group == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::objGroupSimulationMethod) {
        UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod* activefeature = static_cast<UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod*>(
...
QStringList UserDefinedPhenomenonLabSimulation::findAllPluggedUserDefinedPhenomenonLabFeatures(QString group)
{
    QStringList theList;
...
QStringList UserDefinedPhenomenonLabSimulation::findAllFeatureMethods(QString group)
{
    QStringList theList;
    theList.append(QString::fromLatin1("<None>"));
    if (group == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::objGroupSimulationMethod) {
        theList.append(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::Simulate);
        theList.append(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::SimulateInLargeScaleMode);
        return theList;
    }
...
UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeature* UserDefinedPhenomenonLabSimulation::createFeature(Base::Type type, std::string pluggedObjectTypeName, std::string name)
{
    ...
    if (type == UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod::getClassTypeId()) {
        UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod* newFeature = CrpsSimulationMethodFactory::BuildObject(pluggedObjectTypeName);
...
void UserDefinedPhenomenonLabSimulation::setEnums(Base::Type type)
{

    if (type == UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod::getClassTypeId()) {
        SimulationMethod.setEnums(findAllUserDefinedPhenomenonLabFeaturesOfThisType(type));
    }
}

void UserDefinedPhenomenonLabSimulation::resetAllEnums()
{
  SimulationMethod.setEnums(findAllUserDefinedPhenomenonLabFeaturesOfThisType(UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod::getClassTypeId()));
}

QStringList UserDefinedPhenomenonLabSimulation::findAllUserDefinedPhenomenonLabFeatures(Base::Type type)
{
...
QStringList UserDefinedPhenomenonLabSimulation::findAllUserDefinedPhenomenonLabFeaturesByGoupAndType(QString group, QString type)
{
    QStringList featureList;
    App::Document* doc = App::GetApplication().getActiveDocument();
    if (!doc) return featureList;
    ...
    for (auto& feat : features) {
       auto myFeat = static_cast<UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeature*>(feat);
...
std::vector<std::string> UserDefinedPhenomenonLabSimulation::findAllUserDefinedPhenomenonLabFeaturesOfThisType(Base::Type type)
{
...
Base::Type UserDefinedPhenomenonLabSimulation::getRPSType(QString group)
{

    if (group == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::objGroupSimulationMethod) {
        return UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod::getClassTypeId();
    }
}

std::vector<Base::Type> UserDefinedPhenomenonLabSimulation::getRPSTypesOfPluggableFeatures()
{
    std::vector<Base::Type> types;
    types.emplace_back(UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod::getClassTypeId());
    return types;
}

std::vector<QString> UserDefinedPhenomenonLabSimulation::getUserDefinedPhenomenonLabPluggableFeatures()
{
    std::vector<QString> groups;
    groups.emplace_back(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::objGroupSimulationMethod);
    return groups;
}

bool UserDefinedPhenomenonLabSimulation::doubleClicked(void) 
{
    return true;
}

void UserDefinedPhenomenonLabSimulation::onChanged(const App::Property* prop)
{
    ...
    LargeScaleSimulationMode.setValue(false);
     ...
     || (prop == &NumberOfIncrementOfVariableX)) {
        ...
        ParameterGrp::handle hGrp = App::GetApplication().GetParameterGroupByPath("User parameter:BaseApp/Preferences/Mod/UserDefinedPhenomenonLab/General");
        int limitAutoAct = hGrp->GetBool("AutomaticLargeScaleModeActivation", true);
    
        hGrp = App::GetApplication().GetParameterGroupByPath("User parameter:BaseApp/Preferences/Mod/UserDefinedPhenomenonLab/Limit");
...
UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureDescription* UserDefinedPhenomenonLabSimulation::GetUserDefinedPhenomenonLabFeatureDescription(const QString& objectGroup, const QString& objName)
{
    UserDefinedPhenomenonLabFeatureDescription* pluggedUserDefinedPhenomenonLabFeatureDescription = new UserDefinedPhenomenonLabFeatureDescription();
   ...
   if (objectGroup == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::objGroupSimulationMethod) {
    ...
    pluggedUserDefinedPhenomenonLabFeatureDescription->PluginName.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())] ->GetPluginName().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->ReleaseDate.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())] ->GetPluginReleaseDate().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->Path.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())]->GetPluginSubFolder().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->Author.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())]->GetPluginAuthor().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->PluginVersion.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())]->GetPluginVersion().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->LabRPSVersion.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())]->GetLabRPSVersion().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->APIVersion.setValue(App::PluginManager::GetInstance().GetInstalledPluginsNameMap()[QString::fromUtf8(pluginName.c_str())]->GetAPIVersion().toUtf8().constData());
    pluggedUserDefinedPhenomenonLabFeatureDescription->ObjectName.setValue(objectName);
    pluggedUserDefinedPhenomenonLabFeatureDescription->Version.setValue(version);
    pluggedUserDefinedPhenomenonLabFeatureDescription->Stationarity.setValue(stationarity);
    pluggedUserDefinedPhenomenonLabFeatureDescription->Description.setValue(descrip);
    pluggedUserDefinedPhenomenonLabFeatureDescription->PublicationTitle.setValue(pubTitle);
    pluggedUserDefinedPhenomenonLabFeatureDescription->PublicationLink.setValue(pubLink);
    pluggedUserDefinedPhenomenonLabFeatureDescription->PublicationAuthor.setValue(pubAuthor);
    pluggedUserDefinedPhenomenonLabFeatureDescription->PublicationDate.setValue(pubDate);

    return pluggedUserDefinedPhenomenonLabFeatureDescription;
}

void UserDefinedPhenomenonLabSimulation::createNewSimulation() {}

PyObject* UserDefinedPhenomenonLabSimulation::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        PythonObject = Py::Object(new UserDefinedPhenomenonLabSimulationPy(this), true);
    }
    return Py::new_reference_to(PythonObject);
}

bool UserDefinedPhenomenonLabSimulation::simulate(mat &dVelocityArray, std::string& featureName)
{
    auto doc = App::GetApplication().getActiveDocument();
    if(!doc)
	    return false;
    UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod* activefeature = static_cast<UserDefinedPhenomenonLabAPI::IrpsULSimulationMethod*>(doc->getObject(_simuData->simulationMethod.getValue()));
    if (!activefeature) {
...
bool UserDefinedPhenomenonLabSimulation::simulateInLargeScaleMode(std::string& featureName)
{
    auto doc = App::GetApplication().getActiveDocument();
    if(!doc)
	    return false;
...
void UserDefinedPhenomenonLabSimulation::setActiveFeature(App::RPSFeature* feature)
{
    if (feature->getTypeId().isDerivedFrom(UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeatureSimulationMethod::getClassTypeId())) {
        _simuData->simulationMethod.setValue(feature->getNameInDocument());  
    }
}

App::RPSFeature* UserDefinedPhenomenonLabSimulation::getActiveFeature(const QString group)
{
    auto doc = App::GetApplication().getActiveDocument();
    if (!doc)
        return nullptr;
...
std::vector<App::RPSFeature*> UserDefinedPhenomenonLabSimulation::getAllFeatures(const QString group)
{
    auto doc = App::GetApplication().getActiveDocument();
    if (!doc)
...
App::DocumentObject* UserDefinedPhenomenonLabSimulation::getActiveSimulationMethod()
{
    auto doc = App::GetApplication().getActiveDocument();
    if (!doc)
        return nullptr;
...
App::DocumentObject*  UserDefinedPhenomenonLabSimulation::addFeature(const std::string featureName, const std::string simulationName, const std::string featureTypeName, const std::string featureGroup)
{
    Base::Type type = getRPSType(QString::fromStdString(featureGroup));
    
    //create the feature
	UserDefinedPhenomenonLabAPI::UserDefinedPhenomenonLabFeature* newFeature = this->createFeature(type, featureTypeName, featureName);

	if (!newFeature)
		return nullptr;

	//set the feature properties
	auto featureProperties = this->GetUserDefinedPhenomenonLabFeatureDescription(QString::fromLatin1(featureGroup.c_str()), QString::fromLatin1(featureTypeName.c_str()));
