 ...
 */
class UserDefinedPhenomenonLabExport UserDefinedPhenomenonLabUtils {

 private:
     UserDefinedPhenomenonLabUtils() {}  // don't allow instancing

 public:
  virtual ~UserDefinedPhenomenonLabUtils() {}  // avoid the warning message
