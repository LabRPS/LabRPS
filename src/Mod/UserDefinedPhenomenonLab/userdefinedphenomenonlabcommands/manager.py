...
__title__ = "USERDEFINEDPHENOMENONLAB command base class"
__author__ = "Koffi Daniel"
__url__ = "https://www.labrps.com"

## @package manager
#  \ingroup USERDEFINEDPHENOMENONLAB
#  \brief USERDEFINEDPHENOMENONLAB command base class
...
class CommandManager(object):
    ...
    def __init__(self):
        ...
        self.command = "USERDEFINEDPHENOMENONLAB" + self.__class__.__name__
    ...
    def IsActive(self):
        if not self.is_active:
            ...
            active = (
                UserDefinedPhenomenonLabGui.getActiveSimulation() is not None
    ...
    def active_simulation_in_active_doc(self):
        simulation = UserDefinedPhenomenonLabGui.getActiveSimulation()
    ...
    def add_obj_on_gui_set_edit(self, objtype):
        LabRPS.ActiveDocument.openTransaction(
            "Create UserDefinedPhenomenonLab{}"
            .format(objtype)
        )
        LabRPSGui.addModule(
            "UserDefinedPhenomenonLabObjects"
        )
        LabRPSGui.addModule(
            "UserDefinedPhenomenonLabGui"
        )
        LabRPSGui.doCommand(
            "UserDefinedPhenomenonLabGui.getActiveSimulation().addObject(UserDefinedPhenomenonLabObjects."
    ...
    def add_obj_on_gui_expand_noset_edit(self, objtype):
        ...
        # add the object
        LabRPSGui.doCommand(
            "addedObj = UserDefinedPhenomenonLabGui.getActiveSimulation().addObject(UserDefinedPhenomenonLabObjects."
    ...
    def add_obj_on_gui_selobj_set_edit(self, objtype):
        ...
        LabRPSGui.doCommand(
            "UserDefinedPhenomenonLabObjects.make{}("
