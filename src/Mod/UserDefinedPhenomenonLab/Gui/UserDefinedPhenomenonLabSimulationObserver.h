...
#ifndef APP_USERDEFINEDPHENOMENONLABSIMULATIONOBSERVER_H
#define APP_USERDEFINEDPHENOMENONLABSIMULATIONOBSERVER_H
...
/**
 * The UserDefinedPhenomenonLabSimulationObserver class manages all simulation objects.
 * @author Werner Mayer
 */
class UserDefinedPhenomenonLabGuiExport UserDefinedPhenomenonLabSimulationObserver: public App::DocumentObserver
{
public:
    /** Creates the only instance of the UserDefinedPhenomenonLabSimulationObserver. */
    static UserDefinedPhenomenonLabSimulationObserver* instance();
...
private:
    UserDefinedPhenomenonLabSimulationObserver();
    ~UserDefinedPhenomenonLabSimulationObserver();
...
private:
    static UserDefinedPhenomenonLabSimulationObserver* _instance;
