...
PyObject* RPSUserDefinedPhenomenonLabPyTool::ShowArray(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSUserDefinedPhenomenonLabPyTool::ShowArrayAsMatrix(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSUserDefinedPhenomenonLabPyTool::ShowValueAsTable(PyObject* self, PyObject* args)
{
    double value;
...
PyObject* RPSUserDefinedPhenomenonLabPyTool::GetActiveTable(PyObject* self, PyObject* args)
{
...
PyObject* RPSUserDefinedPhenomenonLabPyTool::GetActiveMatrix(PyObject* self, PyObject* args)
{
...
PyMethodDef RPSUserDefinedPhenomenonLabPyTool::Methods[] = {
    {"showArray", (PyCFunction)RPSUserDefinedPhenomenonLabPyTool::ShowArray, METH_VARARGS,
    "showArray(row,col,array) - take a python list and display it in Alphaplot table"},
    {"showArrayAsMatrix", (PyCFunction)RPSUserDefinedPhenomenonLabPyTool::ShowArrayAsMatrix, METH_VARARGS,
    "showArrayAsMatrix(row,col,array) - take a python list and display it in Alphaplot matrix"},
    {"showValueAsTable", (PyCFunction)RPSUserDefinedPhenomenonLabPyTool::ShowValueAsTable, METH_VARARGS,
    "showValueAsTable(value) - take a python floating value and display it in Alphaplot table"},
    {"getActiveTable", (PyCFunction)RPSUserDefinedPhenomenonLabPyTool::GetActiveTable, METH_VARARGS,
    "getActiveTable() - return the active AlphaPlot table as python list of lists"},
    {"getActiveMatrix", (PyCFunction)RPSUserDefinedPhenomenonLabPyTool::GetActiveMatrix, METH_VARARGS,
