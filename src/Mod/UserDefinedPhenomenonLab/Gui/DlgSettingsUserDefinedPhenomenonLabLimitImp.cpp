...
#include "ui_DlgSettingsUserDefinedPhenomenonLabLimit.h"
#include <Gui/Application.h>


using namespace UserDefinedPhenomenonLabGui;

DlgSettingsUserDefinedPhenomenonLabLimitImp::DlgSettingsUserDefinedPhenomenonLabLimitImp(QWidget* parent)
    : PreferencePage(parent)
    , ui(new Ui_DlgSettingsUserDefinedPhenomenonLabLimitImp)
{
    ui->setupUi(this);
}

DlgSettingsUserDefinedPhenomenonLabLimitImp::~DlgSettingsUserDefinedPhenomenonLabLimitImp()
{
    // no need to delete child widgets, Qt does it all for us
}

void DlgSettingsUserDefinedPhenomenonLabLimitImp::saveSettings()
{
 ui->cb_lm_AutoLargeScaleMode->onSave();

     ParameterGrp::handle hGrp = App::GetApplication().GetParameterGroupByPath(
        "User parameter:BaseApp/Preferences/Mod/UserDefinedPhenomenonLab/Limit");
...
void DlgSettingsUserDefinedPhenomenonLabLimitImp::loadSettings()
{
 ...
 */
void DlgSettingsUserDefinedPhenomenonLabLimitImp::changeEvent(QEvent* e)
{
...
#include "moc_DlgSettingsUserDefinedPhenomenonLabLimitImp.cpp"
