...
#ifndef RPSUSERDEFINEDPHENOMENONLABPYTHONPLUGIN_UTILITIES
#define RPSUSERDEFINEDPHENOMENONLABPYTHONPLUGIN_UTILITIES
...
{
// Python interface
class UserDefinedPhenomenonLabGuiExport RPSUserDefinedPhenomenonLabPyTool
{
public:
...
#endif // RPSUSERDEFINEDPHENOMENONLABPYTHONPLUGIN_UTILITIES