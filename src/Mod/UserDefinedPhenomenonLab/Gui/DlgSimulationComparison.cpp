...
/* TRANSLATOR UserDefinedPhenomenonLabGui::DlgSimulationComparison */

DlgSimulationComparison::DlgSimulationComparison(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison* comparison, QWidget* parent)
    : QWidget(parent), ui(new Ui_DlgSimulationComparison), _comparison(comparison)
{
	...
	UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim1 = static_cast<UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation*>(UserDefinedPhenomenonLabGui::UserDefinedPhenomenonLabSimulationObserver::instance()->getSimulation(simeName1.toUtf8().constData()));

	QString simeName2 = ui->comboBox_Sim_Candidate2->currentText();
	UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim2 = static_cast<UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation*>(UserDefinedPhenomenonLabGui::UserDefinedPhenomenonLabSimulationObserver::instance()->getSimulation(simeName2.toUtf8().constData()));
    
	std::vector<QString> groups = sim1->getUserDefinedPhenomenonLabPluggableFeatures();
...
{
	UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim1 = static_cast<UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation*> (UserDefinedPhenomenonLabGui::UserDefinedPhenomenonLabSimulationObserver::instance()->getSimulation(ui->comboBox_Sim_Candidate1->currentText().toUtf8().constData()));
	UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim2 = static_cast<UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation*> (UserDefinedPhenomenonLabGui::UserDefinedPhenomenonLabSimulationObserver::instance()->getSimulation(ui->comboBox_Sim_Candidate2->currentText().toUtf8().constData()));
...
void DlgSimulationComparison::fillPluggedFeatureComboBox(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim, QComboBox* comboBox)
{
	comboBox->clear();
	if (sim)
	{
		QString userDefinedPhenomenonGroup = ui->comboBox_FeatureGroup->currentText();
		QStringList plugginGroupObject = sim->findAllPluggedUserDefinedPhenomenonLabFeatures(userDefinedPhenomenonGroup);
        comboBox->addItems(plugginGroupObject);

	}
}

void DlgSimulationComparison::fillFeatureMethodComboBoxCandidate(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim, QComboBox* comboBox)
{
	comboBox->clear();
	if (sim)
	{
		QString userDefinedPhenomenonGroup = ui->comboBox_FeatureGroup->currentText();
		QStringList plugginGroupObject = sim->findAllFeatureMethods(userDefinedPhenomenonGroup);
        comboBox->addItems(plugginGroupObject);

	}
}

void DlgSimulationComparison::fillFeatureComboBox(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim, QComboBox* comboBox, QString group, QString type)
{
	comboBox->clear();
	if (sim)
	{

		QStringList plugginGroupObject = sim->findAllUserDefinedPhenomenonLabFeaturesByGoupAndType(group, type);
        comboBox->addItems(plugginGroupObject);
...
void DlgSimulationComparison::modifyStandardButtons(QDialogButtonBox* box)
{
    ...
    btn->setText(QApplication::translate("UserDefinedPhenomenonLabGui::DlgSimulationComparison", "&Create"));
}
...
void DlgSimulationComparison::accept()
{
    ...
    auto obj = doc->addObject("UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison", uniqueName.c_str());
	doc->commitTransaction();
	UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison* comparison = static_cast<UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison*>(obj);
...
DlgSimulationComparisonEdit::DlgSimulationComparisonEdit(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulationComparison* comparison)
{
...
void DlgSimulationComparisonEdit::modifyStandardButtons(QDialogButtonBox* box)
{
	...
	{
    QPushButton* btn = box->button(QDialogButtonBox::Ok);
    btn->setText(QApplication::translate("UserDefinedPhenomenonLabGui::DlgSimulationComparisonEdit", "&Save"));
	}
	else
	{
    QPushButton* btn = box->button(QDialogButtonBox::Ok);
    btn->setText(QApplication::translate("UserDefinedPhenomenonLabGui::DlgSimulationComparisonEdit", "&Create"));
	}
