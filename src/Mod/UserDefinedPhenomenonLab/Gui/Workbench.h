...
#ifndef USERDEFINEDPHENOMENONLAB_WORKBENCH_H
#define USERDEFINEDPHENOMENONLAB_WORKBENCH_H
 ...
 * @author Werner Mayer
 */
class UserDefinedPhenomenonLabGuiExport Workbench : public Gui::StdWorkbench
{
    TYPESYSTEM_HEADER();
...
private:
    ...
    void ULWriteAllTobeInstallObjectsToRegistry();
    void ULReadAllTobeInstallObjectsFromRegistry();

    void ULWriteAllTobeInstallObjPublicationTitleToRegistry();
    void ULReadAllTobeInstallObjPublicationTitleToRegistry();

    void ULWriteAllTobeInstallObjPublicationLinkToRegistry();
    void ULReadAllTobeInstallObjPublicationLinkToRegistry();

    void ULWriteAllTobeInstallObjPublicationAuthorToRegistry();
    void ULReadAllTobeInstallObjPublicationAuthorToRegistry();

    void ULWriteAllTobeInstallObjPublicationDateToRegistry();
    void ULReadAllTobeInstallObjPublicationDateToRegistry();

    void ULWriteAllTobeInstallObjVersionToRegistry();
    void ULReadAllTobeInstallObjVersionToRegistry();
    void ULClearAllTobeInstallObjectsFromRegistry();
...
#endif // USERDEFINEDPHENOMENONLAB_WORKBENCH_H
