...
#include "UserDefinedPhenomenonLabAllFeaturesComputation.h"
...
UserDefinedPhenomenonLabAllFeaturesComputation::UserDefinedPhenomenonLabAllFeaturesComputation(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim, QObject* parent)
    : m_sim(sim), QObject(parent)
{ 
}

UserDefinedPhenomenonLabAllFeaturesComputation::~UserDefinedPhenomenonLabAllFeaturesComputation()
{
    
}

RPSUserDefinedPhenomenonLabSimulationWorker *UserDefinedPhenomenonLabAllFeaturesComputation::GetUserDefinedPhenomenonLabSimulationWorker()
{
    return simulationWorker;
}

QThread* UserDefinedPhenomenonLabAllFeaturesComputation::getUserDefinedPhenomenonLabSimulationThread()
{ return simulationThread; }


QString UserDefinedPhenomenonLabAllFeaturesComputation::logSimulationInfo(bool status, const QString &name) {
    ...
    QString table;
    table = UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::makeHtmlTable(7, 2, false, profile);

    table = table.arg(tr("Computation Time"), QString::number(GetUserDefinedPhenomenonLabSimulationWorker()->getSimulationTime()/1000) + QString::fromLatin1(" seconds"));
...
void UserDefinedPhenomenonLabAllFeaturesComputation::startSimulationWorker(QString function, const char* complexNumberDisplay)
{
    // create the worker
    simulationWorker = new RPSUserDefinedPhenomenonLabSimulationWorker(m_sim);
    ...
    connect(this, SIGNAL(stopped()), simulationWorker, SLOT(RPSUserDefinedPhenomenonLabSimulationWorker::stop()), Qt::DirectConnection);
...
void UserDefinedPhenomenonLabAllFeaturesComputation::slotDisplayResultInTable(QString str, int what)
{
    if (what == 1)
    {
...
void UserDefinedPhenomenonLabAllFeaturesComputation::slotDisplayResultInMatrix(QString str, int what)
{
    if (what == 1)
    {
...
void UserDefinedPhenomenonLabAllFeaturesComputation::setComplexNumberDisplay(const char* displayType)
{
