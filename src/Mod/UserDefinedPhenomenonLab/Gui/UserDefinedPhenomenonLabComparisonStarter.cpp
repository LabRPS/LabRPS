...
#include "UserDefinedPhenomenonLabComparisonStarter.h"
...
UserDefinedPhenomenonLabComparisonStarter::UserDefinedPhenomenonLabComparisonStarter(UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim1,UserDefinedPhenomenonLab::UserDefinedPhenomenonLabSimulation* sim2, std::string comparisonName, QObject* parent)
    : m_sim1(sim1), m_sim2(sim2), m_comparisonName(comparisonName), QObject(parent)
{ 
}

UserDefinedPhenomenonLabComparisonStarter::~UserDefinedPhenomenonLabComparisonStarter()
{
    
}

RPSUserDefinedPhenomenonLabSimulationWorker *UserDefinedPhenomenonLabComparisonStarter::GetUserDefinedPhenomenonLabSimulationWorker1()
{
    return simulationWorker1;
}

RPSUserDefinedPhenomenonLabSimulationWorker* UserDefinedPhenomenonLabComparisonStarter::GetUserDefinedPhenomenonLabSimulationWorker2()
{
    return simulationWorker2;
}

QThread* UserDefinedPhenomenonLabComparisonStarter::getUserDefinedPhenomenonLabSimulationThread1()
{ 
    return simulationThread1; 
}

QThread* UserDefinedPhenomenonLabComparisonStarter::getUserDefinedPhenomenonLabSimulationThread2() 
{ 
    return simulationThread2; 
}

std::string UserDefinedPhenomenonLabComparisonStarter::getComparisonName()
{ return m_comparisonName; }

QString UserDefinedPhenomenonLabComparisonStarter::logSimulationInfo(bool status, const QString &name) {
    ...
    UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::TableColorProfile profile =
        UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::TableColorProfile::Success;
    
    if (status != true)
        profile = UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::TableColorProfile::Failure;

    QString table;
    table = UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::makeHtmlTable(7, 3, false, profile);

    table = table.arg(tr("Computation Time"), QString::number(GetUserDefinedPhenomenonLabSimulationWorker1()->getSimulationTime()/1000) + QString::fromLatin1(" seconds"), QString::number(GetUserDefinedPhenomenonLabSimulationWorker2()->getSimulationTime()/1000) + QString::fromLatin1(" seconds"));
...
void UserDefinedPhenomenonLabComparisonStarter::startSimulationWorker(QString function, const char* complexNumberDisplay)
{
    // create a worker
    simulationWorker1 = new RPSUserDefinedPhenomenonLabSimulationWorker(m_sim1);
    simulationWorker2 = new RPSUserDefinedPhenomenonLabSimulationWorker(m_sim2);
    ...
    connect(this, SIGNAL(stopped()), simulationWorker1, SLOT(RPSUserDefinedPhenomenonLabSimulationWorker::stop()), Qt::DirectConnection);
    connect(this, SIGNAL(stopped()), simulationWorker2, SLOT(RPSUserDefinedPhenomenonLabSimulationWorker::stop()), Qt::DirectConnection);
 ...
 if(function == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::Simulate)
        {
    ...
    else if(function == UserDefinedPhenomenonLab::UserDefinedPhenomenonLabUtils::SimulateInLargeScaleMode) {
        simulationWorker1->setComputingFunction(function);
        simulationWorker2->setComputingFunction(function);
...
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInTable(QString str, int what)
{
    if (what == 1)
    {
...
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInMatrix(QString str, int what)
{
    if (what == 1)
    {
...
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInTable1(QString str, int what)
{
    slotDisplayResultInTable(str, what);
}
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInMatrix1(QString str, int what)
{
    slotDisplayResultInMatrix(str, what);
}
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInTable2(QString str, int what)
{
    slotDisplayResultInTable(str, what);
}
void UserDefinedPhenomenonLabComparisonStarter::slotDisplayResultInMatrix2(QString str, int what)
{
    slotDisplayResultInMatrix(str, what);
}

void UserDefinedPhenomenonLabComparisonStarter::setComplexNumberDisplay(const char* displayType)
{
