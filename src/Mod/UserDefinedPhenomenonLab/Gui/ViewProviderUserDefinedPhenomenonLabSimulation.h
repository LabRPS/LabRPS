...
#ifndef USERDEFINEDPHENOMENONLAB_ViewProviderSimulation_H
#define USERDEFINEDPHENOMENONLAB_ViewProviderSimulation_H
...
class UserDefinedPhenomenonLabGuiExport ViewProviderUserDefinedPhenomenonLabSimulation: public Gui::ViewProviderDocumentObjectGroup
{
    Q_DECLARE_TR_FUNCTIONS(UserDefinedPhenomenonLabGui::ViewProviderUserDefinedPhenomenonLabSimulation)
    PROPERTY_HEADER_WITH_OVERRIDE(UserDefinedPhenomenonLabGui::ViewProviderUserDefinedPhenomenonLabSimulation);

public:
    /// constructor.
    ViewProviderUserDefinedPhenomenonLabSimulation();

    /// destructor.
    virtual ~ViewProviderUserDefinedPhenomenonLabSimulation();
...
#endif // USERDEFINEDPHENOMENONLAB_ViewProviderSimulation_H
