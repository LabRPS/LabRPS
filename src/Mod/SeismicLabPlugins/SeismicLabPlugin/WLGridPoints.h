...
#ifndef SEISMICLAB_PLUGIN_GRIDPOINTS_H
#define SEISMICLAB_PLUGIN_GRIDPOINTS_H
...
class WLGridPoints : public SeismicLabAPI::IrpsSLLocationDistribution
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::WLGridPoints);
...
#endif // SEISMICLAB_PLUGIN_GRIDPOINTS_H
