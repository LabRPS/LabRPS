...
PROPERTY_SOURCE(SeismicLab::CWLVerticalUniformDistribution, SeismicLabAPI::SeismicLabFeatureLocationDistribution)
...
bool CWLVerticalUniformDistribution::OnInitialSetting(const SeismicLabAPI::SeismicLabSimulationData& Data)
{
    SeismicLabGui::VerticalLocationDistributionDialogEdit* dlg = new SeismicLabGui::VerticalLocationDistributionDialogEdit(LowestPoint, Spacing,Data.spatialDistribution);
