...
#ifndef SEISMICLAB_PLUGIN_CLOUGHPENZIENPSD_H
#define SEISMICLAB_PLUGIN_CLOUGHPENZIENPSD_H
...
class CRPSCloughPenzienSpectrum : public SeismicLabAPI::IrpsSLSpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::CRPSCloughPenzienSpectrum);
public:
	CRPSCloughPenzienSpectrum();
...
public:
    ...
    App::PropertyFrequency SecondFilterLayerFrequency;
    App::PropertyFloat SecondFilterLayerDampingRatio;
