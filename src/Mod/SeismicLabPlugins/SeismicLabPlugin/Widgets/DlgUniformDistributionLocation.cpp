...
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/ui_DlgUniformDistributionLocation.h>
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/WLUniformDistributionLocations.h>
...
/* TRANSLATOR SeismicLabGui::DlgUniformLocationDistribution */
...
void DlgUniformLocationDistribution::accept()
{
    ...
    SeismicLab::WLUniformDistributionLocations* activefeature = static_cast<SeismicLab::WLUniformDistributionLocations*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
