...
#ifndef SEISMICLABGUI_DlgUniformLocationDistribution_H
#define SEISMICLABGUI_DlgUniformLocationDistribution_H
...
#endif // SEISMICLABGUI_DlgUniformLocationDistribution_H
