...
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/ui_DlgWavePassageEffect.h>
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/RPSWavePassageEffect.h>
...
/* TRANSLATOR SeismicLabGui::DlgWavePassageEffect */
...
void DlgWavePassageEffect::accept()
{
    ...
    SeismicLab::CRPSWavePassageEffect* activefeature = static_cast<SeismicLab::CRPSWavePassageEffect*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
