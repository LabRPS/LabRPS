...
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/ui_DlgRandomPhasesFromFile.h>
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/RPSRandomPhasesFromFile.h>
...
/* TRANSLATOR SeismicLabGui::DlgRandomPhasesFromFile */
...
void DlgRandomPhasesFromFile::accept()
{
    ...
    if(!doc)
	    return;
    SeismicLab::CRPSRandomPhasesFromFile* activefeature = static_cast<SeismicLab::CRPSRandomPhasesFromFile*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
