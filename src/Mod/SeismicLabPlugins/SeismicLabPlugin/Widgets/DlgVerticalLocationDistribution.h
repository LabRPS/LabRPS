...
#ifndef SEISMICLABGUI_DlgVerticalLocationDistribution_H
#define SEISMICLABGUI_DlgVerticalLocationDistribution_H
...
#endif // SEISMICLABGUI_DlgVerticalLocationDistribution_H
