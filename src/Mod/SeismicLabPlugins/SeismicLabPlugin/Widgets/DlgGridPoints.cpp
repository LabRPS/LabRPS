...
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/ui_DlgGridPoints.h>
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/WLGridPoints.h>
...
/* TRANSLATOR SeismicLabGui::DlgGridPoints */
...
void DlgGridPoints::accept()
{
    ...
    SeismicLab::WLGridPoints* activefeature = static_cast<SeismicLab::WLGridPoints*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
