...
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/ui_DlgHorizontalLocationDistribution.h>
#include <Mod/SeismicLabPlugins/SeismicLabPlugin/WLHorizontalUniformDistribution.h>
...
/* TRANSLATOR SeismicLabGui::DlgHorizontalLocationDistribution */
...
void DlgHorizontalLocationDistribution::accept()
{
    ...
    if(!doc)
	    return;
    SeismicLab::CWLHorizontalUniformDistribution* activefeature = static_cast<SeismicLab::CWLHorizontalUniformDistribution*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
