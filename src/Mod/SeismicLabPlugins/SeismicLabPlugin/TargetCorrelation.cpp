...
PROPERTY_SOURCE(SeismicLab::TargetCorrelation, SeismicLabAPI::SeismicLabFeatureTableTool)
...
bool TargetCorrelation::TableToolCompute(const SeismicLabAPI::SeismicLabSimulationData& Data, const mat& inputTable, mat& outputTable)
{
...
bool TargetCorrelation::OnInitialSetting(const SeismicLabAPI::SeismicLabSimulationData& Data)
{
	return true;
}

bool TargetCorrelation::ComputeTargetCorrelation(const SeismicLabAPI::SeismicLabSimulationData& Data, std::vector<double>& tau, std::vector<double>& corr)
{
	...
	returnResult = CRPSSeismicLabFramework::ComputeCrossSpectrumVectorF(Data, locationJ, locationK, time, frequencies, Sij);
