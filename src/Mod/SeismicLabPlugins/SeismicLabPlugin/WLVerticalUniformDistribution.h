...
#ifndef SEISMICLAB_PLUGIN_VERTICALUNIFSD_H
#define SEISMICLAB_PLUGIN_VERTICALUNIFSD_H
...
class CWLVerticalUniformDistribution : public SeismicLabAPI::IrpsSLLocationDistribution
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::CWLVerticalUniformDistribution);
...
#endif // SEISMICLAB_PLUGIN_VERTICALUNIFSD_H