...
#ifndef SEISMICLAB_PLUGIN_KANAITAJIMIPSD_H
#define SEISMICLAB_PLUGIN_KANAITAJIMIPSD_H
...
class CRPSKanaiTajimiSpectrum : public SeismicLabAPI::IrpsSLSpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::CRPSKanaiTajimiSpectrum);
public:
	CRPSKanaiTajimiSpectrum();
...
#endif// SEISMICLAB_PLUGIN_KANAITAJIMIPSD_H