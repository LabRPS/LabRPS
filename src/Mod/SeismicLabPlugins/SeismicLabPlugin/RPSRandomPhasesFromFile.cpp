...
PROPERTY_SOURCE(SeismicLab::CRPSRandomPhasesFromFile, SeismicLabAPI::SeismicLabFeatureRandomness)
...
int CRPSRandomPhasesFromFile::ReadPhaseAngleFromFile(const SeismicLabAPI::SeismicLabSimulationData& Data, QString file_path, mat &dRandomValueArray)
{
