...
#ifndef SEISMICLAB_PLUGIN_UNIFSD_H
#define SEISMICLAB_PLUGIN_UNIFSD_H
...
class WLUniformDistributionLocations : public SeismicLabAPI::IrpsSLLocationDistribution
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::WLUniformDistributionLocations);
