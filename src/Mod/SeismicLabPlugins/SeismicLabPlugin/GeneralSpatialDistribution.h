...
#ifndef SEISMICLAB_PLUGIN_GENERALSD_H
#define SEISMICLAB_PLUGIN_GENERALSD_H
...
class GeneralSpatialDistribution : public SeismicLabAPI::IrpsSLLocationDistribution
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLab::GeneralSpatialDistribution);
...
#endif // SEISMICLAB_PLUGIN_GENERALSD_H
