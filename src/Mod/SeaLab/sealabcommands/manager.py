...
__title__ = "SEALAB command base class"
__author__ = "Koffi Daniel"
__url__ = "https://www.labrps.com"

## @package manager
#  \ingroup SEALAB
#  \brief SEALAB command base class
...
class CommandManager(object):
    ...
    def __init__(self):
        ...
        self.command = "SEALAB" + self.__class__.__name__
    ...
    def IsActive(self):
        if not self.is_active:
            ...
            active = (
                SeaLabGui.getActiveSimulation() is not None
    ...
    def active_simulation_in_active_doc(self):
        simulation = SeaLabGui.getActiveSimulation()
    ...
    def add_obj_on_gui_set_edit(self, objtype):
        ...
        LabRPSGui.doCommand(
            "SeaLabGui.getActiveSimulation().addObject(SeaLabObjects."
    ...
    def add_obj_on_gui_expand_noset_edit(self, objtype):
        ...
        # add the object
        LabRPSGui.doCommand(
            "addedObj = SeaLabGui.getActiveSimulation().addObject(SeaLabObjects."
