...
#ifndef SEALABGUI_VIEWPROVIDERSEALABFEATURESHEARVELO_H
#define SEALABGUI_VIEWPROVIDERSEALABFEATURESHEARVELO_H
...
class SeaLabGuiExport ViewProviderSeaLabFeatureShearVelocityOfFlow : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLabGui::ViewProviderSeaLabFeatureShearVelocityOfFlow);

public:
    /// constructor
    ViewProviderSeaLabFeatureShearVelocityOfFlow();
    /// destructor
    virtual ~ViewProviderSeaLabFeatureShearVelocityOfFlow();
...
#endif // SEALABGUI_VIEWPROVIDERSEALABFEATURESHEARVELO_H
