...
#ifndef SEALABGUI_VIEWPROVIDERSEALABFEATURECORRELATION_H
#define SEALABGUI_VIEWPROVIDERSEALABFEATURECORRELATION_H
...
class SeaLabGuiExport ViewProviderSeaLabFeatureCorrelation : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLabGui::ViewProviderSeaLabFeatureCorrelation);

public:
    /// constructor
    ViewProviderSeaLabFeatureCorrelation();
    /// destructor
    virtual ~ViewProviderSeaLabFeatureCorrelation();
...
#endif // SEALABGUI_VIEWPROVIDERSEALABFEATURECORRELATION_H
