...
#ifndef SEALABGUI_VIEWPROVIDERSEALAB_FEATURE_DIRECTIONALSPECTRUM_H
#define SEALABGUI_VIEWPROVIDERSEALAB_FEATURE_DIRECTIONALSPECTRUM_H
...
class SeaLabGuiExport ViewProviderSeaLabFeatureDirectionalSpreadingFunction : public Gui::ViewProviderRPSFeature
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLabGui::ViewProviderSeaLabFeatureDirectionalSpreadingFunction);

public:
    /// constructor
    ViewProviderSeaLabFeatureDirectionalSpreadingFunction();
    /// destructor
    virtual ~ViewProviderSeaLabFeatureDirectionalSpreadingFunction();
...
#endif // SEALABGUI_VIEWPROVIDERSEALAB_FEATURE_DIRECTIONALSPECTRUM_H
