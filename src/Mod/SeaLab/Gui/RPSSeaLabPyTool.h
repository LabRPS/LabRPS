...
#ifndef RPSSEALABPYTHONPLUGIN_UTILITIES
#define RPSSEALABPYTHONPLUGIN_UTILITIES
...
{
// Python interface
class SeaLabGuiExport RPSSeaLabPyTool
{
public:
...
#endif // RPSSEALABPYTHONPLUGIN_UTILITIES