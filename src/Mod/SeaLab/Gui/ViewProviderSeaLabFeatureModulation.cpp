...
PROPERTY_SOURCE(SeaLabGui::ViewProviderSeaLabFeatureModulation, Gui::ViewProviderRPSFeature)
...
void ViewProviderSeaLabFeatureModulation::setupContextMenu(QMenu* menu, QObject*, const char*)
{
    ...
    func->trigger(gtp, boost::bind(&ViewProviderSeaLabFeatureModulation::goToPublication, this));

    QAction* gtw = menu->addAction(QObject::tr("Go to Wiki"));
    func->trigger(gtw, boost::bind(&ViewProviderSeaLabFeatureModulation::goToWiki, this));
}
