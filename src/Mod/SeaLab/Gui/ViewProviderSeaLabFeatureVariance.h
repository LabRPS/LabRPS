...
#ifndef SEALABGUI_VIEWPROVIDERSEALABFEATUREVARIANCE_H
#define SEALABGUI_VIEWPROVIDERSEALABFEATUREVARIANCE_H
...
class SeaLabGuiExport ViewProviderSeaLabFeatureVariance : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLabGui::ViewProviderSeaLabFeatureVariance);

public:
    /// constructor
    ViewProviderSeaLabFeatureVariance();
    /// destructor
    virtual ~ViewProviderSeaLabFeatureVariance();
...
#endif // SEALABGUI_VIEWPROVIDERSEALABFEATUREVARIANCE_H
