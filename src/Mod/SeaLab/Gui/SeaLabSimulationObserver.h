...
#ifndef APP_SEALABSIMULATIONOBSERVER_H
#define APP_SEALABSIMULATIONOBSERVER_H
...
/**
 * The SeaLabSimulationObserver class manages all simulation objects.
 * @author Werner Mayer
 */
class SeaLabGuiExport SeaLabSimulationObserver: public App::DocumentObserver
{
public:
    /** Creates the only instance of the SeaLabSimulationObserver. */
    static SeaLabSimulationObserver* instance();
...
private:
    static SeaLabSimulationObserver* _instance;
