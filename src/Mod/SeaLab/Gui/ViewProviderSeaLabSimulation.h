...
#ifndef SEALAB_ViewProviderSimulation_H
#define SEALAB_ViewProviderSimulation_H
...
class SeaLabGuiExport ViewProviderSeaLabSimulation: public Gui::ViewProviderDocumentObjectGroup
{
    Q_DECLARE_TR_FUNCTIONS(SeaLabGui::ViewProviderSeaLabSimulation)
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLabGui::ViewProviderSeaLabSimulation);

public:
    /// constructor.
    ViewProviderSeaLabSimulation();

    /// destructor.
    virtual ~ViewProviderSeaLabSimulation();
...
#endif // SEALAB_ViewProviderSimulation_H
