...
#include "ViewProviderSeaLabFeatureCoherencePy.h"
...
#include <Mod/SeaLabAPI/App/IrpsSeLCoherence.h>
...
ViewProviderSeaLabFeatureCoherence::ViewProviderSeaLabFeatureCoherence()
{
    ...
    sPixmap = ":/icons/SeaLabFeatures/SeaLab_Feature_CoherenceObj.svg";
}
...
bool ViewProviderSeaLabFeatureCoherence::doubleClicked(void)
{
    ActivateFeature();
...
bool ViewProviderSeaLabFeatureCoherence::ActivateFeature()
{
...
bool ViewProviderSeaLabFeatureCoherence::setEdit(int ModNum)
{
    Q_UNUSED(ModNum);
...
void ViewProviderSeaLabFeatureCoherence::unsetEdit(int ModNum)
{
    if (ModNum == ViewProvider::Default) {
...
void ViewProviderSeaLabFeatureCoherence::setupContextMenu(QMenu* menu, QObject*, const char*)
{
    // toggle command to display components
    Gui::ActionFunction* func = new Gui::ActionFunction(menu);

    QAction* val = menu->addAction(QObject::tr("ComputeCrossCoherenceValue"));
    func->trigger(val, boost::bind(&ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceValue, this));

    QAction* carrayF = menu->addAction(QObject::tr("ComputeCrossCoherenceVectorF"));
    func->trigger(carrayF, boost::bind(&ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceVectorF, this));

    QAction* carray = menu->addAction(QObject::tr("ComputeCrossCoherenceVectorT"));
    func->trigger(carray, boost::bind(&ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceVectorT, this));

    QAction* carrayPP = menu->addAction(QObject::tr("ComputeCrossCoherenceMatrixPP"));
    func->trigger(carrayPP, boost::bind(&ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceMatrixPP, this));

    QAction* init = menu->addAction(QObject::tr("Setup Feature"));
    func->trigger(init, boost::bind(&ViewProviderSeaLabFeatureCoherence::OnInitialSetting, this));
...
{
   return runFeatureMethod(SeaLab::SeaLabUtils::ComputeCrossCoherenceValue, this->ComplexNumberDisplay.getValueAsString());
}

bool ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceVectorT()
{
    return runFeatureMethod(SeaLab::SeaLabUtils::ComputeCrossCoherenceVectorT, this->ComplexNumberDisplay.getValueAsString());
}

bool ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceVectorF()
{
    return runFeatureMethod(SeaLab::SeaLabUtils::ComputeCrossCoherenceVectorF, this->ComplexNumberDisplay.getValueAsString());
}

bool ViewProviderSeaLabFeatureCoherence::ComputeCrossCoherenceMatrixPP()
{
    return runFeatureMethod(SeaLab::SeaLabUtils::ComputeCrossCoherenceMatrixPP, this->ComplexNumberDisplay.getValueAsString());
}

bool ViewProviderSeaLabFeatureCoherence::OnInitialSetting()
{
ActivateFeature();
    ...
    sim->seaLabFeatureInitalSetting(SeaLab::SeaLabUtils::objGroupCoherenceFunction, QString::fromUtf8(sim->getSimulationData()->coherenceFunction.getValue()));
    return true;
}


void ViewProviderSeaLabFeatureCoherence::onChanged(const App::Property* prop)
{
...
PyObject* ViewProviderSeaLabFeatureCoherence::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        // ref counter is set to 1
        PythonObject = Py::Object(new ViewProviderSeaLabFeatureCoherencePy(this), true);
    }
    return Py::new_reference_to(PythonObject);
}


bool ViewProviderSeaLabFeatureCoherence::runFeatureMethod(const QString function, const char* complexNumberDisplay)
{
