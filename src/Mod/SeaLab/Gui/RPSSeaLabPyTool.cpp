...
PyObject* RPSSeaLabPyTool::ShowArray(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSSeaLabPyTool::ShowArrayAsMatrix(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSSeaLabPyTool::ShowValueAsTable(PyObject* self, PyObject* args)
{
    double value;
...
PyObject* RPSSeaLabPyTool::GetActiveTable(PyObject* self, PyObject* args)
{
...
PyObject* RPSSeaLabPyTool::GetActiveMatrix(PyObject* self, PyObject* args)
{
...
PyMethodDef RPSSeaLabPyTool::Methods[] = {
    {"showArray", (PyCFunction)RPSSeaLabPyTool::ShowArray, METH_VARARGS,
    "showArray(row,col,array) - take a python list and display it in Alphaplot table"},
    {"showArrayAsMatrix", (PyCFunction)RPSSeaLabPyTool::ShowArrayAsMatrix, METH_VARARGS,
    "showArrayAsMatrix(row,col,array) - take a python list and display it in Alphaplot matrix"},
    {"showValueAsTable", (PyCFunction)RPSSeaLabPyTool::ShowValueAsTable, METH_VARARGS,
    "showValueAsTable(value) - take a python floating value and display it in Alphaplot table"},
    {"getActiveTable", (PyCFunction)RPSSeaLabPyTool::GetActiveTable, METH_VARARGS,
    "getActiveTable() - return the active AlphaPlot table as python list of lists"},
    {"getActiveMatrix", (PyCFunction)RPSSeaLabPyTool::GetActiveMatrix, METH_VARARGS,
