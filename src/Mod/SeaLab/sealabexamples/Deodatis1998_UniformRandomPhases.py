...
def get_information():
    return {
        ...
        "sealabfeature": "RandomnessProvider",
    }
...
from sealabexamples.Deodatis1998_UniformRandomPhases import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    randomness = SeaLabObjects.makeFeature("RandomPhases", "Simulation",  "Uniform Random Phases", "Randomness Provider")
