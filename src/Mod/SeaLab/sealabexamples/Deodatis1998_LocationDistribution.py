...
from sealabexamples.Deodatis1998_LocationDistribution import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    loc = SeaLabObjects.makeFeature("SimulationPoints", "Simulation",  "General Distribution", "Location Distribution")
    ...
    myFeatures = sim.findAllSeaLabFeaturesOfThisType('SeaLabAPI::SeaLabFeatureLocationDistribution')
