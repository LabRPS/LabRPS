...
#include <Mod/SeaLab/App/SeaLabSimulationComparisonPy.h>

using namespace App;
using namespace SeaLab;

PROPERTY_SOURCE(SeaLab::SeaLabSimulationComparison, App::DocumentObject)

SeaLabSimulationComparison::SeaLabSimulationComparison()
{
...
void SeaLabSimulationComparison::start()
{

}
void SeaLabSimulationComparison::stop()
{

}

bool SeaLabSimulationComparison::doubleClicked(void)
{
    return true;
}

void SeaLabSimulationComparison::onChanged(const App::Property* prop)
{
...
PyObject* SeaLabSimulationComparison::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        PythonObject = Py::Object(new SeaLabSimulationComparisonPy(this), true);
    }
