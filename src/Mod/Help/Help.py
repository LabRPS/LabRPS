...
"""
Provide tools to access the LabRPS documentation.
...
Basic usage:
    ...
    import Help
    Help.show("Plugin WindLab")
    Help.show("Plugin_WindLab") # works with spaces or underscores
    Help.show("https://wiki.labrps.com/Plugin_WindLab")
    Help.show("https://gitlab.com/labrps/LabRPS-documentation/-/raw/main/wiki/Plugin_WindLab.md")
    Help.show("/home/myUser/.LabRPS/Documentation/Plugin_WindLab.md")
    Help.show("http://myserver.com/myfolder/Plugin_WindLab.html")
...
QT_TRANSLATE_NOOP = LabRPS.Qt.QT_TRANSLATE_NOOP

# texts and icons
WIKI_URL = "https://wiki.labrps.com"
MD_RAW_URL = "https://raw.githubusercontent.com/LabRPS/LabRPS-documentation/main/wiki"
MD_RENDERED_URL = "https://github.com/LabRPS/LabRPS-documentation/blob/main/wiki"
...
PREFS = LabRPS.ParamGet("User parameter:BaseApp/Preferences/Mod/Help")
...
def show(page, view=None, conv=None):
    ...
    LabRPS.Console.PrintLog("Help: opening " + location + "\n")
    if not location:
        LabRPS.Console.PrintError(LOCTXT + "\n")
        return
    ...
    if PREFS.GetBool("optionWiki", True):  # default
        ...
        if not location:
            location = os.path.join(
                LabRPS.getUserAppDataDir(),
                "Mod",
                "offline-documentation",
                "LabRPS-documentation-main",
                "wiki",
            )
...
def get_qtwebwidgets(html, baseurl, title):
    ...
    try:
        ...
        LabRPS.Console.PrintLog(LOGTXT + "\n")
        import WebGui
...
def convert(content, force=None):
    ...
    if False:  # linked CSS file
        # below code doesn't work in LabRPS apparently because it prohibits cross-URL stuff
...
def add_preferences_page():
    ...
    LabRPSGui.addPreferencePage(page, QT_TRANSLATE_NOOP("QObject", "General"))


def add_language_path():
    """registers the Help translations to LabRPS"""
...
def openBrowserHTML(html, baseurl, title, icon, dialog=False):
    """creates a browser view and adds it as a LabRPS MDI tab or dockable dialog"""
