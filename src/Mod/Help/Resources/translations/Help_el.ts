...
the default location ($USERAPPDATADIR/Mod/offline-documentation).</translation>
    ...
    <message>
      ...
      <translation>Wiki LabRPS (online)</translation>
    </message>
    <message>
...
LabRPSwiki στο https://wiki.labrps.com</translation>
    </message>
    <message>
...
&apos;Pandoc&apos; Python module should be installed for optimal results.</source>
      <translation>Οι σελίδες τεκμηρίωσης θα ληφθούν από μια αυτόματη μετατροπή Markdown του wiki LabRPS, που φιλοξενείται στον λογαριασμό GitHub του LabRPS. Αυτό μπορεί να διαμορφωθεί με ένα προσαρμοσμένο φύλλο στυλ παρακάτω και μπορεί να φαίνεται πιο ωραίο από την επιλογή wiki. Το &apos;Markdown&apos; ή
&apos;Pandoc&apos; Θα πρέπει να εγκατασταθεί η ενότητα Python για βέλτιστα αποτελέσματα.</translation>
    ...
    <message>
      ...
      <translation>Η τεκμηρίωση θα ανοίξει σε μια νέα καρτέλα μέσα στη διεπαφή LabRPS.</translation>
    </message>
    <message>
      <location filename="../../dlgPreferencesHelp.ui" line="173"/>
      <source>In a LabRPS tab</source>
      <translation>Σε μια καρτέλα LabRPS</translation>
    </message>
    <message>
