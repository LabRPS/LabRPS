...
/* Python entry */
PyMOD_INIT_FUNC(SeismicLab)
{
     //load dependent module
    try {
        Base::Interpreter().runString("import SeismicLabAPI");
        Base::Interpreter().runString("import SeismicLabTools");
    ...
    PyObject* seismiclabModule = SeismicLab::initModule();
