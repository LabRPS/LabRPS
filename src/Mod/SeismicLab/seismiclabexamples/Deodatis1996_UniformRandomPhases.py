...
from seismiclabexamples.Deodatis1996_UniformRandomPhases import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    if LabRPS.GuiUp and showGui:
        ...
        GeneralToolsGui.GeneralToolsPyTool.showArray(sim.getSimulationData().numberOfFrequency, sim.getSimulationData().numberOfSpatialPosition, randomnesses)
