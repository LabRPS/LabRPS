...
def get_information():
    return {
        "name": "Deodatis 1998 et al Uniform Random Phases",
        "seismiclabfeature": "RandomnessProvider",
    }
...
from seismiclabexamples.Deodatis1998_UniformRandomPhases import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    if LabRPS.GuiUp and showGui:
        ...
        SeismicLabGui.SeismicLabPyTool.showArray(sim.getSimulationData().numberOfFrequency, sim.getSimulationData().numberOfSpatialPosition, randomnesses)
