...
"""
# setup all examples
from seismiclabexamples.manager import *
setup_all()
...
# one special example
from seismiclabexamples.manager import run_example as run
...
def run_simulation(doc, base_name, filepath=""):
    ...
    # filepath
    if filepath == "":
        filepath = join(gettmp(), "SEISMICLAB_examples")
...
def run_example(example, base_name=None):
    ...
    module = import_module("seismiclabexamples." + example)
