...
from seismiclabexamples.Deodatis1998_LocationDistribution import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    myFeatures = sim.findAllSeismicLabFeaturesOfThisType('SeismicLabAPI::SeismicLabFeatureLocationDistribution')
