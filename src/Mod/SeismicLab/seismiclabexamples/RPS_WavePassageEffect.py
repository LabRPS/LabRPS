...
def get_information():
    return {
        ...
        "seismiclabfeature": "WavePassageEffect",
    }
...
from seismiclabexamples.RPS_WavePassageEffect import setup
setup()
...
# init LabRPS document. New document will be created if the passed document is null.
    ...
    mean = SeismicLabObjects.makeFeature("MeanAcceleration", "Simulation",  "Logarithmic Law Profile", "Mean Acceleration")
    ...
    wavepassageEff = SeismicLabObjects.makeFeature("WavePassageEffect", "Simulation", "Exponential Wave Passage effect", "Wave Passage Effect")
    ...
    if LabRPS.GuiUp and showGui:
        ...
        SeismicLabGui.SeismicLabPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, wpe12)
        SeismicLabGui.SeismicLabPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, wpe13)
        SeismicLabGui.SeismicLabPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, wpe23)
