...
#ifndef SEISMICLABGUI_VIEWPROVIDERSEISMICLABFEATURESHEARVELO_H
#define SEISMICLABGUI_VIEWPROVIDERSEISMICLABFEATURESHEARVELO_H
...
class SeismicLabGuiExport ViewProviderSeismicLabFeatureShearVelocityOfFlow : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeismicLabGui::ViewProviderSeismicLabFeatureShearVelocityOfFlow);

public:
    /// constructor
    ViewProviderSeismicLabFeatureShearVelocityOfFlow();
    /// destructor
    virtual ~ViewProviderSeismicLabFeatureShearVelocityOfFlow();
...
#endif // SEISMICLABGUI_VIEWPROVIDERSEISMICLABFEATURESHEARVELO_H
