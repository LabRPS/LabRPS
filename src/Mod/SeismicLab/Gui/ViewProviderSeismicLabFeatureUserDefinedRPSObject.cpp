...
#include "ViewProviderSeismicLabFeatureUserDefinedRPSObjectPy.h"
...
#include <Mod/SeismicLabAPI/App/IrpsSLUserDefinedRPSObject.h>
...
PROPERTY_SOURCE(SeismicLabGui::ViewProviderSeismicLabFeatureUserDefinedRPSObject, Gui::ViewProviderDocumentObject)


ViewProviderSeismicLabFeatureUserDefinedRPSObject::ViewProviderSeismicLabFeatureUserDefinedRPSObject()
{
  sPixmap = ":/icons/SeismicLabFeatures/SeismicLab_Feature_UserDefinedObj.svg";
}
...
bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::doubleClicked(void)
{
    ActivateFeature();
...
bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::ActivateFeature()
{
...
void ViewProviderSeismicLabFeatureUserDefinedRPSObject::setupContextMenu(QMenu* menu, QObject*, const char*)
{
    // toggle command to display components
    Gui::ActionFunction* func = new Gui::ActionFunction(menu);
 
    QAction* userDef = menu->addAction(QObject::tr("UserDefinedRPSObjectCompute"));
    func->trigger(userDef, boost::bind(&ViewProviderSeismicLabFeatureUserDefinedRPSObject::userDefinedRPSObjectCompute, this));

    QAction* init = menu->addAction(QObject::tr("Setup Feature"));
    func->trigger(init, boost::bind(&ViewProviderSeismicLabFeatureUserDefinedRPSObject::OnInitialSetting, this));

    QAction* act = menu->addAction(QObject::tr("Activate Feature"));
    func->trigger(act, boost::bind(&ViewProviderSeismicLabFeatureUserDefinedRPSObject::ActivateFeature, this));
}

bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::userDefinedRPSObjectCompute()
{
    
    return runFeatureMethod(SeismicLab::SeismicLabUtils::UserDefinedRPSObjectCompute);
    
}

bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::OnInitialSetting()
{
ActivateFeature();
    ...
    sim->seismicLabFeatureInitalSetting(SeismicLab::SeismicLabUtils::objGroupUserDefinedRPSObject, QString::fromUtf8(sim->getSimulationData()->userDefinedRPSObject.getValue()));

    return true;
}

bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::setEdit(int ModNum)
{
    Q_UNUSED(ModNum);
...
void ViewProviderSeismicLabFeatureUserDefinedRPSObject::unsetEdit(int ModNum)
{
    if (ModNum == ViewProvider::Default) {
...
PyObject* ViewProviderSeismicLabFeatureUserDefinedRPSObject::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        // ref counter is set to 1
        PythonObject = Py::Object(new ViewProviderSeismicLabFeatureUserDefinedRPSObjectPy(this), true);
    }
    return Py::new_reference_to(PythonObject);
}

bool ViewProviderSeismicLabFeatureUserDefinedRPSObject::runFeatureMethod(const QString function, const char* complexNumberDisplay)
{  
ActivateFeature();
    SeismicLab::SeismicLabSimulation* sim = static_cast<SeismicLab::SeismicLabSimulation*>(SeismicLabGui::SeismicLabSimulationObserver::instance()->active());
    if (!sim) {Base::Console().Warning("No valide active simulation found.\n");return false;}
