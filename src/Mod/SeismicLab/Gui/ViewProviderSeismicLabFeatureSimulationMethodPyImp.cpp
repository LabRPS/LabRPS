...
#include "ViewProviderSeismicLabFeatureSimulationMethodPy.cpp"
...
std::string ViewProviderSeismicLabFeatureSimulationMethodPy::representation(void) const
{
    return std::string("<ViewProviderSeismicLabFeatureSimulationMethod object>");
}

PyObject* ViewProviderSeismicLabFeatureSimulationMethodPy::simulate(PyObject* args)
{
...
int ViewProviderSeismicLabFeatureSimulationMethodPy::setCustomAttributes(const char* /*attr*/, PyObject* /*obj*/)
{
    return 0;
}
