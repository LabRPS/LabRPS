...
#ifndef APP_SEISMICLABSIMULATIONOBSERVER_H
#define APP_SEISMICLABSIMULATIONOBSERVER_H
...
/**
 * The SeismicLabSimulationObserver class manages all simulation objects.
 * @author Werner Mayer
 */
class SeismicLabGuiExport SeismicLabSimulationObserver: public App::DocumentObserver
{
public:
    /** Creates the only instance of the SeismicLabSimulationObserver. */
    static SeismicLabSimulationObserver* instance();
...
private:
    static SeismicLabSimulationObserver* _instance;
