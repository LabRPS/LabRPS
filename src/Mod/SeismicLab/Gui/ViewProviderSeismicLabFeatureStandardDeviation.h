...
public:
    /// constructor
    ViewProviderSeismicLabFeatureStandardDeviation();
    /// destructor
    virtual ~ViewProviderSeismicLabFeatureStandardDeviation();
...
#endif // SEISMICLABGUI_VIEWPROVIDERSEISMICLABFEATURESTANDARDDEV_H
