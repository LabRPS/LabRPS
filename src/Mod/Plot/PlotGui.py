...
LabRPSGui.addLanguagePath(":/Plot/translations")
LabRPSGui.addIconPath(":/Plot/icons")


class Save:
    def Activated(self):
        from LabRPS.Plot import plotSave
        plotSave.load()
...
class Axes:
    def Activated(self):
        from LabRPS.Plot import plotAxes
        plotAxes.load()
...
LabRPSGui.addCommand('Plot_SaveFig', Save())
LabRPSGui.addCommand('Plot_Axes', Axes())
LabRPSGui.addCommand('Plot_Series', Series())
LabRPSGui.addCommand('Plot_Grid', Grid())
LabRPSGui.addCommand('Plot_Legend', Legend())
LabRPSGui.addCommand('Plot_Labels', Labels())
LabRPSGui.addCommand('Plot_Positions', Positions())
