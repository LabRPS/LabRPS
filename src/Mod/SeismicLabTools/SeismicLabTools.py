...
__title__  = "SeismicLab Mean Wind Profile"
...
'''The SeismicLabTools provide tools for the calculation involved in SeismicLab. This is where all the computations happen in all SeismicLab built-in features'''
