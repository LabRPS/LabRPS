...
#include "Mod/SeismicLabTools/App/modulation/ExponentialModulationPy.cpp"
...
PyObject* ExponentialModulationPy::computeModulation(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "ddd", &time, &alpha, &beta))
    return nullptr;
    return Py::new_reference_to(Py::Float(getExponentialModulationPtr()->computeModulation(time, alpha, beta)));
}
