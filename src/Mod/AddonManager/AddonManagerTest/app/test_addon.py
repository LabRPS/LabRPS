...
class TestAddon(unittest.TestCase):
    ...
    def setUp(self):
        self.test_dir = os.path.join(LabRPS.getHomePath(), "Mod", "AddonManager", "AddonManagerTest", "data")
    ...
    def test_display_name(self):
        ...
        self.assertEqual(addon.name, "LabRPS")
        self.assertEqual(addon.display_name, "LabRPS")
    ...
    def test_metadata_loading(self):
        ...
        self.assertEqual(url_list[0]["location"],"https://github.com/chennes/LabRPS-Package")
        self.assertEqual(url_list[0]["branch"],"main")
        self.assertEqual(url_list[1]["type"],"readme")
        self.assertEqual(url_list[1]["location"],"https://github.com/chennes/LabRPS-Package/blob/main/README.md")
    ...
    def test_git_url_cleanup(self):
        base_url = "https://github.com/LabRPS/LabRPS"
        test_urls = [f"  {base_url}  ",
                     f"{base_url}.git",
                     f"  {base_url}.git  "]
        for url in test_urls:
            addon = Addon("LabRPS", url, Addon.Status.NOT_INSTALLED, "master")
    ...
    def test_contains_functions(self):
        ...
        # Workbenches
        addon_with_workbench = Addon("LabRPS","https://github.com/LabRPS/LabRPS", Addon.Status.NOT_INSTALLED, "master")
        ...
        # Macros
        addon_with_macro = Addon("LabRPS","https://github.com/LabRPS/LabRPS", Addon.Status.NOT_INSTALLED, "master")
        ...
        # Preference Packs
        addon_with_prefpack = Addon("LabRPS","https://github.com/LabRPS/LabRPS", Addon.Status.NOT_INSTALLED, "master")
        ...
        # Combination
        addon_with_all = Addon("LabRPS","https://github.com/LabRPS/LabRPS", Addon.Status.NOT_INSTALLED, "master")
    ...
    def test_create_from_macro(self):
        macro_file = os.path.join(self.test_dir, "DoNothing.RPSMacro")
        ...
        self.assertEqual(addon.url,"https://github.com/LabRPS/LabRPS")
    ...
    def test_dependency_resolution(self):
        ...
        addonA = Addon("AddonA","https://github.com/LabRPS/FakeAddonA", Addon.Status.NOT_INSTALLED, "master")
        addonB = Addon("AddonB","https://github.com/LabRPS/FakeAddonB", Addon.Status.NOT_INSTALLED, "master")
        addonC = Addon("AddonC","https://github.com/LabRPS/FakeAddonC", Addon.Status.NOT_INSTALLED, "master")
        addonD = Addon("AddonD","https://github.com/LabRPS/FakeAddonD", Addon.Status.NOT_INSTALLED, "master")
