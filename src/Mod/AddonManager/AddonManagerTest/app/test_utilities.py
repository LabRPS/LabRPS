...
class TestUtilities(unittest.TestCase):
    ...
    def test_recognized_git_location(self):
        recognized_urls = [
            ...
            "https://gitlab.com/labrps/LabRPS",
            "https://framagit.org/labrps/LabRPS",
            "https://salsa.debian.org/science-team/labrps",
        ]
    ...
    def test_get_macro_version_from_file(self):
        good_file = os.path.join(self.test_dir, "good_macro_metadata.rps")
        version = get_macro_version_from_file(good_file)
        self.assertEqual(version, "1.2.3")

        bad_file = os.path.join(self.test_dir, "bad_macro_metadata.rps")
        version = get_macro_version_from_file(bad_file)
        self.assertEqual(version, "", "Bad version did not yield empty string")

        empty_file = os.path.join(self.test_dir, "missing_macro_metadata.rps")
