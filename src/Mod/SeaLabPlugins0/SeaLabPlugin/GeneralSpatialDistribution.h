...
#ifndef SEALAB_PLUGIN_GENERALSD_H
#define SEALAB_PLUGIN_GENERALSD_H
...
class GeneralSpatialDistribution : public SeaLabAPI::IrpsSeLLocationDistribution
{
    PROPERTY_HEADER_WITH_OVERRIDE(SeaLab::GeneralSpatialDistribution);
...
#endif // SEALAB_PLUGIN_GENERALSD_H
