...
PROPERTY_SOURCE(SeaLab::SeLGridPoints, SeaLabAPI::SeaLabFeatureLocationDistribution)

SeLGridPoints::SeLGridPoints()
{
...
bool SeLGridPoints::ComputeLocationCoordinateMatrixP3(const SeaLabAPI::SeaLabSimulationData& Data, mat &dLocCoord)
{
...
bool SeLGridPoints::OnInitialSetting(const SeaLabAPI::SeaLabSimulationData& Data)
{
