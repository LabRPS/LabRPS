...
#include <Mod/SeaLabPlugins/SeaLabPlugin/ui_DlgRandomPhasesFromFile.h>
#include <Mod/SeaLabPlugins/SeaLabPlugin/RPSRandomPhasesFromFile.h>
...
/* TRANSLATOR SeaLabGui::DlgRandomPhasesFromFile */
...
void DlgRandomPhasesFromFile::accept()
{
    ...
    if(!doc)
	    return;
    SeaLab::CRPSRandomPhasesFromFile* activefeature = static_cast<SeaLab::CRPSRandomPhasesFromFile*>(doc->getObject(_featureName.c_str()));
    if (!activefeature)
        return;
