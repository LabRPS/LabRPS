...
__title__  = "SeaLab Mean Wind Profile"
...
'''The SeaLabTools provide tools for the calculation involved in SeaLab. This is where all the computations happen in all SeaLab built-in features'''
