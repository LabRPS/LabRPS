...
#ifndef APP_WINDLABSIMULATIONOBSERVER_H
#define APP_WINDLABSIMULATIONOBSERVER_H
...
/**
 * The WindLabSimulationObserver class manages all simulation objects.
 * @author Werner Mayer
 */
class WindLabGuiExport WindLabSimulationObserver: public App::DocumentObserver
{
public:
    /** Creates the only instance of the WindLabSimulationObserver. */
    static WindLabSimulationObserver* instance();
...
private:
    static WindLabSimulationObserver* _instance;
