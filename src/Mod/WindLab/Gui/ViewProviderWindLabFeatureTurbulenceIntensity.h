...
public:
    /// constructor
    ViewProviderWindLabFeatureTurbulenceIntensity();
    /// destructor
    virtual ~ViewProviderWindLabFeatureTurbulenceIntensity();

    virtual bool doubleClicked(void);
    void setupContextMenu(QMenu*, QObject*, const char*);

    bool computeTurbulenceIntensityValue();
    bool computeTurbulenceIntensityVectorP();
    bool computeTurbulenceIntensityVectorT();
...
#endif // WINDLABGUI_VIEWPROVIDERWINDLABFEATURETURBUINT_H
