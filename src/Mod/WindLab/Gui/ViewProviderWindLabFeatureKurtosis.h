...
#ifndef WINDLABGUI_VIEWPROVIDERWINDLABFEATUREKURTOSIS_H
#define WINDLABGUI_VIEWPROVIDERWINDLABFEATUREKURTOSIS_H
...
class WindLabGuiExport ViewProviderWindLabFeatureKurtosis : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLabGui::ViewProviderWindLabFeatureKurtosis);

public:
    /// constructor
    ViewProviderWindLabFeatureKurtosis();
    /// destructor
    virtual ~ViewProviderWindLabFeatureKurtosis();
...
#endif // WINDLABGUI_VIEWPROVIDERWINDLABFEATUREKURTOSIS_H
