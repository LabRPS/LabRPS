 ...
 *   Based on src/Mod/WindLab/Gui/DlgSettingsWindLabElmerImp.cpp                   *
 *                                                                         *
...
#include "ui_DlgSettingsWindLabLimit.h"
#include <Gui/Application.h>


using namespace WindLabGui;

DlgSettingsWindLabLimitImp::DlgSettingsWindLabLimitImp(QWidget* parent)
    : PreferencePage(parent)
    , ui(new Ui_DlgSettingsWindLabLimitImp)
{
    ui->setupUi(this);
}

DlgSettingsWindLabLimitImp::~DlgSettingsWindLabLimitImp()
{
 ...
 */
void DlgSettingsWindLabLimitImp::changeEvent(QEvent* e)
{
...
#include "moc_DlgSettingsWindLabLimitImp.cpp"
