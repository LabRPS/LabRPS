...
#ifndef WINDLABGUI_VIEWPROVIDERWINDLABFEATUREWPE_H
#define WINDLABGUI_VIEWPROVIDERWINDLABFEATUREWPE_H
...
class WindLabGuiExport ViewProviderWindLabFeatureWavePassageEffect : public Gui::ViewProviderDocumentObject
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLabGui::ViewProviderWindLabFeatureWavePassageEffect);

public:
    /// constructor
    ViewProviderWindLabFeatureWavePassageEffect();
    /// destructor
    virtual ~ViewProviderWindLabFeatureWavePassageEffect();
...
#endif // WINDLABGUI_VIEWPROVIDERWINDLABFEATUREWPE_H
