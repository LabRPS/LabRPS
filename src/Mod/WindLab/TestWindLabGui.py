...
#class WindLabGuiTestCases(unittest.TestCase):
#	def setUp(self):
#		self.Doc = LabRPS.newDocument("WindGuiTest")
#
#	def testBoxCase(self):
#		self.Box = self.Doc.addObject('WindLab::WindObject','WindBox')
...
#	def tearDown(self):
#		#closing doc
#		LabRPS.closeDocument("WindGuiTest")
