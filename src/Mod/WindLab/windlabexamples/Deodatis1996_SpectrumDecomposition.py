...
def setup(doc=None, showGui=True):
    ...
    if LabRPS.GuiUp and showGui:
        ...
        GeneralToolsGui.GeneralToolsPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, psd11)
        GeneralToolsGui.GeneralToolsPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, psd22, False)
        GeneralToolsGui.GeneralToolsPyTool.showArray(sim.getSimulationData().numberOfFrequency, 3, psd33, False)
