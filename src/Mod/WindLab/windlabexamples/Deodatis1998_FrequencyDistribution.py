...
def get_information():
    return {
        ...
        "windlabfeature": "FrequencyDistribution",
    }
...
from windlabexamples.Deodatis1998_FrequencyDistribution import setup
setup()
...
def setup(doc=None, showGui=True):
    ...
    if LabRPS.GuiUp and showGui:
        ...
        WindLabGui.WindLabPyTool.showArray(sim.getSimulationData().numberOfFrequency, sim.getSimulationData().numberOfSpatialPosition, frequencies)
