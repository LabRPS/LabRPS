...
RPS_LOG_LEVEL_INIT("WindLabFeatureVariance",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureVariance, WindLabAPI::WindLabFeature)


WindLabFeatureVariance::WindLabFeatureVariance(void)
{
}
...
App::DocumentObjectExecReturn * WindLabFeatureVariance::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureVariance::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureVariance::onChanged(const App::Property* prop)
{
