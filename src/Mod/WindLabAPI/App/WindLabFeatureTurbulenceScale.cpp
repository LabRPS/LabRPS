...
short WindLabFeatureTurbulenceScale::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureTurbulenceScale::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureTurbulenceScale::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureTurbulenceScale::onChanged(const App::Property* prop)
{
