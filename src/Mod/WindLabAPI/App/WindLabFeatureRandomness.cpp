...
RPS_LOG_LEVEL_INIT("WindLabFeatureRandomness",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureRandomness, WindLabAPI::WindLabFeature)
...
short WindLabFeatureRandomness::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureRandomness::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureRandomness::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureRandomness::onChanged(const App::Property* prop)
{
