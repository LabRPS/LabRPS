...
RPS_LOG_LEVEL_INIT("WindLabFeatureYSpectrum",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureYSpectrum, WindLabAPI::WindLabFeature)
...
short WindLabFeatureYSpectrum::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureYSpectrum::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureYSpectrum::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureYSpectrum::onChanged(const App::Property* prop)
{
