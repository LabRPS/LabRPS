...
#ifndef WINDLABFEATURE_CPD_FEATURE_H
#define WINDLABFEATURE_CPD_FEATURE_H
...
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLabAPI::WindLabFeatureCumulativeProbabilityDistribution);
...
public:
    ...
    virtual const char* getViewProviderName() const {
        return "WindLabGui::ViewProviderWindLabFeatureCumulativeProbabilityDistribution";
    }
...
#endif // WINDLABFEATURE_CPD_FEATURE_H
