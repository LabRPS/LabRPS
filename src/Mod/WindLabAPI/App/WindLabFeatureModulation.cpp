...
RPS_LOG_LEVEL_INIT("WindLabFeatureModulation",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureModulation, WindLabAPI::WindLabFeature)
...
short WindLabFeatureModulation::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureModulation::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureModulation::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureModulation::onChanged(const App::Property* prop)
{
