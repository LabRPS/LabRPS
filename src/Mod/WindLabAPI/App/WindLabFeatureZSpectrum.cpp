...
WindLabFeatureZSpectrum::WindLabFeatureZSpectrum(void)
{
   this->OutputUnitString.setValue("m^2/s");
}

WindLabFeatureZSpectrum::~WindLabFeatureZSpectrum()
{
}

short WindLabFeatureZSpectrum::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureZSpectrum::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureZSpectrum::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureZSpectrum::onChanged(const App::Property* prop)
{
