...
short WindLabFeatureCumulativeProbabilityDistribution::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureCumulativeProbabilityDistribution::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureCumulativeProbabilityDistribution::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureCumulativeProbabilityDistribution::onChanged(const App::Property* prop)
{
