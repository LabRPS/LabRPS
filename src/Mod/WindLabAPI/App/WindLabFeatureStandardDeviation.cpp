...
RPS_LOG_LEVEL_INIT("WindLabFeatureStandardDeviation",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureStandardDeviation, WindLabAPI::WindLabFeature)
...
short WindLabFeatureStandardDeviation::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureStandardDeviation::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureStandardDeviation::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureStandardDeviation::onChanged(const App::Property* prop)
{
