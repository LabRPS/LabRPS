...
RPS_LOG_LEVEL_INIT("WindLabFeatureGustFactor",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureGustFactor, WindLabAPI::WindLabFeature)
...
App::DocumentObjectExecReturn * WindLabFeatureGustFactor::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureGustFactor::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureGustFactor::onChanged(const App::Property* prop)
{
