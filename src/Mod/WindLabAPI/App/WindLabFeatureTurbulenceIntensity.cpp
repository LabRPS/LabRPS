...
RPS_LOG_LEVEL_INIT("WindLabFeatureTurbulenceIntensity",true,true)

PROPERTY_SOURCE(WindLabAPI::WindLabFeatureTurbulenceIntensity, WindLabAPI::WindLabFeature)
...
short WindLabFeatureTurbulenceIntensity::mustExecute(void) const
{
    return WindLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * WindLabFeatureTurbulenceIntensity::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * WindLabFeatureTurbulenceIntensity::execute(void)
{
    return WindLabFeature::execute();
}

void WindLabFeatureTurbulenceIntensity::onChanged(const App::Property* prop)
{
