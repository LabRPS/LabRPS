...
#ifndef WINDLABFEATURE_ZSPECTRUM_FEATURE_H
#define WINDLABFEATURE_ZSPECTRUM_FEATURE_H
...
public:
    /// Constructor
    WindLabFeatureZSpectrum(void);
    virtual ~WindLabFeatureZSpectrum();

    virtual const char* getViewProviderName() const {
        return "WindLabGui::ViewProviderWindLabFeatureZSpectrum";
    }
...
#endif // WINDLABFEATURE_ZSPECTRUM_FEATURE_H
