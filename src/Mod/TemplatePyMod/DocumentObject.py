# LabRPS module providing base classes for document objects and view provider  
# (c) 2011 Werner Mayer LGPL

import LabRPS

class DocumentObject(object):
    """The Document object is the base class for all LabRPS objects."""
            ...
            for key in d:
                ...
                if hasattr(item, '__call__') and key!="onChanged" and key!="execute" and key!="init" and key[0]!="_":
                    ...
                    if not(hasattr(self.__object__,key)):
                        ...
                        LabRPS.Console.PrintWarning('!!! The function : "'+key+'" already exist in the object, cannot override. !!!\n')
    ...
    def __setstate__(self,value):
        ...
        they can be saved when saving the LabRPS document"""
        return None
    ...
    def Content(self):
        ...
        This is the content that is saved when the file is saved by LabRPS"""
    ...
    @property
    def Name(self):
        "the name ofthis object, unique in the LabRPS document"
    ...
    def ViewObject(self,value):
        ...
        None if LabRPS is running in console mode"""
...
class ViewProvider(object):
    ...
    the GUI space. It is only present when LabRPS runs in GUI mode.
    It contains all that is needed to represent the DocumentObject in
    the 3D view and the LabRPS interface"""
    def __init__(self):
...
class Box(DocumentObject):
    ...
    #-----------------------------BEHAVIOR------------------------------------
    def propertyChanged(self,prop):
        LabRPS.Console.PrintMessage("Box property changed : "+ prop+ "\n")
    ...
    def _privateFunctionExample(self,attr):
        LabRPS.Console.PrintMessage("The length : "+str(attr)+"\n")
...
def makeBox():
    LabRPS.newDocument()
    box = LabRPS.ActiveDocument.addObject(Box.type,"MyBox",Box(),None)
