...
class Box(PartFeature):
	...
	def onChanged(self, fp, prop):
		...
		LabRPS.Console.PrintMessage("Change property: " + str(prop) + "\n")

	def execute(self, fp):
		''' Print a short message when doing a recomputation, this method is mandatory '''
		LabRPS.Console.PrintMessage("Recompute Python Box feature\n")
...
def makeBox():
	...
	a=LabRPS.ActiveDocument.addObject("Part::FeaturePython","Box")
	Box(a)
...
class Line:
	def __init__(self, obj):
		...
		obj.addProperty("App::PropertyVector","p2","Line","End point").p2=LabRPS.Vector(1,0,0)
		obj.Proxy = self
...
def makeLine():
	doc=LabRPS.newDocument()
	a=LabRPS.ActiveDocument.addObject("Part::FeaturePython","Line")
	Line(a)
...
class Octahedron:
	...
	def execute(self, fp):
		...
		v2 = LabRPS.Vector(fp.Length,0,0)
		v3 = LabRPS.Vector(0,fp.Width,0)
		v4 = LabRPS.Vector(fp.Length,fp.Width,0)
		v5 = LabRPS.Vector(fp.Length/2,fp.Width/2,fp.Height/2)
		v6 = LabRPS.Vector(fp.Length/2,fp.Width/2,-fp.Height/2)
...
def makeOctahedron():
	doc=LabRPS.newDocument()
	a=LabRPS.ActiveDocument.addObject("App::FeaturePython","Octahedron")
	Octahedron(a)
...
def makePoints():
	...
	a=LabRPS.ActiveDocument.addObject("Points::FeaturePython","Points")
	a.Points=p
	PointFeature(a)
...
def makeMesh():
	...
	a=LabRPS.ActiveDocument.addObject("Mesh::FeaturePython","Mesh")
...
class Molecule:
	def __init__(self, obj):
		''' Add two point properties '''
		obj.addProperty("App::PropertyVector","p1","Line","Start point")
		obj.addProperty("App::PropertyVector","p2","Line","End point").p2=LabRPS.Vector(5,0,0)
...
def makeMolecule():
	doc=LabRPS.newDocument()
	a=LabRPS.ActiveDocument.addObject("Part::FeaturePython","Molecule")
	Molecule(a)
...
def makeCircleSet():
	...
	doc=LabRPS.newDocument()
	a=LabRPS.ActiveDocument.addObject("App::FeaturePython","Circles")
	CircleSet(a)
...
def makeEnumTest():
	LabRPS.newDocument()
	a=LabRPS.ActiveDocument.addObject("Part::FeaturePython","Enum")
	EnumTest(a)
...
def makeDistanceBolt():
	doc=LabRPS.newDocument()
	bolt=LabRPS.ActiveDocument.addObject("Part::FeaturePython","Distance_Bolt")
