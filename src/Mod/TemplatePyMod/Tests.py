...
class ParameterTestCase(unittest.TestCase):
    ...
    def testGroup(self):
        #LabRPS.PrintLog("Base::ParameterTestCase::testGroup\n")
    ...
    def testInt(self):
        #LabRPS.PrintLog("Base::ParameterTestCase::testInt\n")
    ...
    def testBool(self):
        #LabRPS.PrintLog("Base::ParameterTestCase::testBool\n")
        # check on Int
    ...
    def testFloat(self):
        #LabRPS.PrintLog("Base::ParameterTestCase::testFloat\n")
        #Temp = LabRPS.ParamGet("System parameter:Test/44")
        # check on Int
    ...
    def testNesting(self):
        # Parameter testing
        #LabRPS.PrintLog("Base::ParameterTestCase::testNesting\n")
        for i in range(50):
