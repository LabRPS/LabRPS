"""
Examples for customizing the LabRPS application with PySide facilities.
...
import LabRPSGui, __main__

class MainWindow:
	def __init__(self):
		self.app = QtGui.qApp
		self.mw = LabRPSGui.getMainWindow()
		self.dock = {}
...
class PythonQtWorkbench (__main__.Workbench):
	...
	def Activated(self):
		...
		self.mw.setWindowTitle("LabRPS -- PythonQt")
...
LabRPSGui.addWorkbench(PythonQtWorkbench)
