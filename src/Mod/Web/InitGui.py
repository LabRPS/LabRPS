...
class WebWorkbench ( Workbench ):
    ...
    def __init__(self):
        self.__class__.Icon = LabRPS.getResourceDir() + "Mod/Web/Resources/icons/WebWorkbench.svg"
...
LabRPS.addImportType("Web Page (*.html *.xhtml)", "WebGui")

LabRPS.__unit_test__ += [ "TestWebGui" ]
