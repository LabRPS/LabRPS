...
class SpreadsheetWorkbench ( Workbench ):
    ...
    def __init__(self):
        self.__class__.Icon = LabRPS.getResourceDir() + "Mod/Spreadsheet/Resources/icons/SpreadsheetWorkbench.svg"
...
LabRPS.EndingAdd("Spreadsheet formats (*.csv)","SpreadsheetGui")
