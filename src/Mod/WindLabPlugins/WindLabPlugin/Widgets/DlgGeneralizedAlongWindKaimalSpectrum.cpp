...
#include <Mod/WindLabPlugins/WindLabPlugin/ui_DlgGeneralizedKaimalSpectrum.h>
...
DlgGeneralizedKaimalSpectrum::DlgGeneralizedKaimalSpectrum(const App::PropertyFloat& ExponentialDecayCx, const App::PropertyFloat& ExponentialDecayCy, const App::PropertyFloat& ExponentialDecayCz, const App::PropertyString& featureName, QWidget* parent)
	: QWidget(parent), ui(new Ui_DlgGeneralizedKaimalSpectrum), _featureName(featureName.getStrValue())
{
	ui->setupUi(this);
...
DlgGeneralizedKaimalSpectrumEdit::DlgGeneralizedKaimalSpectrumEdit(const App::PropertyFloat& ExponentialDecayCx, const App::PropertyFloat& ExponentialDecayCy, const App::PropertyFloat& ExponentialDecayCz, const App::PropertyString& featureName)
{
	// create and show dialog for the WindLabFeatures
    widget = new DlgGeneralizedKaimalSpectrum(ExponentialDecayCx,ExponentialDecayCy, ExponentialDecayCz, featureName, nullptr);
