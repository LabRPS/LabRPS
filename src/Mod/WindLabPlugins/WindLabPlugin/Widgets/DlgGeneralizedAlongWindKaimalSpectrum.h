...
public:
    DlgGeneralizedKaimalSpectrum(const App::PropertyFloat& ExponentialDecayCx, const App::PropertyFloat& ExponentialDecayCy, const App::PropertyFloat& ExponentialDecayCz, const App::PropertyString& featureName, QWidget* parent = nullptr);
...
public:
    DlgGeneralizedKaimalSpectrumEdit(const App::PropertyFloat& ExponentialDecayCx, const App::PropertyFloat& ExponentialDecayCy, const App::PropertyFloat& ExponentialDecayCz, const App::PropertyString& featureName);
