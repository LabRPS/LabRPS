...
#ifndef WINDLAB_PLUGIN_KARMANXPSD_H
#define WINDLAB_PLUGIN_KARMANXPSD_H
...
namespace WindLab {
	...
	class CRPSvonKarmanAlongWindSpectrum : public WindLabAPI::IrpsWLXSpectrum
	{
		PROPERTY_HEADER_WITH_OVERRIDE(WindLab::CRPSvonKarmanAlongWindSpectrum);

	public:
		CRPSvonKarmanAlongWindSpectrum();
...
#endif // WINDLAB_PLUGIN_KARMANXPSD_H