...
#ifndef WINDLAB_PLUGIN_DAVENPORTPSD_H
#define WINDLAB_PLUGIN_DAVENPORTPSD_H
...
class CRPSDavenportSpectrum : public WindLabAPI::IrpsWLXSpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLab::CRPSDavenportSpectrum);
public:
	CRPSDavenportSpectrum();
