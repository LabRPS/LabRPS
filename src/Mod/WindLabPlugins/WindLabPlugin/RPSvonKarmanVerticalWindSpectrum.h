...
#ifndef WINDLAB_PLUGIN_KARMANZPSD_H
#define WINDLAB_PLUGIN_KARMANZPSD_H
...
class CRPSvonKarmanVerticalWindSpectrum : public WindLabAPI::IrpsWLZSpectrum
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLab::CRPSvonKarmanVerticalWindSpectrum);

public:

	CRPSvonKarmanVerticalWindSpectrum();
...
#endif // WINDLAB_PLUGIN_KARMANZPSD_H