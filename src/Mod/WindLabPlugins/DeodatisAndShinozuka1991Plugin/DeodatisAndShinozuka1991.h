...
class CDeodatisAndShinozuka1991 : public WindLabAPI::IrpsWLSimuMethod
{
    PROPERTY_HEADER_WITH_OVERRIDE(WindLab::CDeodatisAndShinozuka1991);

public:
    CDeodatisAndShinozuka1991();
