...
#include "DeodatisAndShinozuka1991.h"
...
std::string strPluginName = "DeodatisAndShinozuka1991Plugin";
bool stationarity = true;

PLUGIN_NAME("DeodatisAndShinozuka1991Plugin");
...
std::string objNameDeo_S = "Shinozuka and Deodatis (1991)";
...
std::string objAuthorsDeo_S = "Masanobu Shinozuka and George Deodatis";
std::string objDateDeo_S = "13/01/2025";
std::string objVersionDeo_S = "1.0";

RPS_PLUGIN_FUNC IrpsWLSimuMethod* BuildDeodatisAndShinozuka1991()
{
    return new CDeodatisAndShinozuka1991;
}

RPS_PLUGIN_FUNC void DestroyDeodatisAndShinozuka1991(IrpsWLSimuMethod* r)
{
    delete r;
}
...
PLUGIN_INIT_TYPE()
{ 
    if (WindLab::CDeodatisAndShinozuka1991::getClassTypeId() == Base::Type::badType()) {
        WindLab::CDeodatisAndShinozuka1991::init();
    }
...
INSTALL_PLUGIN()
{
    RegisterSimuMethod(objNameDeo_S, strPluginName, objDescriptionDeo_S, BuildDeodatisAndShinozuka1991, DestroyDeodatisAndShinozuka1991);
    return 1;
}
