...
//    if(!returnResult)
//    {
//       Base::Console().Warning("The computation of the frequencies matrix has failed.") ;
//       return false;
//    }
//
...
//            for (int l = 1; l <= N && false == Data.isInterruptionRequested.getValue() && true == returnResult; l++)
//            {
//                returnResult = CRPSWindLabFramework::ComputeCrossSpectrumValue(Data,
//                                                                 PSD1(l - 1),
//                                                                 dLocCoord(j-1,1),
//                                                                 dLocCoord(j-1,2),
//                                                                 dLocCoord(j-1,3),
...
//            for (int l = 1; l <= N && false == Data.isInterruptionRequested.getValue() && true == returnResult; l++)
//            {
//                returnResult = CRPSWindLabFramework::ComputeCrossCoherenceValue(Data, Kz(l - 1),
//                                                            dLocCoord(j-1,1),
//                                                            dLocCoord(j-1,2),
//                                                            dLocCoord(j-1,3),
//                                                            dLocCoord(m-1,1),
...
//
//                dVelocityArray(p - 1, j - 1)=dVelocityArray(p - 1, j - 1)+real(G(k - 1,q)*exp(i2*((k)*deltaomega*(p-1)*dt/n)));
//            }
//        }
//    }
//
