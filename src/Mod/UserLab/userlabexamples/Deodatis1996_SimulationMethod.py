...
def get_information():
    return {
        ...
        "userlabfeature": "SimulationMethod",
    }
...
from userlabexamples.Deodatis1996_SimulationMethod import setup
setup()
...
def setup(doc=None, showGui=True, location = 1):
    ...
    from userlabexamples.Deodatis1996_SpectrumDecomposition import setup
    doc = setup(None, False)

    # get the existing simulation
    sim = UserLab.getSimulation("Simulation")
    ...
    simMethod = UserLabObjects.makeFeature("SimulationMethod", "Simulation",  "Deodatis Simulation Method", "Simulation Method")
    ...
    randomness = UserLabObjects.makeFeature("RandomPhases", "Simulation",  "Uniform Random Phases", "Randomness Provider")
    ...
    CorrelationErgo = UserLabObjects.makeFeature("CorrelationErgo", "Simulation",  "Correlation Ergodicity Check Tool", "Table Tool")
    ...
    # create new table tool
    pdfCheck = UserLabObjects.makeFeature("pdfCheck", "Simulation",  "PDF Check Tool", "Table Tool")
    ...
    # create new table tool
    psdErgo = UserLabObjects.makeFeature("psdErgo", "Simulation", "Ergodicity Check Tool", "Table Tool")
