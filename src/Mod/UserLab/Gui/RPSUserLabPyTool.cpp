...
PyObject* RPSUserLabPyTool::ShowArray(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSUserLabPyTool::ShowArrayAsMatrix(PyObject* self, PyObject* args)
{
    int row;
    int col;
    PyObject* numpyArray;
...
PyObject* RPSUserLabPyTool::ShowValueAsTable(PyObject* self, PyObject* args)
{
    double value;
...
PyObject* RPSUserLabPyTool::GetActiveTable(PyObject* self, PyObject* args)
{
...
PyObject* RPSUserLabPyTool::GetActiveMatrix(PyObject* self, PyObject* args)
{
...
PyMethodDef RPSUserLabPyTool::Methods[] = {
    {"showArray", (PyCFunction)RPSUserLabPyTool::ShowArray, METH_VARARGS,
    "showArray(row,col,array) - take a python list and display it in Alphaplot table"},
    {"showArrayAsMatrix", (PyCFunction)RPSUserLabPyTool::ShowArrayAsMatrix, METH_VARARGS,
    "showArrayAsMatrix(row,col,array) - take a python list and display it in Alphaplot matrix"},
    {"showValueAsTable", (PyCFunction)RPSUserLabPyTool::ShowValueAsTable, METH_VARARGS,
    "showValueAsTable(value) - take a python floating value and display it in Alphaplot table"},
    {"getActiveTable", (PyCFunction)RPSUserLabPyTool::GetActiveTable, METH_VARARGS,
    "getActiveTable() - return the active AlphaPlot table as python list of lists"},
    {"getActiveMatrix", (PyCFunction)RPSUserLabPyTool::GetActiveMatrix, METH_VARARGS,
