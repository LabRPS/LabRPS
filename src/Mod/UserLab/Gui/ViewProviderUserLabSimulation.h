...
#ifndef USERLAB_ViewProviderSimulation_H
#define USERLAB_ViewProviderSimulation_H
...
class UserLabGuiExport ViewProviderUserLabSimulation: public Gui::ViewProviderDocumentObjectGroup
{
    Q_DECLARE_TR_FUNCTIONS(UserLabGui::ViewProviderUserLabSimulation)
    PROPERTY_HEADER_WITH_OVERRIDE(UserLabGui::ViewProviderUserLabSimulation);

public:
    /// constructor.
    ViewProviderUserLabSimulation();

    /// destructor.
    virtual ~ViewProviderUserLabSimulation();
...
#endif // USERLAB_ViewProviderSimulation_H
