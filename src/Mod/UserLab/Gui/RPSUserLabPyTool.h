...
#ifndef RPSUSERLABPYTHONPLUGIN_UTILITIES
#define RPSUSERLABPYTHONPLUGIN_UTILITIES
...
{
// Python interface
class UserLabGuiExport RPSUserLabPyTool
{
public:
...
#endif // RPSUSERLABPYTHONPLUGIN_UTILITIES