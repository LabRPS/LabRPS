...
#include "ui_DlgSettingsUserLabLimit.h"
#include <Gui/Application.h>


using namespace UserLabGui;

DlgSettingsUserLabLimitImp::DlgSettingsUserLabLimitImp(QWidget* parent)
    : PreferencePage(parent)
    , ui(new Ui_DlgSettingsUserLabLimitImp)
{
    ui->setupUi(this);
}

DlgSettingsUserLabLimitImp::~DlgSettingsUserLabLimitImp()
{
 ...
 */
void DlgSettingsUserLabLimitImp::changeEvent(QEvent* e)
{
...
#include "moc_DlgSettingsUserLabLimitImp.cpp"
