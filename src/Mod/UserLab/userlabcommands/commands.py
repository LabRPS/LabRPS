...
__title__ = "USERLAB command definitions"
__author__ = "Koffi Daniel"
__url__ = "https://www.labrps.com"

## @package commands
#  \ingroup USERLAB
#  \brief USERLAB command definitions
...
# for C++ command definitions see src/Mod/UserLab/Command.cpp
...
class _Simulation(CommandManager):
    "The UserLab_Simulation command definition"

    def __init__(self):
        super(_Simulation, self).__init__()
        self.menutext = Qt.QT_TRANSLATE_NOOP("UserLab_Simulation", "Simulation")
        self.pixmap = "UserLab_CreateSimulation"
        self.accel = "W, S"
    ...
    def Activated(self):
        ...
        LabRPSGui.doCommand("UserLabObjects.makeSimulation(LabRPS.ActiveDocument, 'Simulation')")
...
class _Examples(CommandManager):
    ...
    def __init__(self):
        ...
        self.pixmap = "UserLab_Examples"
        self.menutext = Qt.QT_TRANSLATE_NOOP(
            "UserLab_Examples",
            "Open UserLab examples"
        )
        self.tooltip = Qt.QT_TRANSLATE_NOOP(
            "UserLab_Examples",
            "Open UserLab examples"
    ...
    def Activated(self):
        LabRPSGui.addModule("userlabexamples.examplesgui")
        LabRPSGui.doCommand("userlabexamples.examplesgui.show_examplegui()")
