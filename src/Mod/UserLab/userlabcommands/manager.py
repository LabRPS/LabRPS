...
__title__ = "USERLAB command base class"
__author__ = "Koffi Daniel"
__url__ = "https://www.labrps.com"

## @package manager
#  \ingroup USERLAB
#  \brief USERLAB command base class
...
class CommandManager(object):
    ...
    def __init__(self):
        ...
        self.command = "USERLAB" + self.__class__.__name__
    ...
    def IsActive(self):
        if not self.is_active:
            ...
            active = (
                UserLabGui.getActiveSimulation() is not None
    ...
    def active_simulation_in_active_doc(self):
        simulation = UserLabGui.getActiveSimulation()
    ...
    def add_obj_on_gui_set_edit(self, objtype):
        ...
        LabRPSGui.doCommand(
            "UserLabGui.getActiveSimulation().addObject(UserLabObjects."
    ...
    def add_obj_on_gui_expand_noset_edit(self, objtype):
        ...
        # add the object
        LabRPSGui.doCommand(
            "addedObj = UserLabGui.getActiveSimulation().addObject(UserLabObjects."
