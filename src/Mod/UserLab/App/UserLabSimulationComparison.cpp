...
#include <Mod/UserLab/App/UserLabSimulationComparisonPy.h>

using namespace App;
using namespace UserLab;

PROPERTY_SOURCE(UserLab::UserLabSimulationComparison, App::DocumentObject)

UserLabSimulationComparison::UserLabSimulationComparison()
{
...
void UserLabSimulationComparison::start()
{

}
void UserLabSimulationComparison::stop()
{

}

bool UserLabSimulationComparison::doubleClicked(void)
{
    return true;
}

void UserLabSimulationComparison::onChanged(const App::Property* prop)
{
...
PyObject* UserLabSimulationComparison::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        PythonObject = Py::Object(new UserLabSimulationComparisonPy(this), true);
    }
