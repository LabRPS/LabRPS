...
<TS version="2.1" language="el" sourcelanguage="en">
  <context>
    ...
    <message>
      ...
      <translation>Παρακάτω βρίσκονται οι πρόσφατες αλλαγές που προστέθηκαν στον &lt;a href="http://github.com/LabRPS/LabRPS/"&gt;πηγαίο κώδικα του LabRPS&lt;/a&gt;. Αυτές οι αλλαγές μπορει να μην έχουν περαστεί ακόμα στην έκδοση που χρησιμοποιείτε. Ελέγξτε στις &lt;a href="https://www.labrpsweb.org/wiki/Downloads"&gt;διαθέσιμες επιλογές λήψης&lt;/a&gt; αν θέλετε να λάβετε μια υπό ανάπτυξη έκδοση.</translation>
    </message>
    <message>
