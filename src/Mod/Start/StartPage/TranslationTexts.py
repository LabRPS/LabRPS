...
T_DESCR_RECENTCOMMITS = translate("StartPage", "Below are the latest changes added to the <a href=\"http://github.com/LabRPS/LabRPS/\">LabRPS source code</a>. These changes might not reflect yet in the LabRPS version that you are currently running. Check the <a href=\"https://www.labrpsweb.org/wiki/Downloads\">available options</a> if you wish to obtain a development version.")
