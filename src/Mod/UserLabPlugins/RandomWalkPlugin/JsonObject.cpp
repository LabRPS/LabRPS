...
inline bool utilities::JsonObject::add_value(const std::string& key, const Tparam& value)
{
    bool status = true;
...
template<>
inline bool utilities::JsonObject::add_value(const std::string& key,
...
template<>
inline bool utilities::JsonObject::add_value(const std::string& key,
                                             const std::vector<utilities::JsonObject>& value)
{
    bool status = true;
...
template<typename Tparam> Tparam utilities::JsonObject::get_value(const std::string& key) const
{
...
template<>
inline utilities::JsonObject utilities::JsonObject::get_value(const std::string& key) const
{
