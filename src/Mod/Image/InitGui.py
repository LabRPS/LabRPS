...
class ImageWorkbench ( Workbench ):
    ...
    def __init__(self):
        self.__class__.Icon = LabRPS.getResourceDir() + "Mod/Image/Resources/icons/ImageWorkbench.svg"
    ...
    def Initialize(self):
        ...
        try:
            ...
            LabRPS.Console.PrintError("Features from ImageTools package cannot be loaded. {err}\n".format(err= str(err)))        
...
LabRPS.EndingAdd("Image formats (*.bmp *.jpg *.png *.xpm)","ImageGui")
