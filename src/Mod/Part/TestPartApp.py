...
class PartTestCases(unittest.TestCase):
    def setUp(self):
        self.Doc = LabRPS.newDocument("PartTest")
...
class PartTestRuledSurface(unittest.TestCase):
    ...
    def testRuledSurfaceFromTwoObjects(self):
        line1 = Part.makeLine(LabRPS.Vector(-70,-30,0), LabRPS.Vector(-50,40,0))
        line2 = Part.makeLine(LabRPS.Vector(-40,-30,0), LabRPS.Vector(-40,10,0))
        plm1 = LabRPS.Placement()
        plm1.Rotation = LabRPS.Rotation(0.7071067811865476, 0.0, 0.0, 0.7071067811865475)
    ...
    def testRuledSurfaceFromOneObjects(self):
        ...
        sketch.Placement = LabRPS.Placement(LabRPS.Vector(0.000000, 0.000000, 0.000000), App.Rotation(0.707107, 0.000000, 0.000000, 0.707107))
