...
std::unique_ptr<Part::GeometryExtension> GeometryDefaultExtension<T>::copy(void) const
{
    ...
    //
    // /home/travis/build/LabRPS/LabRPS/src/Mod/Part/App/GeometryDefaultExtension.cpp: In instantiation of
    // 'std::unique_ptr<Part::GeometryExtension> Part::GeometryDefaultExtension<T>::copy() const [with T = long int]':
    // /home/travis/build/LabRPS/LabRPS/src/Mod/Part/App/GeometryDefaultExtension.cpp:164:16:   required from here
    // /home/travis/build/LabRPS/LabRPS/src/Mod/Part/App/GeometryDefaultExtension.cpp:84:12: error: cannot bind //
