...
enum eRefType {
    ...
    rtFlagHasPlacement = 0x0100 //indicates that the linked shape is a whole LabRPS object that has placement available.
};
...
public: //methods
     ...
     * flat faces in LabRPS prior to introduction of Attacher. Set
