...
void CmdPartBox2::activated(int iMsg)
{
    ...
    doCommand(Doc,"from LabRPS import Base");
...
void CmdPartRuledSurface::activated(int iMsg)
{
    ...
    doCommand(Doc, "LabRPS.ActiveDocument.addObject('Part::RuledSurface', 'Ruled Surface')");
    doCommand(Doc, "LabRPS.ActiveDocument.ActiveObject.Curve1=(LabRPS.ActiveDocument.%s,['%s'])"
              ,obj1.c_str(), link1.c_str());
    doCommand(Doc, "LabRPS.ActiveDocument.ActiveObject.Curve2=(LabRPS.ActiveDocument.%s,['%s'])"
