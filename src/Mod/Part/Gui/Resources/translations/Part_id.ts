...
If reload LabRPS-Ship module another time, we can find tank instances generator tool.
...
LabRPS-Ship provide a tool to easily compute a Gz curve.
...
When we press Accept tool starts the computation. If you runs LabRPS from terminal you can see work progress. In a couple of seconds we will receive Gz curve.
...
Of course this example is not real (first for all fuel tanks cannot be placed in the double bottom structure, or using hull side as structure), but is a good example in order to learn to use LabRPS-Ship</translation>
    </message>
    <message>
