    ...
    try{
        ...
        for (QList<QTreeWidgetItem *>::iterator it = items.begin(); it != items.end(); ++it) {
            ...
            QString code = QString::fromLatin1(
                "LabRPS.ActiveDocument.addObject(\"%1\",\"%2\")\n"
                "LabRPS.ActiveDocument.%2.Source = LabRPS.ActiveDocument.%3\n"
                "LabRPS.ActiveDocument.%2.Axis = (%4,%5,%6)\n"
                "LabRPS.ActiveDocument.%2.Base = (%7,%8,%9)\n"
                "LabRPS.ActiveDocument.%2.Angle = %10\n"
                "LabRPS.ActiveDocument.%2.Solid = %11\n"
                "LabRPS.ActiveDocument.%2.AxisLink = %12\n"
                "LabRPS.ActiveDocument.%2.Symmetric = %13\n"
                "LabRPSGui.ActiveDocument.%3.Visibility = False\n")
