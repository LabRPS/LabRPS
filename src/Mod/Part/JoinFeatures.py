...
# LabRPS.ActiveDocument.openTransaction("Create " + mode + "ObjectsFeature")
# LabRPSGui.addModule("JoinFeatures")
# LabRPSGui.doCommand(
...
# LabRPSGui.doCommand("j.Base.ViewObject.hide()")
# LabRPSGui.doCommand("j.Tool.ViewObject.hide()")
...
# LabRPSGui.addCommand("Part_JoinConnect", _CommandConnectFeature())
...
# def Activated(self):
# if len(LabRPSGui.Selection.getSelection()) == 2:
...
# LabRPSGui.addCommand("Part_JoinEmbed", _CommandEmbedFeature())
...
# LabRPSGui.addCommand("Part_JoinCutout", _CommandCutoutFeature())
