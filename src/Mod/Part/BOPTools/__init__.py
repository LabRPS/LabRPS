...
def addCommands():
    "addCommands(): add all GUI commands of BOPTools package to LabRPS command manager."
    JoinFeatures.addCommands()
    SplitFeatures.addCommands()

def generalFuseIsAvailable():
    """generalFuseIsAvailable(): returns True if LabRPS's Part.Shape.generalFuse is functional.
