...
def booleanFragments(list_of_shapes, mode, tolerance = 0.0):
    ...
    if mode == "Standard":
        ...
        if len(solids) < 1:
            ...
            LabRPS.Console.PrintWarning("Part_BooleanFragments: only one solid in the result, generating trivial compsolid.")
...
def slice(base_shape, tool_shapes, mode, tolerance = 0.0):
    ...
    if mode == "Standard":
        ...
        if len(solids) < 1:
            ...
            LabRPS.Console.PrintWarning("Part_Slice: only one solid in the result, generating trivial compsolid.")
