...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureSpectrum",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureSpectrum, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureSpectrum::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureSpectrum::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureSpectrum::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureSpectrum::onChanged(const App::Property* prop)
{
