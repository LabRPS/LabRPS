...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureKurtosis",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureKurtosis, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureKurtosis::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureKurtosis::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureKurtosis::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureKurtosis::onChanged(const App::Property* prop)
{
