...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureVariance",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureVariance, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureVariance::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureVariance::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureVariance::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureVariance::onChanged(const App::Property* prop)
{
