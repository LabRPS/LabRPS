...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureMeanAcceleration",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureMeanAcceleration, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureMeanAcceleration::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureMeanAcceleration::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureMeanAcceleration::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureMeanAcceleration::onChanged(const App::Property* prop)
{
