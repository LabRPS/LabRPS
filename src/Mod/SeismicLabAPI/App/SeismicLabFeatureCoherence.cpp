...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureCoherence",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureCoherence, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureCoherence::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureCoherence::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureCoherence::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureCoherence::onChanged(const App::Property* prop)
{
