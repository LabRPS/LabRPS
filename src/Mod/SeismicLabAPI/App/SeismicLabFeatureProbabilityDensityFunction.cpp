...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureProbabilityDensityFunction",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureProbabilityDensityFunction, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureProbabilityDensityFunction::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureProbabilityDensityFunction::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureProbabilityDensityFunction::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureProbabilityDensityFunction::onChanged(const App::Property* prop)
{
