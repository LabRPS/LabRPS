...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureStandardDeviation",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureStandardDeviation, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureStandardDeviation::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureStandardDeviation::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureStandardDeviation::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureStandardDeviation::onChanged(const App::Property* prop)
{
