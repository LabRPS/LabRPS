...
RPS_LOG_LEVEL_INIT("SeismicLabFeaturePeakFactor",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeaturePeakFactor, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeaturePeakFactor::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeaturePeakFactor::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeaturePeakFactor::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeaturePeakFactor::onChanged(const App::Property* prop)
{
