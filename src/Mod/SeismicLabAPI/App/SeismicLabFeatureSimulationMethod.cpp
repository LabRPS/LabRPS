...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureSimulationMethod",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureSimulationMethod, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureSimulationMethod::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureSimulationMethod::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureSimulationMethod::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureSimulationMethod::onChanged(const App::Property* prop)
{
