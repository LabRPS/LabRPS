...
const char * RPSSeismicLabAPIInfo::getSeismicLabAPIVersion()
{
	return "0.1";
}
    ...
    CrpsCoherenceFactory::~CrpsCoherenceFactory()
    {
 	...
 	IrpsSLCoherence *CrpsCoherenceFactory::BuildObject(const std::string& name)
 	{
...
CrpsLocationDistributionFactory::~CrpsLocationDistributionFactory()
{
  ...
  for (std::map<const std::string, PyObject*>::const_iterator it = mProducerMap.begin(); it != mProducerMap.end(); ++it) {
    ...
    IrpsSLLocationDistribution *CrpsLocationDistributionFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsMeanFactory::~CrpsMeanFactory()
    {
 	...
 	IrpsSLMeanAcceleration *CrpsMeanFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsSpectrumFactory::~CrpsSpectrumFactory()
    {
 	...
 	IrpsSLSpectrum *CrpsSpectrumFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsSimuMethodFactory::~CrpsSimuMethodFactory()
    {
 	...
 	IrpsSLSimulationMethod *CrpsSimuMethodFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsFrequencyDistributionFactory::~CrpsFrequencyDistributionFactory()
    {
 	...
 	IrpsSLFrequencyDistribution *CrpsFrequencyDistributionFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsRandomnessFactory::~CrpsRandomnessFactory()
    {
 	...
 	IrpsSLRandomness *CrpsRandomnessFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsPSDdecomMethodFactory::~CrpsPSDdecomMethodFactory()
    {
 	...
 	IrpsSLPSDdecompositionMethod *CrpsPSDdecomMethodFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsCorrelationFactory::~CrpsCorrelationFactory()
    {
 	...
 	IrpsSLCorrelation *CrpsCorrelationFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsModulationFactory::~CrpsModulationFactory()
    {
 	...
 	IrpsSLModulation *CrpsModulationFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsTableToolFactory::~CrpsTableToolFactory()
    {
 	...
 	IrpsSLTableTool *CrpsTableToolFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsMatrixToolFactory::~CrpsMatrixToolFactory()
    {
 	...
 	IrpsSLMatrixTool *CrpsMatrixToolFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsUserDefinedRPSObjectFactory::~CrpsUserDefinedRPSObjectFactory()
    {
 	...
 	IrpsSLUserDefinedRPSObject *CrpsUserDefinedRPSObjectFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsCumulativeProbabilityDistributionFactory::~CrpsCumulativeProbabilityDistributionFactory()
    {
 	...
 	IrpsSLCumulativeProbabilityDistribution *CrpsCumulativeProbabilityDistributionFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsKurtosisFactory::~CrpsKurtosisFactory()
    {
 	...
 	IrpsSLKurtosis *CrpsKurtosisFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsPeakFactorFactory::~CrpsPeakFactorFactory()
    {
 	...
 	IrpsSLPeakFactor *CrpsPeakFactorFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsProbabilityDensityFunctionFactory::~CrpsProbabilityDensityFunctionFactory()
    {
 	...
 	IrpsSLProbabilityDensityFunction *CrpsProbabilityDensityFunctionFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsShearVelocityOfFlowFactory::~CrpsShearVelocityOfFlowFactory()
    {
 	...
 	IrpsSLShearVelocityOfFlow *CrpsShearVelocityOfFlowFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsSkewnessFactory::~CrpsSkewnessFactory()
    {
 	...
 	IrpsSLSkewness *CrpsSkewnessFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsStandardDeviationFactory::~CrpsStandardDeviationFactory()
    {
 	...
 	IrpsSLStandardDeviation *CrpsStandardDeviationFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsVarianceFactory::~CrpsVarianceFactory()
    {
 	...
 	IrpsSLVariance *CrpsVarianceFactory::BuildObject(const std::string& name)
 	{
    ...
    CrpsWavePassageEffectFactory::~CrpsWavePassageEffectFactory()
    {
 	...
 	IrpsSLWavePassageEffect *CrpsWavePassageEffectFactory::BuildObject(const std::string& name)
 	{
