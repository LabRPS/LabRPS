...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureWavePassageEffect",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureWavePassageEffect, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureWavePassageEffect::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureWavePassageEffect::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureWavePassageEffect::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureWavePassageEffect::onChanged(const App::Property* prop)
{
