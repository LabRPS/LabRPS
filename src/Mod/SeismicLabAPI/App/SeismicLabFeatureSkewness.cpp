...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureSkewness",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureSkewness, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureSkewness::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureSkewness::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureSkewness::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureSkewness::onChanged(const App::Property* prop)
{
