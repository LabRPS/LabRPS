...
RPS_LOG_LEVEL_INIT("SeismicLabFeatureCumulativeProbabilityDistribution",true,true)

PROPERTY_SOURCE(SeismicLabAPI::SeismicLabFeatureCumulativeProbabilityDistribution, SeismicLabAPI::SeismicLabFeature)
...
short SeismicLabFeatureCumulativeProbabilityDistribution::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn * SeismicLabFeatureCumulativeProbabilityDistribution::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn * SeismicLabFeatureCumulativeProbabilityDistribution::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabFeatureCumulativeProbabilityDistribution::onChanged(const App::Property* prop)
{
