...
PROPERTY_SOURCE(SeismicLabAPI::SeismicLabSimulationData, SeismicLabAPI::SeismicLabFeature)

SeismicLabSimulationData::SeismicLabSimulationData()
{

	ADD_PROPERTY_TYPE(numberOfSpatialPosition, (3), "SeismicLabData", App::Prop_None, "The number of simulation point which is the number of wind processes in a sample");
...
short SeismicLabSimulationData::mustExecute(void) const
{
    return SeismicLabFeature::mustExecute();
}

App::DocumentObjectExecReturn* SeismicLabSimulationData::recompute(void)
{
    try {
...
App::DocumentObjectExecReturn* SeismicLabSimulationData::execute(void)
{
    return SeismicLabFeature::execute();
}

void SeismicLabSimulationData::onChanged(const App::Property* prop)
{
    SeismicLabFeature::onChanged(prop);
}

PyObject* SeismicLabSimulationData::getPyObject(void)
{
    if (PythonObject.is(Py::_None())) {
        // ref counter is set to 1
        PythonObject = Py::Object(new SeismicLabSimulationDataPy(this), true);
    }
