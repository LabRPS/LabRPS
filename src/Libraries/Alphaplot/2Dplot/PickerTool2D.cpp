...
void PickerTool2D::setPicker(const Graph2DCommon::Picker &picker) {
  ...
  switch (picker_) {
    ...
    case Graph2DCommon::Picker::DataPoint: {
      ...
      xpickerline_->setLayer(QString::fromLatin1("picker"));
      ypickerline_->setLayer(QString::fromLatin1("picker"));
    ...
    case Graph2DCommon::Picker::DataMove: {
      ...
      xpickerellipse_->setLayer(QString::fromLatin1("picker"));
    ...
    case Graph2DCommon::Picker::ZoomRange: {
      ...
      layout_->getPlotCanwas()->setCursor(
          QCursor(QPixmap(QString::fromLatin1(":icons/cursor/cursor-zoom.png"))));
      layout_->setAxisRangeDrag(false);
    ...
    case Graph2DCommon::Picker::DataRange: {
      ...
      if (curve_) {
        ...
        ypickerline_->setLayer(QString::fromLatin1("picker"));
        xpickerellipse_->setLayer(QString::fromLatin1("picker"));
        ypickerellipse_->setLayer(QString::fromLatin1("picker"));
        layout_->setAxisRangeDrag(false);
        layout_->setAxisRangeZoom(false);
        setupRangepicker();
      }
...
void PickerTool2D::showtooltip(const QPointF position, const double xval,
  ...
  QToolTip::showText(
      ...
      xvalstring + QString::fromLatin1(", ") + yvalstring);
  ...
  Q_FOREACH (QCPItemPosition *position, xpickerline_->positions()) {
    position->setAxes(xaxis, yaxis);
  }
  xpickerline_->setClipAxisRect(xaxis->axisRect());
  xpickerline_->setClipToAxisRect(true);
  xpickerline_->position(QString::fromLatin1("point1"))->setCoords(xval, yaxis->range().lower);
  xpickerline_->position(QString::fromLatin1("point2"))->setCoords(xval, yaxis->range().upper);
  Q_FOREACH (QCPItemPosition *position, ypickerline_->positions()) {
    position->setAxes(xaxis, yaxis);
  }
  ypickerline_->setClipAxisRect(xaxis->axisRect());
  ypickerline_->setClipToAxisRect(true);
  ypickerline_->position(QString::fromLatin1("point1"))->setCoords(xaxis->range().lower, yval);
  ypickerline_->position(QString::fromLatin1("point2"))->setCoords(xaxis->range().upper, yval);
  layout_->streachLabelSetText(QString::fromLatin1(" x=%1 y=%2").arg(xvalstring, yvalstring));
}
...
void PickerTool2D::movepickermousedrag(const QPointF &position,
  ...
  xpickerellipse_->position(QString::fromLatin1("topLeft"))->setPixelPosition(
      QPointF(x - ellipseradius_, y - ellipseradius_));
  xpickerellipse_->position(QString::fromLatin1("bottomRight"))
      ->setPixelPosition(QPointF(x + ellipseradius_, y + ellipseradius_));
  QToolTip::showText(
      layout_->mapToGlobal(QPoint(static_cast<int>(position.x()),
                                  static_cast<int>(position.y()))),
      QString::number(xval) + QString::fromLatin1(", ") + QString::number(yval));
}
...
void PickerTool2D::movepickermouserelease(const QPointF position) {
  ...
  if (status) {
    ...
    QToolTip::showText(
        layout_->mapToGlobal(QPoint(static_cast<int>(position.x()),
                                    static_cast<int>(position.y()))),
        QString::number(newxval) + QString::fromLatin1(", ") + QString::number(newyval));
  } else {
    ...
    QToolTip::showText(
        ...
        QString::number(movepicker_.xval) + QString::fromLatin1(", ") +
...
void PickerTool2D::datapoint(Curve2D *curve, const double xval,
                             const double yval) {
  Q_EMIT layout_->datapoint(curve, xval, yval);
}
...
void PickerTool2D::movepickermouspress(const double xval, const double yval,
  ...
  // ellipse
  Q_FOREACH (QCPItemPosition *position, xpickerellipse_->positions()) {
    position->setAxes(xaxis, yaxis);
  }
...
void PickerTool2D::setupRangepicker() {
  ...
  xpickerline_->position(QString::fromLatin1("point1"))->setCoords(
      startx, curve_->getyaxis()->range().lower);
  xpickerline_->position(QString::fromLatin1("point2"))->setCoords(
  ...
  ypickerline_->position(QString::fromLatin1("point1"))->setCoords(
      stopx, curve_->getyaxis()->range().lower);
  ypickerline_->position(QString::fromLatin1("point2"))->setCoords(
  ...
  Q_FOREACH (QCPItemPosition *position, ypickerellipse_->positions()) {
    position->setAxes(curve_->getxaxis(), curve_->getyaxis());
  }
  ...
  ypickerellipse_->position(QString::fromLatin1("topLeft"))->setPixelPosition(
      QPointF(x2 - ellipseradius_, y2 - ellipseradius_));
  ypickerellipse_->position(QString::fromLatin1("bottomRight"))
...
void PickerTool2D::moveLineEllipseItenTo(double xval, double yval,
  ...
  // line
  rangepicker_.line->position(QString::fromLatin1("point1"))->setCoords(
      xval, rangepicker_.curve->getyaxis()->range().lower);
  rangepicker_.line->position(QString::fromLatin1("point2"))->setCoords(
  ...
  ellipse->position(QString::fromLatin1("topLeft"))->setPixelPosition(
      QPointF(x - ellipseradius_, y - ellipseradius_));
  ellipse->position(QString::fromLatin1("bottomRight"))
      ->setPixelPosition(QPointF(x + ellipseradius_, y + ellipseradius_));
}
