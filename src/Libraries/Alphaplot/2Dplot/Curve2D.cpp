...
void Curve2D::init() {
  layername_ = QString::fromLatin1("<Curve2D>") +
...
void Curve2D::save(XmlStreamWriter *xmlwriter, int xaxis, int yaxis) {
  xmlwriter->writeStartElement(QString::fromLatin1("curve"));
  // axis
  ...
  switch (getcurvetype_cplot()) {
    case Curve2D::Curve2DType::Curve:
      xmlwriter->writeAttribute(QString::fromLatin1("type"), QString::fromLatin1("curve"));
      break;
    case Curve2D::Curve2DType::Spline:
      xmlwriter->writeAttribute(QString::fromLatin1("type"), QString::fromLatin1("spline"));
      break;
  }

  (getlegendvisible_cplot()) ? xmlwriter->writeAttribute(QString::fromLatin1(
      "legendvisible"), QString::fromLatin1("true"))
      : xmlwriter->writeAttribute(QString::fromLatin1(
          "legendvisible"), QString::fromLatin1("false"));
  xmlwriter->writeAttribute(QString::fromLatin1("legend"), getlegendtext_cplot());
  // data
  if (curvedata_) {
    xmlwriter->writeAttribute(QString::fromLatin1("data"), QString::fromLatin1("table"));
    xmlwriter->writeAttribute(QString::fromLatin1("table"), curvedata_->gettable()->name());
    xmlwriter->writeAttribute(QString::fromLatin1("xcolumn"), curvedata_->getxcolumn()->name());
    xmlwriter->writeAttribute(QString::fromLatin1("ycolumn"), curvedata_->getycolumn()->name());
    xmlwriter->writeAttribute(QString::fromLatin1("from"), QString::number(curvedata_->getfrom()));
    xmlwriter->writeAttribute(QString::fromLatin1("to"), QString::number(curvedata_->getto()));
  } else if (functionData_) {
    xmlwriter->writeAttribute(QString::fromLatin1("data"), QString::fromLatin1("function"));
    switch (funcdata_.type) {
      case 0:
        xmlwriter->writeAttribute(QString::fromLatin1("functiontype)"), QString::fromLatin1("normal"));
        (funcdata_.functions.size() == 1)
            ? xmlwriter->writeAttribute(QString::fromLatin1("function"), funcdata_.functions.at(0))
            : xmlwriter->writeAttribute(QString::fromLatin1("function"), QString::fromLatin1("unknown"));
        break;
      case 1:
        xmlwriter->writeAttribute(QString::fromLatin1("functiontype"), QString::fromLatin1("parametric"));
        if (funcdata_.functions.size() == 2) {
          xmlwriter->writeAttribute(QString::fromLatin1("functionx"), funcdata_.functions.at(0));
          xmlwriter->writeAttribute(QString::fromLatin1("functiony"), funcdata_.functions.at(1));
        } else {
          xmlwriter->writeAttribute(QString::fromLatin1("functionx"), QString::fromLatin1("unknown"));
          xmlwriter->writeAttribute(QString::fromLatin1("functiony"), QString::fromLatin1("unknown"));
        }
        xmlwriter->writeAttribute(QString::fromLatin1("parameter"), funcdata_.parameter);
        break;
      case 2:
        xmlwriter->writeAttribute(QString::fromLatin1("functiontype"), QString::fromLatin1("polar"));
        if (funcdata_.functions.size() == 2) {
          xmlwriter->writeAttribute(QString::fromLatin1("functionr"), funcdata_.functions.at(0));
          xmlwriter->writeAttribute(QString::fromLatin1("functiontheta"), funcdata_.functions.at(1));
        } else {
          xmlwriter->writeAttribute(QString::fromLatin1("functionr"), QString::fromLatin1("unknown"));
          xmlwriter->writeAttribute(QString::fromLatin1("functiontheta"), QString::fromLatin1("unknown"));
        }
        xmlwriter->writeAttribute(QString::fromLatin1("parameter"), funcdata_.parameter);
        break;
    }
    xmlwriter->writeAttribute(QString::fromLatin1("from"), QString::number(funcdata_.from));
    xmlwriter->writeAttribute(QString::fromLatin1("to"), QString::number(funcdata_.to));
    xmlwriter->writeAttribute(QString::fromLatin1("points"), QString::number(funcdata_.points));
    xmlwriter->writeStartElement(QString::fromLatin1("functiondata"));

    for (int i = 0; i < functionData_.data()->size(); ++i) {
        xmlwriter->writeStartElement(QString::fromLatin1("data"));
      xmlwriter->writeAttribute(
          QString::fromLatin1("xdata"), QString::number(functionData_.data()->at(i)->key));
      xmlwriter->writeAttribute(
          QString::fromLatin1("ydata"), QString::number(functionData_.data()->at(i)->value));
  ...
  // line
  xmlwriter->writeStartElement(QString::fromLatin1("line"));
  switch (getlinetype_cplot()) {
    case 0:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("none"));
      break;
    case 1:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("line"));
      break;
  }
  (getlinefillstatus_cplot()) ? xmlwriter->writeAttribute(QString::fromLatin1("fill"), QString::fromLatin1("true"))
  ...
  xmlwriter->writeAttribute(QString::fromLatin1("size"), QString::number(getscattersize_cplot()));
...
bool Curve2D::load(XmlStreamReader *xmlreader) {
  ...
  while (!xmlreader->atEnd()) {
    if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("curve")) break;
    ...
    if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("line")) {
      ...
      if (ok) {
        if (style == QString::fromLatin1("none")) {
          setlinetype_cplot(0);
        } else if (style == QString::fromLatin1("line")) {
          setlinetype_cplot(1);
        }
      } else
...
void Curve2D::reloadIcon() {
  if (curve2dtype_ == Curve2DType::Spline) {
    icon_ = IconLoader::load(QString::fromLatin1("graph2d-spline"), IconLoader::LightDark);
    return;
  }
  if (type_ == Graph2DCommon::PlotType::Function) {
    icon_ = IconLoader::load(QString::fromLatin1("graph2d-function-xy"), IconLoader::LightDark);
    return;
  }
  (getlinetype_cplot() == 0 &&
   getscattershape_cplot() == Graph2DCommon::ScatterStyle::None &&
   getlinefillstatus_cplot() == false)
      ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-scatter"), IconLoader::LightDark)
  : (getlinetype_cplot() == 0 &&
     getscattershape_cplot() == Graph2DCommon::ScatterStyle::None &&
  ...
  : (getlinetype_cplot() == 1 &&
     getscattershape_cplot() == Graph2DCommon::ScatterStyle::None &&
     getlinefillstatus_cplot() == false)
      ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-line"), IconLoader::LightDark)
  : (getlinetype_cplot() == 1 &&
     getscattershape_cplot() == Graph2DCommon::ScatterStyle::None &&
     getlinefillstatus_cplot() == true)
      ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-area"), IconLoader::LightDark)
  : (getlinetype_cplot() == 1 &&
     getscattershape_cplot() != Graph2DCommon::ScatterStyle::None &&
     getlinefillstatus_cplot() == false)
      ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-line-scatter"), IconLoader::LightDark)
  : (getlinetype_cplot() == 1 &&
     getscattershape_cplot() != Graph2DCommon::ScatterStyle::None &&
     getlinefillstatus_cplot() == true)
      ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-area"), IconLoader::LightDark)
