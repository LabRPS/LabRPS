...
LineSpecial2D::LineSpecial2D(Table *table, Column *xcol, Column *ycol, int from,
    ...
    : QCPGraph(xAxis, yAxis),
      ...
      yerrorbar_(nullptr),
      layername_(
          QString::fromLatin1("<LineSpecial2D>") +
...
void LineSpecial2D::save(XmlStreamWriter *xmlwriter, int xaxis, int yaxis) {
  xmlwriter->writeStartElement(QString::fromLatin1("linespecial"));
  // axis
  ...
  xmlwriter->writeAttribute(QString::fromLatin1("legend"), getlegendtext_lsplot());
  // data
  xmlwriter->writeAttribute(QString::fromLatin1("table"), graphdata_->gettable()->name());
  xmlwriter->writeAttribute(QString::fromLatin1("xcolumn"), graphdata_->getxcolumn()->name());
  xmlwriter->writeAttribute(QString::fromLatin1("ycolumn"), graphdata_->getycolumn()->name());
  xmlwriter->writeAttribute(QString::fromLatin1("from"), QString::number(graphdata_->getfrom()));
  xmlwriter->writeAttribute(QString::fromLatin1("to"), QString::number(graphdata_->getto()));
  // error bar
  ...
  switch (getlinetype_lsplot()) {
    case Graph2DCommon::LineStyleType::Line:
      ...
      break;
    case Graph2DCommon::LineStyleType::Impulse:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("impulse"));
      break;
    case Graph2DCommon::LineStyleType::StepLeft:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("stepleft"));
      break;
    case Graph2DCommon::LineStyleType::StepRight:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("stepright"));
      break;
    case Graph2DCommon::LineStyleType::StepCenter:
      xmlwriter->writeAttribute(QString::fromLatin1("style"), QString::fromLatin1("stepcenter"));
      break;
  }
  (getlinefillstatus_lsplot()) ? xmlwriter->writeAttribute(QString::fromLatin1("fill"), QString::fromLatin1("true"))
  ...
  xmlwriter->writeAttribute(QString::fromLatin1("size"), QString::number(getscattersize_lsplot()));
...
bool LineSpecial2D::load(XmlStreamReader *xmlreader) {
  ...
  while (!xmlreader->atEnd()) {
    if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("linespecial")) break;
...
void LineSpecial2D::reloadIcon() {
  switch (getlinetype_lsplot()) {
    case Graph2DCommon::LineStyleType::Impulse:
      icon_ = IconLoader::load(QString::fromLatin1("graph2d-vertical-drop"), IconLoader::LightDark);
      break;
    case Graph2DCommon::LineStyleType::StepCenter:
      (getlinefillstatus_lsplot())
          ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-area"), IconLoader::LightDark)
          : icon_ = IconLoader::load(QString::fromLatin1("graph2d-vertical-step"),
                                     IconLoader::LightDark);
      break;
    case Graph2DCommon::LineStyleType::StepLeft:
      (getlinefillstatus_lsplot())
          ? icon_ = IconLoader::load(QString::fromLatin1("graph2d-area"), IconLoader::LightDark)
          : icon_ = IconLoader::load(QString::fromLatin1("graph2d-horizontal-step"),
                                     IconLoader::LightDark);
      break;
    case Graph2DCommon::LineStyleType::StepRight:
      (getlinefillstatus_lsplot())
