...
ArrangeLegend2D::ArrangeLegend2D(QWidget *parent, Legend2D *legend,
  ...
  btnUp_->setIcon(IconLoader::load(QString::fromLatin1("edit-up"), IconLoader::LightDark));
  btnDown_->setIcon(IconLoader::load(QString::fromLatin1("edit-down"), IconLoader::LightDark));
  setWindowTitle(tr("Arrange Legend 2D Plots"));
  setWindowIcon(IconLoader::load(QString::fromLatin1("edit-legend"), IconLoader::LightDark));
