...
class AlphaplotExport DataBlockGraph {
 public:
...
class AlphaplotExport DataBlockCurve {
 public:
...
class AlphaplotExport DataBlockBar {
 public:
...
class AlphaplotExport DataBlockHist {
 public:
...
class AlphaplotExport DataBlockError {
 public:
