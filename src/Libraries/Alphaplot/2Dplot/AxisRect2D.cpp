...
QList<Axis2D *> AxisRect2D::getAxes2D(
  ...
  Q_FOREACH (QCPAxis *qcpAxis, qcpAxes) {
...
LineSpecial2D *AxisRect2D::addLineSpecial2DPlot(
  ...
  connect(legendItem, &LegendItem2D::legendItemClicked, this,
          &AxisRect2D::legendClick);
  lineSpecial->setName(table->name() +QString::fromLatin1( "_") + xData->name() +QString::fromLatin1( "_") +
                       yData->name());
  lsvec_.append(lineSpecial);
  layers_.append(lineSpecial->layer());

  lockColumnModeChange(QList<Column *>() << xData << yData, true);
  Q_EMIT LineSpecial2DCreated(lineSpecial);
  return lineSpecial;
}
...
QPair<LineSpecial2D *, LineSpecial2D *> AxisRect2D::addLineSpecialChannel2DPlot(
  ...
  connect(legendItem, &LegendItem2D::legendItemClicked, this,
          &AxisRect2D::legendClick);
  lineSpecial1->setName(table->name() +QString::fromLatin1( "_") + xData->name() +QString::fromLatin1( "_") +
                        yData1->name() +QString::fromLatin1( "_") + yData2->name());
  auto pair =
  ...
  Q_EMIT LineSpecialChannel2DCreated(pair);
  return pair;
}
...
Curve2D *AxisRect2D::addCurve2DPlot(const AxisRect2D::LineScatterType &type,
  ...
  curve->setName(table->name() +QString::fromLatin1( "_") + xcol->name() +QString::fromLatin1( "_") + ycol->name());
  curvevec_.append(curve);
  layers_.append(curve->layer());
  lockColumnModeChange(QList<Column *>() << xcol << ycol, true);
  Q_EMIT Curve2DCreated(curve);
  return curve;
}
...
Bar2D *AxisRect2D::addBox2DPlot(const AxisRect2D::BarType &type, Table *table,
  ...
  connect(legendItem, &LegendItem2D::legendItemClicked, this,
          &AxisRect2D::legendClick);
  bar->setName(table->name() +QString::fromLatin1( "_") + xData->name() +QString::fromLatin1( "_") + yData->name());
  layers_.append(bar->layer());
  barvec_.append(bar);
  lockColumnModeChange(QList<Column *>() << xData << yData, true);
  Q_EMIT Bar2DCreated(bar);
  return bar;
}
...
Vector2D *AxisRect2D::addVectorPlot(const Vector2D::VectorPlot &vectorplot,
  ...
  connect(legendItem, &LegendItem2D::legendItemClicked, this,
          &AxisRect2D::legendClick);
  vec->setName(table->name() +QString::fromLatin1( "_") + x1Data->name() +QString::fromLatin1( "_") + y1Data->name() +
               QString::fromLatin1("_") + x2Data->name() +QString::fromLatin1( "_") + y2Data->name());
  layers_.append(vec->layer());
  vectorvec_.append(vec);
  lockColumnModeChange(
      QList<Column *>() << x1Data << y1Data << x2Data << y2Data, true);
  Q_EMIT Vector2DCreated(vec);
  return vec;
}
...
StatBox2D *AxisRect2D::addStatBox2DPlot(Table *table, Column *ycol,
  ...
  Q_FOREACH (StatBox2D *sbox, statboxvec_) {
  ...
  double datakey = 1;
  Q_FOREACH (StatBox2D *box, statboxvec_) {
  ...
  Q_EMIT StatBox2DCreated(statbox);
  return statbox;
}
...
Bar2D *AxisRect2D::addHistogram2DPlot(const AxisRect2D::BarType &type,
  ...
  axisRectLegend_->addItem(legendItem);
  connect(legendItem, SIGNAL(legendItemClicked()), SLOT(legendClick()));
  bar->setName(table->name() +QString::fromLatin1( "_") + yData->name());
  layers_.append(bar->layer());
  barvec_.append(bar);
...
ColorMap2D *AxisRect2D::addColorMap2DPlot(Matrix *matrix, Axis2D *xAxis,
  ...
  Q_EMIT ColorMap2DCreated(colormap);
  return colormap;
}
...
TextItem2D *AxisRect2D::addTextItem2D(const QString text) {
  ...
  Q_EMIT TextItem2DCreated(textitem);
  return textitem;
}

LineItem2D *AxisRect2D::addLineItem2D() {
  LineItem2D *lineitem = new LineItem2D(this, plot2d_);
  Q_FOREACH (QCPItemPosition *position, lineitem->positions()) {
  ...
  Q_EMIT LineItem2DCreated(lineitem);
  return lineitem;
}
...
ImageItem2D *AxisRect2D::addImageItem2D(const QString &filename) {
  ...
  Q_FOREACH (QCPItemPosition *position, imageitem->positions()) {
    position->setAxes(gridpair_.first.second, gridpair_.second.second);
  }
  ...
  Q_EMIT ImageItem2DCreated(imageitem);
  return imageitem;
}
...
bool AxisRect2D::updateData(Table *table, const QString &name) {
    ...
    if (data1->table == table && data2->table == table) {
      if (data1->xcol == col || data1->ycol == col || data2->xcol == col ||
        ...
        if (!hasMinimumDataPointsToPlot(
                ...
                data1->to)) {
          plotname = channel.first->name() +QString::fromLatin1( "_") + data2->ycol->name();
  ...
  Q_FOREACH (Vector2D *vector, vectorvec_) {
    ...
    if (pie->gettable_pieplot() == table) {
      if (pie->getxcolumn_pieplot() == col) {
        if (!hasMinimumDataPointsToPlot(
          ...
          plotname = pie->gettable_pieplot()->name() +QString::fromLatin1( "_") +
  ...
  Q_FOREACH (Axis2D *axis, getXAxes2D()) {
  ...
  if (!plotname.isEmpty()) Q_EMIT NoMinimumDataPointsPlotRemoved(plotname);
  return modified;
}
...
bool AxisRect2D::axisColumTypeCompatibilityCheck(Axis2D *axis, Column *col,
  ...
  if ((getXAxes2D().contains(axis) &&
    ...
    Q_EMIT AxisColumnTypeMismatch(axis->getname_axis(), axis->getnumber_axis(),
                                col->name());
    return false;
  }
  Q_EMIT AxisColumnOrientationMismatch(axis->getname_axis(),
...
bool AxisRect2D::hasMinimumDataPointsToPlot(const int noofpoints, Table *table,
  ...
  if ((to - from) + 1 < noofpoints) {
    Q_EMIT NoMinimumDataPoints(noofpoints);
    return false;
  }
  if (xcol && ycollist.count() == 0 && to < table->numRows()) {
    ...
    Q_EMIT NoPlotForSelectedColumns();
    return false;
  }
...
QList<Axis2D *> AxisRect2D::getAxesOrientedTo(
  ...
  Q_FOREACH (QCPAxis *axisQCP, axesQCP) {
...
void AxisRect2D::selectAxisRect() { Q_EMIT AxisRectClicked(this); }
...
bool AxisRect2D::removeImageItem2D(ImageItem2D *imageitem) {
  ...
  Q_EMIT ImageItem2DRemoved(this);
  return result;
}
...
bool AxisRect2D::removeLineSpecial2D(LineSpecial2D *ls) {
  ...
  if (!result) return result;
  Q_EMIT LineSpecial2DRemoved(this);
  return result;
}
...
bool AxisRect2D::removeChannel2D(
  ...
  xaxis->removetickertext();
  yaxis->removetickertext();
  Q_EMIT LineSpecialChannel2DRemoved(this);
  return result;
}
...
bool AxisRect2D::removeBar2D(Bar2D *bar) {
  ...
  Q_FOREACH (auto bargroup, bargroupvec_) {
    if (bargroup->size() == 1) {
...
bool AxisRect2D::movechannellayer(QCPLayer *layer, QCPLayer *layerswap) {
  ...
  for (int i = 0; i < layers_.size(); i++) {
    Q_FOREACH (auto channel, channelvec_) {
...
void AxisRect2D::setItemAxes(Axis2D *xaxis, Axis2D *yaxis) {
  ...
  Q_FOREACH (TextItem2D *textitem, textvec_) {
    textitem->position->setAxes(xaxis, yaxis);
  }
  Q_FOREACH (LineItem2D *lineitem, linevec_) {
    Q_FOREACH (QCPItemPosition *position, lineitem->positions()) {
      position->setAxes(xaxis, yaxis);
    }
  }
  Q_FOREACH (ImageItem2D *imageitem, imagevec_) {
    Q_FOREACH (QCPItemPosition *position, imageitem->positions()) {
      position->setAxes(xaxis, yaxis);
    }
  }
...
bool AxisRect2D::loadLineSpecialChannel2D(XmlStreamReader *xmlreader,
  ...
  // linespecialchannel
  if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("channel")) {
    xmlreader->readNextStartElement();
    while (!xmlreader->atEnd()) {
      if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("linespecial")) {
        break;
      }
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("linespecial")) {
        int xax = xmlreader->readAttributeInt(QString::fromLatin1("xaxis"), &ok);
        if (ok) {
          xaxis1 = getXAxis(xax);
        } else
          xmlreader->raiseError(
              tr("LineSpecialChannel2D X axis not found error"));
        int yax = xmlreader->readAttributeInt(QString::fromLatin1("yaxis"), &ok);
        if (ok) {
          yaxis1 = getYAxis(yax);
        } else
          xmlreader->raiseError(
        ...
        QString lstype = xmlreader->readAttributeString(QString::fromLatin1("type"), &ok);
        if (lstype == QString::fromLatin1("line") && ok) {
        ...
        // legend
        legendvisible1 = xmlreader->readAttributeBool(QString::fromLatin1("legendvisible"), &ok);
        if (!ok)
          xmlreader->raiseWarning(
              tr("LineSpecialChannel2D legend visible property setting error"));
        legend1 = xmlreader->readAttributeString(QString::fromLatin1("legend"), &ok);
        if (!ok)
          xmlreader->raiseWarning(
        ...
        from1 = xmlreader->readAttributeInt(QString::fromLatin1("from"), &ok);
        if (!ok)
          xmlreader->raiseError(
              tr("LineSpecialChannel2D from not found error"));
        to1 = xmlreader->readAttributeInt(QString::fromLatin1("to"), &ok);
        if (!ok)
          xmlreader->raiseError(tr("LineSpecialChannel2D to not found error"));

        xmlreader->readNextStartElement();
        // line
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("line")) {
          // line style
          QString style = xmlreader->readAttributeString(QString::fromLatin1("style"), &ok);
          if (ok) {
            if (style == QString::fromLatin1("line")) {
              lstype1 = Graph2DCommon::LineStyleType::Line;
            } else if (style == QString::fromLatin1("impulse")) {
              lstype1 = Graph2DCommon::LineStyleType::Impulse;
            } else if (style == QString::fromLatin1("stepleft")) {
              lstype1 = Graph2DCommon::LineStyleType::StepLeft;
            } else if (style == QString::fromLatin1("stepright")) {
              lstype1 = Graph2DCommon::LineStyleType::StepRight;
            } else if (style == QString::fromLatin1("stepcenter")) {
          ...
          // line fill status
          linefill1 = xmlreader->readAttributeBool(QString::fromLatin1("fill"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
          ...
          // line antialias
          lineantialias1 = xmlreader->readAttributeBool(QString::fromLatin1("antialias"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
          ...
          while (!xmlreader->atEnd()) {
            xmlreader->readNext();
            if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("brush"))
              break;
            // brush
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("scatter")) {
          ...
          // scatter size
          scattersize1 = xmlreader->readAttributeInt(QString::fromLatin1("size"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
                tr("LineSpecialChannel2D scatter size property setting error"));

          // scatter antialias
          scatterantialias1 = xmlreader->readAttributeBool(QString::fromLatin1("antialias"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
    ...
    while (!xmlreader->atEnd()) {
      ...
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("linespecial")) {
        ...
        // legend
        legendvisible2 = xmlreader->readAttributeBool(QString::fromLatin1("legendvisible"), &ok);
        if (!ok)
          xmlreader->raiseWarning(
              tr("LineSpecialChannel2D legend visible property setting error"));
        legend2 = xmlreader->readAttributeString(QString::fromLatin1("legend"), &ok);
        if (!ok)
          xmlreader->raiseWarning(
              tr("LineSpecialChannel2D legendtext not found"));
        QString tablename = xmlreader->readAttributeString(QString::fromLatin1("table"), &ok);
        ...
        if (ok) {
          ...
          xmlreader->raiseError(
              tr("LineSpecialChannel2D Table Y column not found error"));
        from2 = xmlreader->readAttributeInt(QString::fromLatin1("from"), &ok);
        if (!ok)
          xmlreader->raiseError(
              tr("LineSpecialChannel2D from not found error"));
        to2 = xmlreader->readAttributeInt(QString::fromLatin1("to"), &ok);
        if (!ok)
          xmlreader->raiseError(tr("LineSpecialChannel2D to not found error"));
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("line")) {
          ...
          // line fill status
          linefill2 = xmlreader->readAttributeBool(QString::fromLatin1("fill"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
                tr("LineSpecialChannel2D line fill status property setting "
                   "error"));
          ...
          // line antialias
          lineantialias2 = xmlreader->readAttributeBool(QString::fromLatin1("antialias"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
                tr("LineSpecialChannel2D line antialias "
                   "property setting error"));
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("scatter")) {
          ...
          // scatter size
          scattersize2 = xmlreader->readAttributeInt(QString::fromLatin1("size"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
                tr("LineSpecialChannel2D scatter size property setting error"));

          // scatter antialias
          scatterantialias2 = xmlreader->readAttributeBool(QString::fromLatin1("antialias"), &ok);
          if (!ok)
            xmlreader->raiseWarning(
                tr("LineSpecialChannelD scatter antialias property setting "
                   "error"));
...
void AxisRect2D::save(XmlStreamWriter *xmlwriter, const QPair<int, int> rowcol,
  ...
  xmlwriter->writeStartElement(QString::fromLatin1("layout"));
  xmlwriter->writeAttribute(
      QString::fromLatin1("index"), QString::number(
                   layoutgrid->rowColToIndex(rowcol.first, rowcol.second) + 1));
  xmlwriter->writeAttribute(QString::fromLatin1("row"), QString::number(rowcol.first + 1));
  xmlwriter->writeAttribute(QString::fromLatin1("column"), QString::number(rowcol.second + 1));
  xmlwriter->writeAttribute(
      QString::fromLatin1("rowstreachfactor"),
      QString::number(layoutgrid->rowStretchFactors().at(rowcol.first)));
  xmlwriter->writeAttribute(
      QString::fromLatin1("columnstreachfactor"),
      QString::number(layoutgrid->columnStretchFactors().at(rowcol.second)));
  (autoMargins() == QCP::MarginSide::msAll) ? xmlwriter->writeAttribute(
      QString::fromLatin1("automargin"), QString::fromLatin1("true"))
      : xmlwriter->writeAttribute(QString::fromLatin1("automargin"), QString::fromLatin1("false"));
  xmlwriter->writeAttribute(QString::fromLatin1("leftmargin"), QString::number(margins().left()));
  xmlwriter->writeAttribute(QString::fromLatin1("topmargin"), QString::number(margins().top()));
  xmlwriter->writeAttribute(QString::fromLatin1("rightmargin"), QString::number(margins().right()));
  xmlwriter->writeAttribute(QString::fromLatin1("bottommargin"),
                            QString::number(margins().bottom()));
  xmlwriter->writeBrush(backgroundBrush());
  getLegend()->save(xmlwriter);
  Q_FOREACH (Axis2D *axis, getAxes2D()) { axis->save(xmlwriter); }
  gridpair_.first.first->save(xmlwriter, QString::fromLatin1("xgrid"));
  gridpair_.second.first->save(xmlwriter, QString::fromLatin1("ygrid"));
  ...
  if (!saveastemplate) {
    ...
    Q_FOREACH (QCPLayer *layer, layers_) {
      ...
      Q_FOREACH (LineSpecial2D *ls, lvec) {
        if (layer == ls->layer()) {
      ...
      for (int i = 0; i < chvec.size(); i++) {
        if (layer == chvec.at(i).first->layer()) {
          xmlwriter->writeStartElement(QString::fromLatin1("channel"));
      ...
      Q_FOREACH (Vector2D *vector, vvec) {
      ...
      Q_FOREACH (StatBox2D *statbox, stvec) {
      ...
      Q_FOREACH (ColorMap2D *colmap, colvec) {
      ...
      // items
      Q_FOREACH (TextItem2D *textitem, txvec) {
      ...
      Q_FOREACH (LineItem2D *lineitem, livec) {
      ...
      Q_FOREACH (ImageItem2D *imageitem, imvec) {
...
bool AxisRect2D::load(XmlStreamReader *xmlreader, QList<Table *> tabs,
  ...
  if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("layout")) {
    bool ok = false;
    // auto margins
    bool automar = xmlreader->readAttributeBool(QString::fromLatin1("automargin"), &ok);
    if (ok) {
    ...
    mar.setLeft(xmlreader->readAttributeInt(QString::fromLatin1("leftmargin"), &ok));
    if (ok) {
      mar.setTop(xmlreader->readAttributeInt(QString::fromLatin1("topmargin"), &ok));
      if (ok) {
        mar.setRight(xmlreader->readAttributeInt(QString::fromLatin1("rightmargin"), &ok));
        if (ok) {
          mar.setBottom(xmlreader->readAttributeInt(QString::fromLatin1("bottommargin"), &ok));
          if (ok) {
            setMargins(mar);
          } else
            xmlreader->raiseWarning(
    ...
    while (!xmlreader->atEnd()) {
      xmlreader->readNext();
      if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("layout")) break;
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("axis")) {
        ...
        Axis2D::TickerType tickertype = Axis2D::TickerType::Value;
        // Type property
        QString position = xmlreader->readAttributeString(QString::fromLatin1("position"), &ok);
        if (ok) {
          if (position == QString::fromLatin1("left"))
          ...
          else if (position == QString::fromLatin1("top"))
          ...
          xmlreader->raiseError(
              tr("(critical) Axis2D Position property setting error"));
        // Tickertype property
        QString ticker = xmlreader->readAttributeString(QString::fromLatin1("tickertype"), &ok);
        if (ok) {
          if (ticker == QString::fromLatin1("value"))
            tickertype = Axis2D::TickerType::Value;
          else if (ticker == QString::fromLatin1("log"))
            tickertype = Axis2D::TickerType::Log;
          else if (ticker == QString::fromLatin1("pi"))
            tickertype = Axis2D::TickerType::Pi;
          else if (ticker == QString::fromLatin1("time"))
            tickertype = Axis2D::TickerType::Time;
          else if (ticker == QString::fromLatin1("datetime"))
            tickertype = Axis2D::TickerType::DateTime;
          else if (ticker == QString::fromLatin1("text"))
            tickertype = Axis2D::TickerType::Text;
          else {
            xmlreader->raiseError(
        ...
        bool associatedgrid = xmlreader->readAttributeBool(QString::fromLatin1("grid"), &ok);
        ...
        // xgrid
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("xgrid")) {
          gridpair_.first.first->load(xmlreader, QString::fromLatin1("xgrid"));
        } else
          // ygrid
          if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("ygrid")) {
            gridpair_.second.first->load(xmlreader, QString::fromLatin1("ygrid"));
          } else
            // textitem
            if (xmlreader->isStartElement() &&
                xmlreader->name() == QString::fromLatin1("textitem")) {
              TextItem2D *textitem = addTextItem2D(QString::fromLatin1("Text"));
              textitem->load(xmlreader);
            } else
              // lineitem
              if (xmlreader->isStartElement() &&
                  xmlreader->name() == QString::fromLatin1("lineitem")) {
                LineItem2D *lineitem = addLineItem2D();
                lineitem->load(xmlreader);
              } else
                // imageitem
                if (xmlreader->isStartElement() &&
                    xmlreader->name() == QString::fromLatin1("imageitem")) {
                  // source property
                  QString file = xmlreader->readAttributeString(QString::fromLatin1("file"), &ok);
                  ...
                  // curve
                  if (xmlreader->isStartElement() &&
                      xmlreader->name() == QString::fromLatin1("curve")) {
                    Curve2D *curve = nullptr;
                    ...
                    QString curvetype =
                        xmlreader->readAttributeString(QString::fromLatin1("type"), &ok);
                    if (curvetype == QString::fromLatin1("curve") && ok) {
                      ctype = LineScatterType::Scatter2D;
                    } else if (curvetype == QString::fromLatin1("spline") && ok) {
                      ctype = LineScatterType::Spline2D;
                    }

                    // legend
                    QString legend =
                        xmlreader->readAttributeString(QString::fromLatin1("legend"), &ok);
                    if (!ok)
                      xmlreader->raiseWarning(
                          tr("Curve2D legendtext not found"));

                    QString datatype =
                        xmlreader->readAttributeString(QString::fromLatin1("data"), &ok);
                    if (ok && datatype == QString::fromLatin1("table")) {
                      Table *table = nullptr;
                      Column *xcolumn = nullptr;
                      Column *ycolumn = nullptr;

                      QString tablename =
                          xmlreader->readAttributeString(QString::fromLatin1("table"), &ok);
                      if (ok) {
                      ...
                      QString xcolname =
                          xmlreader->readAttributeString(QString::fromLatin1("xcolumn"), &ok);
                      if (ok) {
                      ...
                      QString ycolname =
                          xmlreader->readAttributeString(QString::fromLatin1("ycolumn"), &ok);
                      if (ok) {
                      ...
                      int from = xmlreader->readAttributeInt(QString::fromLatin1("from"), &ok);
                      if (!ok)
                        xmlreader->raiseError(
                            tr("Curve2D from not found error"));
                      int to = xmlreader->readAttributeInt(QString::fromLatin1("to"), &ok);
                      if (!ok)
                    ...
                    } else if (ok && datatype == QString::fromLatin1("function")) {
                      PlotData::FunctionData funcdata;
                      int functiontype = 0;
                      // function type
                      QString functype =
                          xmlreader->readAttributeString(QString::fromLatin1("functiontype"), &ok);
                      if (!ok)
                        xmlreader->raiseWarning(
                            tr("Curve2D function type not found"));

                      (
                          functype == QString::fromLatin1("normal")) ? functiontype = 0
                           : (
                               functype == QString::fromLatin1("parametric")) ? functiontype = 1
                      : (functype == QString::fromLatin1("polar"))      ? functiontype = 2
                                                   : functiontype = 0;
                      ...
                      switch (functiontype) {
                        case 0: {
                          ...
                          // function function
                          QString funcfunc =
                              xmlreader->readAttributeString(QString::fromLatin1("function"), &ok);
                          if (ok)
                        ...
                        case 1: {
                          ...
                          // function functionx
                          QString funcfuncx =
                              xmlreader->readAttributeString(QString::fromLatin1("functionx"), &ok);
                          if (ok)
                          ...
                          // function functiony
                          QString funcfuncy =
                              xmlreader->readAttributeString(QString::fromLatin1("functiony"), &ok);
                          if (ok)
                          ...
                          // function parameter
                          QString funcparam =
                              xmlreader->readAttributeString(QString::fromLatin1("parameter"), &ok);
                          if (ok)
                        ...
                        case 2: {
                          ...
                          // function functionr
                          QString funcfuncr =
                              xmlreader->readAttributeString(QString::fromLatin1("functionr"), &ok);
                          if (ok)
                          ...
                          QString funcfunctheta =
                              xmlreader->readAttributeString(QString::fromLatin1("functiontheta"),
                                                             &ok);
                          if (ok)
                      ...
                      // Function from
                      double funcfrom =
                          xmlreader->readAttributeDouble(QString::fromLatin1("from"), &ok);
                      if (ok)
                      ...
                      // Function to
                      double functo =
                          xmlreader->readAttributeDouble(QString::fromLatin1("to"), &ok);
                      if (ok)
                        funcdata.to = functo;
                      else
                        xmlreader->raiseWarning(
                      ...
                      // Function points
                      int funcpoints =
                          xmlreader->readAttributeInt(QString::fromLatin1("points"), &ok);
                      if (ok)
                      ...
                      while (!xmlreader->atEnd()) {
                        ...
                        if (xmlreader->isEndElement() &&
                            xmlreader->name() == QString::fromLatin1("functiondata"))
                          break;
                        // pen
                        if (xmlreader->isStartElement() &&
                            xmlreader->name() == QString::fromLatin1("data")) {
                          double xval =
                                xmlreader->readAttributeDouble(QString::fromLatin1("xdata"), &ok);
                          bool xok = ok;
                          double yval =
                              xmlreader->readAttributeDouble(QString::fromLatin1("ydata"), &ok);
                          if (xok && ok) {
                            xdata->append(xval);
                            ydata->append(yval);
                          } else
                    ...
                    bool legendvisible =
                        xmlreader->readAttributeBool(QString::fromLatin1("legendvisible"), &ok);
                    (ok)
                    ...
                    while (!xmlreader->atEnd()) {
                      xmlreader->readNextStartElement();
                      if (xmlreader->isStartElement() &&
                          xmlreader->name() != QString::fromLatin1("errorbar")) {
                      ...
                      if (xmlreader->isStartElement() &&
                        ...
                        QString colname =
                            xmlreader->readAttributeString(QString::fromLatin1("errcolumn"), &ok);
                        if (ok) {
                    ...
                    // linespecial
                    if (xmlreader->isStartElement() &&
                        xmlreader->name() == QString::fromLatin1("linespecial")) {
                      ...
                      } else if (lstype == QString::fromLatin1("impulse") && ok) {
                        ltype = AxisRect2D::LineScatterSpecialType::
                            VerticalDropLine2D;
                      } else if (lstype == QString::fromLatin1("stepleft") && ok) {
                        ltype =
                            AxisRect2D::LineScatterSpecialType::VerticalStep2D;
                      } else if (lstype == QString::fromLatin1("stepright") && ok) {
                        ltype = AxisRect2D::LineScatterSpecialType::
                            HorizontalStep2D;
                      } else if (lstype == QString::fromLatin1("stepcenter") && ok) {
                        ltype = AxisRect2D::LineScatterSpecialType::
                          ...
                          while (!xmlreader->atEnd()) {
                            ...
                            if (xmlreader->isStartElement() &&
                              ...
                              QString colname = xmlreader->readAttributeString(
                                  QString::fromLatin1("errcolumn"), &ok);
                              if (ok) {
                                (table) ? column = table->column(colname)
                                        : column = nullptr;
                              } else
                              ...
                              int from =
                                  xmlreader->readAttributeInt(QString::fromLatin1("from"), &ok);
                              if (!ok)
                                xmlreader->raiseError(
                                    tr("ErrorBar2D from not found error"));
                              int to = xmlreader->readAttributeInt(QString::fromLatin1("to"), &ok);
                      ...
                      // channel
                      if (xmlreader->isStartElement() &&
                          xmlreader->name() == QString::fromLatin1("channel")) {
                        loadLineSpecialChannel2D(xmlreader, tabs);
                      } else

                        // bar
                        if (xmlreader->isStartElement() &&
                            xmlreader->name() == QString::fromLatin1("bar")) {
                          Bar2D *bar = nullptr;
                          Axis2D *xaxis = nullptr;
                          Axis2D *yaxis = nullptr;
                          ...
                          QString orientation = xmlreader->readAttributeString(
                              QString::fromLatin1("orientation"), &ok);
                          if (ok) {
                            (orientation == QString::fromLatin1("vertical"))
                                ? barorientation =
                                      AxisRect2D::BarType::VerticalBars
                                : barorientation =
                          ...
                          if (bartype == QString::fromLatin1("barxy")) {
                            Table *table = nullptr;
                            Column *xcolumn = nullptr;
                            Column *ycolumn = nullptr;
                            ...
                            QString barstyle =
                                xmlreader->readAttributeString(QString::fromLatin1("style"), &ok);
                            if (ok) {
                              barstylstatus = true;
                              (barstyle == QString::fromLatin1("individual"))
                                  ? barstyleenum = Bar2D::BarStyle::Individual
                              : (barstyle == QString::fromLatin1("grouped"))
                                  ? barstyleenum = Bar2D::BarStyle::Grouped
                              : (barstyle == QString::fromLatin1("stacked"))
                            ...
                            int stackorder =
                                xmlreader->readAttributeInt(QString::fromLatin1("stackorder"), &ok);
                            if (!ok)
                              xmlreader->raiseWarning(
                          ...
                          else if (ok && bartype == QString::fromLatin1("histogram")) {
                            Table *table = nullptr;
                            Column *column = nullptr;
                            ...
                            if (ok) {
                              ...
                              xmlreader->raiseError(
                                  tr("Bar2D Table not found error"));
                            QString colname =
                                xmlreader->readAttributeString(QString::fromLatin1("column"), &ok);
                            if (ok) {
                              (table) ? column = table->column(colname)
                                      : column = nullptr;
                            } else
                            ...
                            if (table && column && xaxis && yaxis) {
                              ...
                              // autobin
                              bool autobin =
                                  xmlreader->readAttributeBool(QString::fromLatin1("autobin"), &ok);
                              if (ok)
                              ...
                              // begin
                              double begin =
                                  xmlreader->readAttributeDouble(QString::fromLatin1("begin"), &ok);
                              if (ok)
                              ...
                              // end
                              double end =
                                  xmlreader->readAttributeDouble(QString::fromLatin1("end"), &ok);
                              if (ok)
                                bar->setHistEnd(end);
                              else
                                xmlreader->raiseWarning(
                          ...
                          // stackgap
                          double stackgap =
                              xmlreader->readAttributeDouble(QString::fromLatin1("stackgap"), &ok);
                          if (ok) {
                          ...
                          // vector
                          if (xmlreader->isStartElement() &&
                              xmlreader->name() == QString::fromLatin1("vector")) {
                            Axis2D *xaxis = nullptr;
                            Axis2D *yaxis = nullptr;
                            ...
                            QString vectortype =
                                xmlreader->readAttributeString(QString::fromLatin1("type"), &ok);
                            if (vectortype == QString::fromLatin1("xyam") && ok) {
                              type = Vector2D::VectorPlot::XYAM;
                            } else if (vectortype == QString::fromLatin1("xyxy") && ok) {
                            ...
                            QString x1colname =
                                xmlreader->readAttributeString(QString::fromLatin1("x1column"), &ok);
                            if (ok) {
                            ...
                            QString y1colname =
                                xmlreader->readAttributeString(QString::fromLatin1("y1column"), &ok);
                            if (ok) {
                            ...
                            QString x2colname =
                                xmlreader->readAttributeString(QString::fromLatin1("x2column"), &ok);
                            if (ok) {
                            ...
                            QString y2colname =
                                xmlreader->readAttributeString(QString::fromLatin1("y2column"), &ok);
                            if (ok) {
                            ...
                            // pie
                            if (xmlreader->isStartElement() &&
                                xmlreader->name() == QString::fromLatin1("pie")) {
                              Table *table = nullptr;
                              Column *xcolumn = nullptr;
                              Column *ycolumn = nullptr;
                              QString tablename =
      ...
      // statbox
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("statbox")) {
        Axis2D *xaxis = nullptr;
        Axis2D *yaxis = nullptr;
        ...
        QString legendtext = xmlreader->readAttributeString(QString::fromLatin1("legend"), &ok);
        if (!ok)
        ...
        QString colname = xmlreader->readAttributeString(QString::fromLatin1("column"), &ok);
        if (ok) {
        ...
        // colormap
        if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("colormap")) {
          Matrix *matrix = nullptr;
      ...
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("legend")) {
...
void AxisRect2D::legendClick() { Q_EMIT AxisRectClicked(this); }
