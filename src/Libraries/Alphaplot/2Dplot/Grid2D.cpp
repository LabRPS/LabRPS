...
void Grid2D::save(XmlStreamWriter *xmlwriter, const QString tag) {
  ...
  xmlwriter->writeStartElement(QString::fromLatin1("major"));
  (getMajorGridVisible()) ? xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("true"))
                          : xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("false"));
  xmlwriter->writePen(pen());
  xmlwriter->writeEndElement();
  xmlwriter->writeStartElement(QString::fromLatin1("zero"));
  (getZerothLineVisible()) ? xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("true"))
                           : xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("false"));
  xmlwriter->writePen(zeroLinePen());
  xmlwriter->writeEndElement();
  xmlwriter->writeStartElement(QString::fromLatin1("minor"));
  (getMinorGridVisible()) ? xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("true"))
                          : xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("false"));
...
bool Grid2D::load(XmlStreamReader *xmlreader, const QString tag) {
  if (xmlreader->isStartElement() && xmlreader->name() == tag) {
    ...
    while (!xmlreader->atEnd()) {
      xmlreader->readNext();
      if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("major")) break;
      // visible
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("major")) {
    ...
    while (!xmlreader->atEnd()) {
      xmlreader->readNext();
      if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("zero")) break;
      // visible
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("zero")) {
        bool visible = xmlreader->readAttributeBool(QString::fromLatin1("visible"), &ok);
    ...
    while (!xmlreader->atEnd()) {
      xmlreader->readNext();
      if (xmlreader->isEndElement() && xmlreader->name() == QString::fromLatin1("minor")) break;
      // visible
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("minor")) {
          bool visible = xmlreader->readAttributeBool(QString::fromLatin1("visible"), &ok);
