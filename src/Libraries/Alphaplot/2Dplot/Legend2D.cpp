...
Legend2D::Legend2D(AxisRect2D *axisrect)
    : QCPLegend(),
      ...
      title_text_(QString::fromLatin1("Title")),
...
void Legend2D::save(XmlStreamWriter *xmlwriter) {
  xmlwriter->writeStartElement(QString::fromLatin1("legend"));
  ...
  xmlwriter->writeAttribute(
      QString::fromLatin1("width"), QString::number(axisrect_->insetLayout()->insetRect(0).width()));
  xmlwriter->writeAttribute(
      QString::fromLatin1("height"),
      QString::number(axisrect_->insetLayout()->insetRect(0).height()));

  (gethidden_legend()) ? xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("false"))
                       : xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("true"));
  xmlwriter->writeAttribute(QString::fromLatin1("iconwidth"), QString::number(iconSize().width()));
  xmlwriter->writeAttribute(QString::fromLatin1("iconheight"), QString::number(iconSize().height()));
  xmlwriter->writeAttribute(QString::fromLatin1("icontextpadding"),
                            QString::number(iconTextPadding()));
  switch (getdirection_legend()) {
    case QCPLegend::foRowsFirst:
      xmlwriter->writeAttribute(QString::fromLatin1("direction"), QString::fromLatin1("rows"));
      break;
    case QCPLegend::foColumnsFirst:
      xmlwriter->writeAttribute(QString::fromLatin1("direction"), QString::fromLatin1("columns"));
      break;
  }
  xmlwriter->writeAttribute(QString::fromLatin1("marginleft"), QString::number(margins().left()));
  xmlwriter->writeAttribute(QString::fromLatin1("margintop"), QString::number(margins().top()));
  xmlwriter->writeAttribute(QString::fromLatin1("marginright"), QString::number(margins().right()));
  xmlwriter->writeAttribute(QString::fromLatin1("marginbottom"),
                            QString::number(margins().bottom()));
  xmlwriter->writeFont(font(), textColor());
  xmlwriter->writePen(borderPen());
  xmlwriter->writeBrush(brush());
  xmlwriter->writeStartElement(QString::fromLatin1("title"));
  (istitle_legend()) ? xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("true"))
                     : xmlwriter->writeAttribute(QString::fromLatin1("visible"), QString::fromLatin1("false"));
  xmlwriter->writeAttribute(QString::fromLatin1("text"), titletext_legend());
...
bool Legend2D::load(XmlStreamReader *xmlreader) {
  if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("legend")) {
    bool ok;
    double orix = xmlreader->readAttributeDouble(QString::fromLatin1("x"), &ok);
    if (ok) {
      double oriy = xmlreader->readAttributeDouble(QString::fromLatin1("y"), &ok);
      if (ok) {
        double width = xmlreader->readAttributeDouble(QString::fromLatin1("width"), &ok);
        if (ok) {
          double height = xmlreader->readAttributeDouble(QString::fromLatin1("height"), &ok);
          if (ok) {
            QRectF rect;
    ...
    int iconwidth = xmlreader->readAttributeInt(QString::fromLatin1("iconwidth"), &ok);
    if (ok) {
      QSize size = iconSize();
    ...
    int iconheight = xmlreader->readAttributeInt(QString::fromLatin1("iconheight"), &ok);
    if (ok) {
      QSize size = iconSize();
    ...
    int icontextpadding = xmlreader->readAttributeInt(QString::fromLatin1("icontextpadding"), &ok);
    (ok) ? setIconTextPadding(icontextpadding)
         : xmlreader->raiseError(
               tr("no Legend2D icon text padding property element found"));
    // direction
    QString direction = xmlreader->readAttributeString(QString::fromLatin1("direction"), &ok);
    if (ok) {
      if (direction == QString::fromLatin1("rows"))
        setdirection_legend(0);
      else if (direction == QString::fromLatin1("columns"))
    ...
    // margin property
    if (ok) {
      int left = xmlreader->readAttributeInt(QString::fromLatin1("marginleft"), &ok);
      if (ok) {
        int top = xmlreader->readAttributeInt(QString::fromLatin1("margintop"), &ok);
        if (ok) {
          int right = xmlreader->readAttributeInt(QString::fromLatin1("marginright"), &ok);
          if (ok) {
            int bottom = xmlreader->readAttributeInt(QString::fromLatin1("marginbottom"), &ok);
            if (ok)
    ...
    while (!xmlreader->atEnd()) {
      ...
      if (xmlreader->isEndElement() &&
          (xmlreader->name() == QString::fromLatin1("title") || xmlreader->name() == QString::fromLatin1("legend")))
        break;
      if (xmlreader->isStartElement() && xmlreader->name() == QString::fromLatin1("title")) {
        // title visible
        bool titlevisible = xmlreader->readAttributeBool(QString::fromLatin1("visible"), &ok);
        (ok) ? (titlevisible) ? addtitle_legend() : removetitle_legend()
             : xmlreader->raiseWarning(
                   tr("no Legend2D title visible property element found"));
        QString titletext = xmlreader->readAttributeString(QString::fromLatin1("text"), &ok);
