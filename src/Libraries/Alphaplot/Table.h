...
class AlphaplotExport Table: public TableView, public scripted, public QScriptable
{
    Q_OBJECT

 public:
  Gui::TableViewProvider* d_future_table;
  ...
  Table(const QString& fname, const QString& sep,
  ...
  Table(int r, int c, const QString& label,
  ...
  void setCaptionPolicy(CaptionPolicy policy) {
    ...
    switch (policy) {
      case Name:
        d_future_table->setCaptionSpec(QString::fromLatin1("%n"));
        break;
      case Label:
        d_future_table->setCaptionSpec(QString::fromLatin1("%c"));
        break;
      case Both:
        d_future_table->setCaptionSpec(QString::fromLatin1("%n%C{ - }%c"));
        break;
    }
  }
  ...
  virtual QWidget* view() { return d_future_table->view(); }
