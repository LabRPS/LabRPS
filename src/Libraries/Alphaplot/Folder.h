...
class AlphaplotExport Folder : public QObject {
  Q_OBJECT
 ...
 public:
  ...
  int windowCount(bool recursive = false) const {
    ...
    if (recursive) Q_FOREACH (Folder *folder, folders())
  ...
  void setActiveWindow(MyWidget *window) { 
      d_active_window = static_cast<MyWidget*>(window);
  }
...
class AlphaplotExport WindowTableWidgetItem : public QTreeWidgetItem {
 public:
...
class AlphaplotExport FolderTreeWidgetItem : public QTreeWidgetItem {
 public:
...
class AlphaplotExport FolderTreeWidget : public QTreeWidget {
  Q_OBJECT
...
class AlphaplotExport TableWidgetDelegate : public QItemDelegate {
  Q_OBJECT
