...
class AlphaplotExport Matrix: public MatrixView, public scripted
{
  Q_OBJECT

 public:
  Gui::MatrixViewProvider *d_future_matrix;
  ...
  void setCaptionPolicy(CaptionPolicy policy) {
    ...
    switch (policy) {
      case Name:
        d_future_matrix->setCaptionSpec(QString::fromLatin1("%n"));
        break;
      case Label:
        d_future_matrix->setCaptionSpec(QString::fromLatin1("%c"));
        break;
      case Both:
        d_future_matrix->setCaptionSpec(QString::fromLatin1("%n%C{ - }%c"));
        break;
    }
  }
   ...
   */
  Matrix(int r, int c, const QString &label,
         QWidget *parent = nullptr, const char *name = 0,
         Qt::WindowFlags f = Qt::SubWindow, ScriptingEnv* env = nullptr);
  ~Matrix();
 ...
 public Q_SLOTS:
   ...
   */
  QChar textFormat() {return QChar::fromLatin1(d_future_matrix->numericFormat()); }
  /*!
 ...
 private:
  ...
  Matrix(Gui::MatrixViewProvider *future_matrix, int r, int c,
