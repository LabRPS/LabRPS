...
RandomDistributionDialog::RandomDistributionDialog(QWidget *parent)
  ...
  (IconLoader::lumen_ < 100)
      ? distFormulaPath = QString::fromLatin1
           (":icons/dark/distribution/")
      : distFormulaPath = QString::fromLatin1(":icons/light/distribution/");
  ...
  int distIndex = settings.value(QString::fromLatin1("RandomDistribution"), 0).toInt();
  ui_->distComboBox->setCurrentIndex(distIndex);
  distributionChanged(distIndex);
  ui_->parameter1DbleSpinBox->setValue(
      settings.value(QString::fromLatin1("RandomDistributionParam-1")).toDouble());
  ui_->parameter2DbleSpinBox->setValue(
      settings.value(QString::fromLatin1("RandomDistributionParam-2")).toDouble());
  ui_->parameter3DbleSpinBox->setValue(
      settings.value(QString::fromLatin1("RandomDistributionParam-3")).toDouble());
  settings.endGroup();
  ...
  switch (dist) {
    case Gaussian: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-gaussian.png")));
    ...
    case Exponential: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-exponential.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
    ...
    case Laplace: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-laplace.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
      ...
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromUtf8("μ = "));
      ui_->parameter2Label->setText(QString::fromLatin1("a = "));
      ui_->parameter1DbleSpinBox->setValue(0.0);
      ui_->parameter2DbleSpinBox->setValue(1.0);
      parameters.clear();
      parameters << 0.0 << 1.0 << nan("null");
    ...
    case ExponentialPower: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-exponential-power.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
      ...
      ui_->parameter1Label->setText(QString::fromUtf8("μ = "));
      ui_->parameter2Label->setText(QString::fromLatin1("a = "));
      ui_->parameter3Label->setText(QString::fromLatin1("b = "));
      ui_->parameter1DbleSpinBox->setValue(0.0);
      ui_->parameter2DbleSpinBox->setValue(1.0);
    ...
    case Cauchy: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-cauchy.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->hide();
      ui_->parameter2Label->hide();
      ui_->parameter3DbleSpinBox->hide();
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("a = "));
      ui_->parameter1DbleSpinBox->setValue(1.0);
      parameters.clear();
      parameters << 1.0 << nan("null") << nan("null");
    } break;
    case Rayleigh: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-rayleigh.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->hide();
      ui_->parameter2Label->hide();
    ...
    case RayleighTail: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-rayleigh-tail.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
    ...
    case Landau: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-landau.png")));
    ...
    case LevyAlphaStable: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-levy-alpha-stable.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
      ui_->parameter3DbleSpinBox->hide();
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("c = "));
    ...
    case LevySkewAlphaStable: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-levy-skew-alpha-stable.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
    ...
    case Flat: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-flat.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
      ...
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("a = "));
      ui_->parameter2Label->setText(QString::fromLatin1("b = "));
      ui_->parameter1DbleSpinBox->setValue(0.0);
      ui_->parameter2DbleSpinBox->setValue(1.0);
      parameters.clear();
      parameters << 0.0 << 1.0 << nan("null");
    ...
    case Gamma:
      ...
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-gamma.png")));
    case Beta:
    case Pareto:
    case Weibull:
    case Gumbel1:
    ...
    case Lognormal: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-lognormal.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->show();
      ui_->parameter2Label->show();
    ...
    case ChiSquared: {
      ui_->distFormulaLabel->setPixmap(
          QPixmap(distFormulaPath + QString::fromLatin1("dist-chisquared.png")));
      ui_->parameter1DbleSpinBox->show();
      ui_->parameter1Label->show();
      ui_->parameter2DbleSpinBox->hide();
      ui_->parameter2Label->hide();
    ...
    case Poisson: {
      ...
      ui_->parameter3DbleSpinBox->hide();
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("μ = "));
      ui_->parameter1DbleSpinBox->setValue(0.0);
      parameters.clear();
    ...
    case Logarithmic: {
      ...
      ui_->parameter3DbleSpinBox->hide();
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("p = "));
    ...
    case Pascal: {
      ...
      ui_->parameter3Label->hide();
      ui_->parameter1Label->setText(QString::fromLatin1("p = "));
      ui_->parameter2Label->setText(QString::fromLatin1("n = "));
      ui_->parameter1DbleSpinBox->setValue(0.5);
    ...
    case Hypergeometric: {
      ...
      ui_->parameter3DbleSpinBox->show();
      ui_->parameter3Label->show();
      ui_->parameter1Label->setText(QString::fromLatin1("n1 = "));
      ui_->parameter2Label->setText(QString::fromLatin1("n2 = "));
      ui_->parameter3Label->setText(QString::fromLatin1("t = "));
      ui_->parameter1DbleSpinBox->setValue(1.0);
...
void RandomDistributionDialog::ok() {
  ...
  Q_EMIT randomDistribution(distribution, parameters);
  // Save settings
  QSettings settings;
  settings.beginGroup(QString::fromLatin1("General"));
  settings.setValue(QString::fromLatin1("RandomDistribution"), ui_->distComboBox->currentIndex());
  settings.setValue(QString::fromLatin1("RandomDistributionParam-1"), parameters.at(0));
  settings.setValue(QString::fromLatin1("RandomDistributionParam-2"), parameters.at(1));
  settings.setValue(QString::fromLatin1("RandomDistributionParam-3"), parameters.at(2));
  settings.endGroup();
  QDialog::accept();
}
