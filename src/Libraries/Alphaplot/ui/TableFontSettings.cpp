...
TableFontSettings::TableFontSettings(SettingsDialog *dialog)
  ...
  ui->setupUi(this);
  setWindowIcon(
      IconLoader::load(QString::fromLatin1("preferences-table-font"), IconLoader::General));
...
void TableFontSettings::Load() {
  ...
  ui->labelfontvalueLabel->setText(QString::fromLatin1("%1 %2")
                                  .arg(labelfont_.family())
                                  .arg(labelfont_.pointSize()));
  ui->textfontvalueLabel->setFont(textfont_);
  ui->textfontvalueLabel->setText(QString::fromLatin1("%1 %2")
...
void TableFontSettings::Save() {
  ...
  Q_EMIT tablefontsettingsupdate();
}
...
void TableFontSettings::pickTextFont() {
  ...
  ui->textfontvalueLabel->setText(
      QString::fromLatin1("%1 %2").arg(textfont_.family()).arg(textfont_.pointSize()));
}
...
void TableFontSettings::pickLabelFont() {
  ...
  ui->labelfontvalueLabel->setText(
      QString::fromLatin1("%1 %2").arg(labelfont_.family()).arg(labelfont_.pointSize()));
}
