...
SettingsDialog::SettingsDialog(QWidget* parent)
  ...
  QString scrollbackcol =
      QString::fromLatin1(".QScrollArea {border: 0; background-color: rgba(%1,%2,%3,%4);}");
  ...
  ui_->settingsButton->setStyleSheet(
      QString::fromLatin1("QPushButton {background-color : rgba(0,0,0,0);border: 0 "
      "rgba(0,0,0,0);}"));

  // Prepare label.
  QString label_font_color =
      QString::fromLatin1("QLabel {background-color : rgba(0,0,0,0);"
      " padding-left: 10px;"
      " padding-right: 10px;"
      " padding-top: 10px;"
