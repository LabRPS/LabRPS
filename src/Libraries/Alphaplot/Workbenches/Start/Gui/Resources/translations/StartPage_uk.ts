...
<TS version="2.1" language="uk" sourcelanguage="en">
  <context>
    ...
    <message>
      ...
      <translation>Цей розділ містить документацію, корисну для користувачів LabRPS загалом: перелік усіх робочих середовищ, детальні інструкції для встановлення та використання додатку LabRPS, навчальні посібники та все, що вам потрібно для початку.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>У цьому розділі зібрана документація для досвідчених користувачів і людей, зацікавлених в написанні скриптів python. Ви також знайдете там сховище макросів, інструкції щодо їх встановлення, використання та додаткову інформацію про налаштування LabRPS під ваші конкретні потреби.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Цей розділ містить матеріали для розробників: Як самостійно встановити LabRPS, як структурувати вихідний код LabRPS + як орієнтуватися в ньому, як розробляти нові робочі середовища та / або вбудовувати LabRPS у свій власний додаток.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Посібник із LabRPS - це інший, більш лінійний спосіб представлення інформації з вікі. Він створений для читання як книга, та поступово познайомить вас з багатьма іншими сторінками з вищезгаданих розділів. Також доступний у форматі &lt;a href="https://www.gitbook.com/book/yorikvanhavre/a-labrps-manual/details"&gt;електронної книги&lt;/a&gt;.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;a href="http://forum.labrps.com"&gt;Форум LabRPS&lt;/a&gt; є чудовим місцем, щоб отримати допомогу від інших користувачів LabRPS та розробників. Форум має багато розділів з різних питань та тем, що обговорюються. Якщо маєте сумніви, напишіть у більш загальний розділ &lt;a href="https://forum.labrps.com/viewforum.php?f=3"&gt;Допомога у використанні LabRPS&lt;/a&gt;.</translation>
    </message>
    <message>
      ...
      <translation>Якщо це буде ваш перший допис на форумі, спочатку обовʼязково &lt;a href="https://forum.labrps.com/viewtopic.php?f=3&amp;t=2264"&gt;прочитайте рекомендації&lt;/a&gt;.</translation>
    </message>
    <message>
      ...
      <translation>LabRPS також підтримує публічний &lt;a href="https://www.labrps.com/tracker"&gt; відстежувач помилок&lt;/a&gt;, де будь-кто може надсилати помилки та пропонувати нові функції. Щоб уникнути зайвої роботи та мати найкращі шанси побачити помилку вирішеною, обов’язково прочитайте &lt;a href="https://forum.labrps.com/viewtopic.php?f=3&amp;t=5236"&gt;посібник з усунення помилок&lt;/a&gt; перед публікацією.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Нижче наведено список доступних додаткових робочих середовищ, які можна додати до інсталяції LabRPS. Перегляньте та встановіть їх з меню Інструменти -&gt; Менеджер додатків. Ви можете дізнатись більше про будь-яке з них, натиснувши посилання нижче.</translation>
    </message>
    <message>
      ...
      <translation>Встановіть пакет документації LabRPS (якщо він не входить до комплекту постачання вашої версії LabRPS), щоб отримати пакети документації, довідку з робочих середовищ та документацію за окремими командами без підключення до Інтернету.</translation>
    </message>
    <message>
      ...
      <translation>Не вдається отримати інформацію з GitHub. &lt;a href="EnableDownload.py"&gt; Авторизуйте LabRPS з доступом до Інтернету &lt;/a&gt;та перезавантажте стартову сторінку.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Нижче наведено останні зміни, додані до &lt;a href="http://github.com/LabRPS/LabRPS/"&gt; LabRPS-коду&lt;/a&gt;. Ці зміни можуть поки що не відображатися у версії LabRPS, яку ви зараз використовуєте. Перевірте &lt;a href="https://www.labrps.com/wiki/Downloads"&gt;доступні варіанти&lt;/a&gt;, якщо хочете отримати версію для розробки.</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Останні дописи на &lt;a href="https://forum.labrps.com"&gt;форумі LabRPS&lt;/a&gt;:</translation>
    </message>
    <message>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Якщо позначено цей пункт, останні повідомлення з форуму LabRPS будуть показані на вкладці Активність</translation>
    </message>
    <message>
...
Використовуючи ";;" для розділення шляхів, ви можете додати сюди кілька тек</translation>
    ...
    <message>
      ...
      <translation>у LabRPS</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Використовувати стилі LabRPS</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>Якщо прапорець встановлений, при запуску LabRPS автоматично закриє Стартову сторінку</translation>
    </message>
    <message>
