...
class AlphaplotExport DataBlockAbstract3D {
 public:
  // getters
...
class AlphaplotExport DataBlockSurface3D : public DataBlockAbstract3D {
 public:
...
class AlphaplotExport DataBlockBar3D : public DataBlockAbstract3D {
 public:
...
class AlphaplotExport DataBlockScatter3D : public DataBlockAbstract3D {
 public:
