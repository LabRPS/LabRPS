...
class AlphaplotExport ExponentialFit : public Fit {
  Q_OBJECT

 public:
  ExponentialFit(Gui::MainWindow *parent, AxisRect2D *axisrect,
...
class AlphaplotExport TwoExpFit : public Fit {
  Q_OBJECT

 public:
  TwoExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect);
  TwoExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect,
            PlotData::AssociatedData *associateddata);
  TwoExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect,
...
class AlphaplotExport ThreeExpFit : public Fit {
  Q_OBJECT

 public:
  ThreeExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect);
  ThreeExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect,
              PlotData::AssociatedData *associateddata);
  ThreeExpFit(Gui::MainWindow *parent, AxisRect2D *axisrect,
              PlotData::AssociatedData *associateddata, double start,
