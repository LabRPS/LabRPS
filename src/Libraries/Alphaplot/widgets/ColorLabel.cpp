...
ColorLabel::ColorLabel(QWidget *parent) : QLabel(QString::fromLatin1(""), parent), color_(Qt::gray) {
...
void ColorLabel::setColor(const QColor &color) {
  ...
  QString stylesheetstring =
      QString::fromLatin1("QLabel:!disabled{background : rgba(%1,%2, %3, %4); border: %5px solid "
      "rgba(%6, %7, %8, %9);}");
