...
#include "future/core/AbstractImportFilter.h"
 ...
 */
class AlphaplotExport AsciiTableImportFilter: public AbstractImportFilter
{
  Q_OBJECT
 ...
 public:
  AsciiTableImportFilter()
      : d_ignored_lines(0),
        d_separator(QString::fromLatin1("\t")),
  ...
  QString separator() const {
    ...
    return result.replace(QString::fromLatin1("\t"), QString::fromLatin1("\\t"));
  }
  void set_separator(const QString& value) {
    d_separator = value;
    d_separator.replace(QString::fromLatin1("\\t"), QString::fromLatin1("\t"));
  }
