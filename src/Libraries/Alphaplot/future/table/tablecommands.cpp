...
TableInsertColumnsCmd::TableInsertColumnsCmd(
    Gui::TableViewProvider::Private* private_obj, int before, QList<Column*> cols,
    QUndoCommand* parent)
    : QUndoCommand(parent),
...
TableSetNumberOfRowsCmd::TableSetNumberOfRowsCmd(
    Gui::TableViewProvider::Private* private_obj, int rows, QUndoCommand* parent)
...
TableRemoveColumnsCmd::TableRemoveColumnsCmd(
    Gui::TableViewProvider::Private* private_obj, int first, int count,
...
///////////////////////////////////////////////////////////////////////////
TableMoveColumnCmd::TableMoveColumnCmd(Gui::TableViewProvider::Private* private_obj,
