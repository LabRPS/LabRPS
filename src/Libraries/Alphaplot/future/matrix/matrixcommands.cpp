...
MatrixInsertColumnsCmd::MatrixInsertColumnsCmd(
    Gui::MatrixViewProvider::Private* private_obj, int before, int count,
    QUndoCommand* parent)
    : QUndoCommand(parent),
...
///////////////////////////////////////////////////////////////////////////
MatrixInsertRowsCmd::MatrixInsertRowsCmd(Gui::MatrixViewProvider::Private* private_obj,
...
MatrixRemoveColumnsCmd::MatrixRemoveColumnsCmd(
    Gui::MatrixViewProvider::Private* private_obj, int first, int count,
    QUndoCommand* parent)
    : QUndoCommand(parent),
      d_private_obj(private_obj),
      d_first(first),
...
///////////////////////////////////////////////////////////////////////////
MatrixRemoveRowsCmd::MatrixRemoveRowsCmd(Gui::MatrixViewProvider::Private* private_obj,
                                         int first, int count,
                                         QUndoCommand* parent)
    : QUndoCommand(parent),
      d_private_obj(private_obj),
...
///////////////////////////////////////////////////////////////////////////
MatrixClearCmd::MatrixClearCmd(Gui::MatrixViewProvider::Private* private_obj,
                               QUndoCommand* parent)
...
///////////////////////////////////////////////////////////////////////////
MatrixClearColumnCmd::MatrixClearColumnCmd(Gui::MatrixViewProvider::Private* private_obj,
...
MatrixSetCellValueCmd::MatrixSetCellValueCmd(
    Gui::MatrixViewProvider::Private* private_obj, int row, int col, double value,
    QUndoCommand* parent)
    : QUndoCommand(parent),
      d_private_obj(private_obj),
      d_row(row),
...
MatrixSetCoordinatesCmd::MatrixSetCoordinatesCmd(
    Gui::MatrixViewProvider::Private* private_obj, double x1, double x2, double y1,
...
///////////////////////////////////////////////////////////////////////////
MatrixSetFormatCmd::MatrixSetFormatCmd(Gui::MatrixViewProvider::Private* private_obj,
                                       char new_format)
...
///////////////////////////////////////////////////////////////////////////
MatrixSetDigitsCmd::MatrixSetDigitsCmd(Gui::MatrixViewProvider::Private* private_obj,
                                       int new_digits)
...
///////////////////////////////////////////////////////////////////////////
MatrixSetFormulaCmd::MatrixSetFormulaCmd(Gui::MatrixViewProvider::Private* private_obj,
                                         QString formula)
...
MatrixSetColumnCellsCmd::MatrixSetColumnCellsCmd(
    Gui::MatrixViewProvider::Private* private_obj, int col, int first_row, int last_row,
...
///////////////////////////////////////////////////////////////////////////
MatrixSetRowCellsCmd::MatrixSetRowCellsCmd(Gui::MatrixViewProvider::Private* private_obj,
...
///////////////////////////////////////////////////////////////////////////
MatrixTransposeCmd::MatrixTransposeCmd(Gui::MatrixViewProvider::Private* private_obj,
                                       QUndoCommand* parent)
    : QUndoCommand(parent), d_private_obj(private_obj) {
...
MatrixMirrorHorizontallyCmd::MatrixMirrorHorizontallyCmd(
    Gui::MatrixViewProvider::Private* private_obj, QUndoCommand* parent)
    : QUndoCommand(parent), d_private_obj(private_obj) {
