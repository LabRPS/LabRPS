...
void NumericDateTimeBaseFilter::writeExtraAttributes(
  ...
  writer->writeAttribute(QString::fromLatin1("base_datetime"),
                         QString::number(m_date_time_0.toMSecsSinceEpoch()));
  writer->writeAttribute(QString::fromLatin1("unit"),
...
bool NumericDateTimeBaseFilter::load(XmlStreamReader *reader) {
  ...
  QString base_datetimeStr =
      attribs.value(reader->namespaceUri().toString(), QString::fromLatin1("base_datetime"))
          .toString();
  QString unitStr =
      attribs.value(reader->namespaceUri().toString(), QString::fromLatin1("unit")).toString();
