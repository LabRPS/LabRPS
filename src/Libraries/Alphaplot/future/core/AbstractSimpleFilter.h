...
#include "Libraries/Alphaplot/future/core/AbstractFilter.h"
 ...
 * \endcode
 */
class AlphaplotExport AbstractSimpleFilter: public AbstractFilter
{
  Q_OBJECT
...
class AlphaplotExport SimpleFilterColumn: public AbstractColumn
{
  Q_OBJECT
