...
class AlphaplotExport AbstractAspect: public QObject
{
  Q_OBJECT
  ...
  */
  ...
  virtual QString path() const {
    return parentAspect() ? parentAspect()->path() + QString::fromLatin1("/") + name() : QString::fromLatin1("");
  }
