...
#include "future/core/datatypes/DayOfWeek2DoubleFilter.h"
...
#include "future/core/datatypes/Month2DoubleFilter.h"
...
Column::Private::Private(Column* owner, AlphaPlot::ColumnMode mode)
  ...
  switch (mode) {
    case AlphaPlot::Numeric:
                          ...
                          // global setting method
      {
        ...
        static_cast<Double2StringFilter*>(d_output_filter)
            ->setNumDigits(settings.value(QString::fromLatin1("DecimalDigits"), 14).toInt());
        static_cast<Double2StringFilter*>(d_output_filter)
            ->setNumericFormat(settings.value(QString::fromLatin1("DefaultNumericFormat"), 'f')
                                   .toChar()
                                   .toLatin1());
      }
#endif
    ...
    case AlphaPlot::Month:
      ...
      d_output_filter = new DateTime2StringFilter();
      static_cast<DateTime2StringFilter*>(d_output_filter)->setFormat(QString::fromLatin1("MMMM"));
      connect(static_cast<DateTime2StringFilter*>(d_output_filter),
              SIGNAL(formatChanged()), d_owner, SLOT(notifyDisplayChange()));
      d_data_type = AlphaPlot::TypeDateTime;
      d_data = new QList<QDateTime>();
    ...
    case AlphaPlot::Day:
      ...
      d_output_filter = new DateTime2StringFilter();
      static_cast<DateTime2StringFilter*>(d_output_filter)->setFormat(QString::fromLatin1("dddd"));
      connect(static_cast<DateTime2StringFilter*>(d_output_filter),
              SIGNAL(formatChanged()), d_owner, SLOT(notifyDisplayChange()));
      d_data_type = AlphaPlot::TypeDateTime;
      d_data = new QList<QDateTime>();
  ...
  d_input_filter->setName(QString::fromLatin1("InputFilter"));
  d_output_filter->setName(QString::fromLatin1("OutputFilter"));
}
...
void Column::Private::setColumnMode(const AlphaPlot::ColumnMode new_mode,
  ...
  switch (new_mode) {
    ...
    case AlphaPlot::ColumnMode::Month: {
      ...
      static_cast<DateTime2StringFilter*>(new_out_filter)->setFormat(QString::fromLatin1("MMMM"));
      connect(static_cast<DateTime2StringFilter*>(new_out_filter),
              SIGNAL(formatChanged()), d_owner, SLOT(notifyDisplayChange()));
      if (nullptr == converter) {
        switch (old_mode) {
    ...
    case AlphaPlot::ColumnMode::Day: {
      ...
      static_cast<DateTime2StringFilter*>(new_out_filter)->setFormat(QString::fromLatin1("dddd"));
      connect(static_cast<DateTime2StringFilter*>(new_out_filter),
              SIGNAL(formatChanged()), d_owner, SLOT(notifyDisplayChange()));
      if (nullptr == converter) {
        switch (old_mode) {
  ...
  switch (old_mode) {
    case AlphaPlot::ColumnMode::Numeric: {
      ...
      temp_col.reset(new Column(
          QString::fromLatin1("temp_col"), *(static_cast<QVector<qreal>*>(old_data)), d_validity));
      break;
    }
    case AlphaPlot::ColumnMode::Text: {
      temp_col.reset(new Column(
          QString::fromLatin1("temp_col"), *(static_cast<QStringList*>(old_data)), d_validity));
      break;
    }
    ...
    case AlphaPlot::ColumnMode::Day: {
      ...
      if ((AlphaPlot::ColumnMode::DateTime != new_mode) &&
        ...
        temp_col.reset(new Column(QString::fromLatin1("temp_col"),
  ...
  new_in_filter->setName(QString::fromLatin1("InputFilter"));
  new_out_filter->setName(QString::fromLatin1("OutputFilter"));
...
void Column::Private::replaceModeData(AlphaPlot::ColumnMode mode,
  ...
  in_filter->setName(QString::fromLatin1("InputFilter"));
  out_filter->setName(QString::fromLatin1("OutputFilter"));
