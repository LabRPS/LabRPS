...
#include <Libraries/Alphaplot/ui/ExtensibleFileDialog.h>
...
class AlphaplotExport ImportASCIIDialog : public ExtensibleFileDialog {
  Q_OBJECT
 ...
 public:
   ...
   */
  ImportASCIIDialog(bool importModeEnabled, bool strip_spaces, bool simplify_spaces,
                    int ignoredLines, bool renameColumns, QString columnSeparator,
                    bool d_convert_to_numeric, QLocale d_ASCII_import_locale,
