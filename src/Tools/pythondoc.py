...
# Create HTML documentation from LabRPS's Python modules and classes.

import pydoc, pkgutil, sys, os, dircache, zipfile

def generateDoc():
		# Get the path to the LabRPS module relative to this directory
		...
		# Import LabRPS module
		sys.path.append(binpath)
		print('Write documentation for module \'LabRPS\'')
		pydoc.writedoc('LabRPS')
		print('')
