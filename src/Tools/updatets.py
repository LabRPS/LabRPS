...
directories = [
    ...
    {"tsname": "LabRPS", "workingdir": "./src/Gui", "tsdir": "Language"},
    {
        "tsname": "AddonManager",
...
excluded_files = [
    ("RPS", "UtilsArguments.py"),  # Causes lupdate to hang
    ("RPS", "refactored_centroid_post.py"),  # lupdate bug causes failure on line 245
    ("RPS", "refactored_grbl_post.py"),  # lupdate bug causes failure on line 212
    ("RPS", "refactored_linuxcnc_post.py"),  # lupdate bug causes failure on line 178
    ("RPS", "refactored_mach3_mach4_post.py"),  # lupdate bug causes failure on line 186
    ("RPS", "refactored_test_post.py"),  # lupdate bug causes failure on lines 42 and 179
]
