...
#  define _TEMPLATE_Export      LABRPS_DECL_EXPORT
#else
#  define _TEMPLATE_Export      LABRPS_DECL_IMPORT
#endif
#endif
...
#  define _TEMPLATE_GuiExport   LABRPS_DECL_EXPORT
#else
#  define _TEMPLATE_GuiExport   LABRPS_DECL_IMPORT
#endif
#endif
