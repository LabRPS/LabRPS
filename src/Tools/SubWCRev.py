...
#
# LabRPS RevInfo script to get the revision information from Subversion, Bazaar, and Git.
#
...
class DebianChangelog(VersionControl):
    def extractInfo(self, srcdir, bindir):
        ...
        self.url = "https://code.launchpad.net/~vcs-imports/labrps/trunk"
        return True
...
class GitControl(VersionControl):
        ...
        for ref in self.branchlst:
            if '/' in ref:
                ...
                if remote in self.remotes:
                    ...
                    entryscore=(url == "git://github.com/LabRPS/LabRPS.git",\
    ...
    def revisionNumber(self, srcdir,origin=None):
        ...
        referencecommit="d1216de"
        referencerevision=204
    ...
    def extractInfo(self, srcdir, bindir):
        ...
        for fetchurl in ("git@github.com:LabRPS/LabRPS.git",\
