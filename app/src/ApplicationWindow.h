...
class ApplicationWindow : public QMainWindow,
 ...
 public slots:
  ...
  QStringList columnsList(LabRPS::PlotDesignation plotType);
  QList<QPair<Table*, Column*>> columnList(LabRPS::PlotDesignation plotType);
  ...
  //! Return a version string ("LabRPS x.y.z")
