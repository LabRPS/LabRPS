...
AxisRect2D *Layout2D::addAxisRectItemAsAppropriate(Column *xcol,
                                                   QList<Column *> ycollist) {
  /*Q_ASSERT(xcoldatatype != LabRPS::ColumnDataType::TypeDay &&
           ycoldatatype != LabRPS::ColumnDataType::TypeDay &&
           xcoldatatype != LabRPS::ColumnDataType::TypeMonth &&
           ycoldatatype != LabRPS::ColumnDataType::TypeMonth);*/
...
void Layout2D::addTextToAxisTicker(Column *col, Axis2D *axis, const int from,
  ...
  } else if (col->dataType() == LabRPS::ColumnDataType::TypeDateTime) {
