...
class Table : public TableView,
 ...
 public:
  ...
  enum ColType {
    ...
    Day = 5,
    DateTime = 6
  };  // TODO: remove this in favor of LabRPS::columnMode
 ...
 public slots:
  ...
  // the next non-bugfix LabRPS release, indication of failure should be done
  ...
  LabRPS::PlotDesignation colPlotDesignation(int col);
  void setColPlotDesignation(int col, LabRPS::PlotDesignation d);
  ...
  void addCol(LabRPS::PlotDesignation pd = LabRPS::Y);
  ...
  LabRPS::ColumnMode columnType(int col);

  QList<int> columnTypes();
  void setColumnTypes(QList<int> ctl);
  void setColumnTypes(const QStringList& ctl);
  void setColumnType(int col, LabRPS::ColumnMode mode);
