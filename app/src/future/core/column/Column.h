...
class Column : public AbstractColumn {
 ...
 public:
   ...
   */
  Column(const QString& name, LabRPS::ColumnMode mode);
  //! Ctor
  /** @{
   * \param name the column name (= aspect name)
  ...
  LabRPS::ColumnDataType dataType() const;
   ...
   */
  LabRPS::ColumnMode columnMode() const;
   ...
   */
  void setColumnMode(const LabRPS::ColumnMode mode,
...
class ColumnStringIO : public AbstractColumn {
 ...
 public:
  ...
  virtual LabRPS::ColumnMode columnMode() const { return LabRPS::Text; }
  virtual LabRPS::ColumnDataType dataType() const {
    return LabRPS::TypeString;
  }
  virtual LabRPS::PlotDesignation plotDesignation() const {
