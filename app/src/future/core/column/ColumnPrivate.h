...
class Column::Private {
 public:
  //! Ctor
  Private(Column* owner, LabRPS::ColumnMode mode);
  //! Dtor
  ~Private();
  //! Special ctor (to be called from Column only!)
  Private(Column* owner, LabRPS::ColumnDataType type,
          LabRPS::ColumnMode mode, void* data,
          IntervalAttribute<bool> validity);

  //! Return the data type of the column
  LabRPS::ColumnDataType dataType() const { return d_data_type; }
   ...
   */
  LabRPS::ColumnMode columnMode() const { return d_column_mode; }
   ...
   */
  void setColumnMode(const LabRPS::ColumnMode new_mode,
  ...
  LabRPS::PlotDesignation plotDesignation() const {
  ...
  void setPlotDesignation(LabRPS::PlotDesignation pd);
  //! Set the column plot designation
  void setPlotDesignationColor(LabRPS::PlotDesignation pd);
   ...
   */
  void replaceModeData(LabRPS::ColumnMode mode,
                       LabRPS::ColumnDataType type, void* data,
 ...
 private:
   ...
   */
  LabRPS::ColumnDataType d_data_type;
  //! The column mode
  /**
   * The column mode specifies how to interpret
   * the values in the column additional to the data type.
   */
  LabRPS::ColumnMode d_column_mode;
  ...
  LabRPS::PlotDesignation d_plot_designation;
