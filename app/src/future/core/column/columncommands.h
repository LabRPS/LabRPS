...
class ColumnSetModeCmd : public QUndoCommand {
 public:
  //! Ctor
  ColumnSetModeCmd(Column::Private* col, LabRPS::ColumnMode mode,
 ...
 private:
  ...
  //! The previous mode
  LabRPS::ColumnMode d_old_mode;
  //! The new mode
  LabRPS::ColumnMode d_mode;
  //! The old data type
  LabRPS::ColumnDataType d_old_type;
  //! The new data type
  LabRPS::ColumnDataType d_new_type;
  //! Pointer to old data
  void* d_old_data;
  //! Pointer to new data
  void* d_new_data;
...
class ColumnSetPlotDesignationCmd : public QUndoCommand {
 ...
 private:
  ...
  LabRPS::PlotDesignation d_new_pd;
  //! Old plot designation
  LabRPS::PlotDesignation d_old_pd;
};
///////////////////////////////////////////////////////////////////////////
