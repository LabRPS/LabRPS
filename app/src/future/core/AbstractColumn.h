...
class AbstractColumn : public AbstractAspect {
 ...
 public:
  ...
  virtual LabRPS::ColumnDataType dataType() const = 0;
   ...
   */
  virtual LabRPS::ColumnMode columnMode() const = 0;
  //! Set the column mode
  /**
   * This sets the column mode and, if
   * necessary, converts it to another datatype.
   */
  virtual void setColumnMode(const LabRPS::ColumnMode mode) {
    Q_UNUSED(mode)
  }
  ...
  virtual LabRPS::PlotDesignation plotDesignation() const = 0;
  // virtual QColor plotDesignationColor() const = 0;
  //! Set the column plot designation
  // virtual void setPlotDesignation(LabRPS::PlotDesignation pd) {
  // Q_UNUSED(pd) };
