 ...
 * 06			return (source->dataType() == LabRPS::TypeDouble);
 * 07		}
 * 08	public:
 * 09		virtual LabRPS::ColumnDataType dataType() const { return
 * LabRPS::TypeDouble; }
 * 10
 ...
 * checking for
 * LabRPS::TypeQString or LabRPS::TypeQDateTime in line 6. You would then
 * use
...
class AbstractSimpleFilter : public AbstractFilter {
 ...
 public:
   ...
   */
  virtual LabRPS::ColumnMode columnMode() const {
    // calling this function while d_input is empty is a sign of very bad code
    // nevertheless it will return some rather meaningless value to
    // avoid crashes
    return d_inputs.value(0) ? d_inputs.at(0)->columnMode() : LabRPS::Text;
  }
