...
#include "ui_rpswlaccuracycomparisontablezoomindialog.h"
#include "rpswlaccuracycomparisondialog.h"

RPSWLAccuracyComparisonTableZoomInDialog::RPSWLAccuracyComparisonTableZoomInDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::RPSWLAccuracyComparisonTableZoomInDialog)
{
    ui->setupUi(this);

    RPSWLAccuracyComparisonDialog *rpsWindLabComparisonDialog = (RPSWLAccuracyComparisonDialog *)this->parent();
...
RPSWLAccuracyComparisonTableZoomInDialog::~RPSWLAccuracyComparisonTableZoomInDialog()
{
    delete ui;
}
