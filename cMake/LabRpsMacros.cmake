...
MACRO(SET_BIN_DIR ProjectName OutputName)
    ...
    if(WIN32)
        ...
        # LabRPSBase, SMDS, Driver, MEFISTO2 and area-native libs don't depend on parts from CMAKE_INSTALL_LIBDIR
        if(NOT ${ProjectName} MATCHES "^(LabRPSBase|SMDS|Driver|MEFISTO2|area-native)$")
            if(${ARGC} STREQUAL 4)
