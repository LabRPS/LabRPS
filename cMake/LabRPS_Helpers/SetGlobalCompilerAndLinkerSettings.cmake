macro(SetGlobalCompilerAndLinkerSettings)
    ...
    if(MSVC)
        ...
        if(LABRPS_RELEASE_PDB)
            set (CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /Zi")
            set (CMAKE_SHARED_LINKER_FLAGS_RELEASE "${CMAKE_SHARED_LINKER_FLAGS_RELEASE} /DEBUG")
        endif(LABRPS_RELEASE_PDB)
	...
	option(LABRPS_USE_MP_COMPILE_FLAG "Add /MP flag to the compiler definitions. Speeds up the compile on multi processor machines" ON)
        if(LABRPS_USE_MP_COMPILE_FLAG)
