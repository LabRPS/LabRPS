macro(ConfigureCMakeVariables)
    ...
    if(WIN32)
        ...
        # Don't set it without manual adoption of LibDir variable in src/App/LabRPSInit.py
        set(CMAKE_INSTALL_LIBDIR lib CACHE PATH "Output directory for libraries")
    else()
        set(CMAKE_INSTALL_PREFIX "/usr/lib${LIB_SUFFIX}/labrps" CACHE PATH "Installation root directory")
