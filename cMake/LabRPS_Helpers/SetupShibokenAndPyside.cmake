...
# -------------------------------- Shiboken/PySide ------------------------
    ...
    if(SHIBOKEN_INCLUDE_DIR)
        option(LABRPS_USE_SHIBOKEN "Links to the shiboken library at build time. If OFF its Python module is imported at runtime" ON)
    else()
        option(LABRPS_USE_SHIBOKEN "Links to the shiboken library at build time. If OFF its Python module is imported at runtime" OFF)
    ...
    if(PYSIDE_INCLUDE_DIR)
        option(LABRPS_USE_PYSIDE "Links to the PySide libraries at build time." ON)
    else()
        option(LABRPS_USE_PYSIDE "Links to the PySide libraries at build time." OFF)
    endif()
